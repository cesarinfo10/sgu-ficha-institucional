...
$SQL_alumno = "SELECT va.rut,upper(a.nombres||' '||a.apellidos) AS nombre,a.cohorte,a.semestre_cohorte,a.mes_cohorte,c.nombre AS carrera,
                      to_char(coalesce(a.fecha_titulacion,a.fecha_graduacion),'DD \"de\" tmMonth \"de\" YYYY') AS fecha_titulacion,
                      coalesce(a.nota_titulacion,a.nota_graduacion) AS nota_titulacion,
                      a.malla_actual,va.malla_actual AS ano_malla_actual,
...
$HTML_enc = "<table border='0.1' cellspacing='0' cellpadding='2' width='100%'>"
          . "  <tr>"
...
for ($x=0;$x<count($asig_alumno);$x++) {
	...
	if ($periodo == "") { $periodo = "&nbsp;"; }
      ...
      if (($pag == 0 && $filas == 20) || ($pag > 0 && $filas == 25)) { $HTML .= "</table><!-- PAGE BREAK -->$HTML_enc"; $filas = 0; $pag++; }
}
$HTML .= "</table>";
...
*/
$HTML .= "  <tr>"
      .  "    <td align='right'><b>Nota de Titulación/Graduación</b></td>"
//      .  "    <td align='center'></td>"
//      .  "    <td align='center'></td>"
      .  "    <td align='center'><b>".number_format($al_nota_titulacion,1,",",".")."</b></td>"
      .  "  </tr>";
$HTML .= "</table>";
...
if ($al_estado == "Titulado" || $al_estado == "Licenciado" || $al_estado == "Graduado") {
	$TABLA_POND_NOTA_FINAL = $HTML;
      $fecha_emision = $al_fecha_titulacion;
}
...
$FIRMAS = "<table width='100%'>".$LF
		. "  <tr>".$LF
		. "    <td align='center' valign='bottom' width='45%'><img width='200' src='../img/firma_aaranela.png'><hr noshade size='2'><b>$JEFE_REGACAD_nombre</b><br>Jefa de Registro Académico, Títulos y Grados</td>".$LF
...
$FIRMAS = "<table width='100%'>".$LF
       . "  <tr>".$LF
       . "    <td align='center' valign='bottom' width='45%'><img width='180' src='../../img/firma_aaranela.png'><br><b>$nombre_regacad</b><br>Jefa de Registro Académico, Títulos y Grados</td>".$LF
...
$HTML = "<html>".$LF
      . "  <head>".$LF
      . "    <title>UMC - SGU - Concentración de Notas: $al_rut $al_nombre</title>".$LF
      . "    <style>".$LF
      ...
      . "          <table width='100%'><tr><td valign='top' align='justify'>$TEXTO</td></tr></table>".$LF
      . "          <table width='100%'><tr><td valign='top' align='center'>$FIRMAS</td></tr></table>".$LF
      . "        </td>".$LF
      . "      </tr>".$LF
      . "    </table>".$LF
      . "  </body>".$LF
...
$html2pdf = "htmldoc -t pdf --fontsize 11 --fontspacing 1 --no-strict --size 21.5x27cm --bodyfont helvetica "
		  . "--left 1cm --top 5cm --right 1cm --bottom 1cm --footer 't /' --header '   ' --no-embedfonts "
