...
if (empty($id_curso)) {
	$SQL_cursos = "SELECT vac.id_curso AS id,vac.semestre||'-'||vac.ano||'     '||vac.asignatura AS nombre,
				   ...
				   WHERE vac.id_alumno=$id_alumno AND vac.id_estado IS NULL
...
<form name="formulario" method="get" action="principal.php" onSubmit="return validar_nota('solemne1','nota_catedra','solemne2','recuperativa')">
