<?php
  function sacaEstadoActividad($id_actividad) {
...
$id_asiscapac_actividades_obligatorias_funcionarios = $_REQUEST['id_asiscapac_actividades_obligatorias_funcionarios'];
...
$strActividad = "";
if ($id_actividad<>"") {
  $estado_actividad = sacaEstadoActividad($id_actividad);
      ...
      if ($cuenta==0) {
       ...
       // echo("<br>$SQL");
              if (consulta_dml($SQL) > 0) {
                ...
                echo(js("location='$enlbase=asiscapac_actividades_obligatorias&ano=$ano&id_origen=2&id_campo_actividades=$id_actividad';"));
...
//        echo(msje_js("Registro existente."));   
          ...
          set ano = $ano, 
          id_asiscapac_actividades = $id_actividad,
          id_usuario = $id_usuario,
          id_asiscapac_actividades_funcionarios_check = $campo_id_check,
          observacion = $campo_observacion
          where id = $id_asiscapac_actividades_obligatorias_funcionarios
          ;"; 
        //  echo("<br>$SQL");
          consulta_dml($SQL);      
          echo(msje_js("Registro almacenado con éxito*"));
...
<div class="texto" style='margin-top: 5px'>
  <form name="formulario" action="principal.php" method="get">
    ...
    <input type="hidden" name="id_asiscapac_actividades_obligatorias_funcionarios" id="id_asiscapac_actividades_obligatorias_funcionarios" value="<?php echo($id_asiscapac_actividades_obligatorias_funcionarios); ?>">
