...
<?php
	...
	if (count($funcionarios) > 0) {
      ...
      . "    <td class='textoTabla'><a href='principal.php?modulo=capac_usuario_buscar&id_usuario_parametro=$id&nombre_usuario_parametro=$nombre_usuario_parametro' class='text' target='_blank'>$id</a></td>"
