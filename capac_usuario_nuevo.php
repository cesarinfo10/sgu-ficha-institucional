<?php
function cuentaRegistroCapacitaciones($ano, 
                                  //$id_origen, 
                                  $id_asiscapac_tipo, 
                                  $id_asiscapac_estado, 
                                  $fecha_inicio, 
  ...
  $ss = "
    ...
    and id_asiscapac_tipo = $id_asiscapac_tipo //1
    and id_asiscapac_estado = $id_asiscapac_estado //1
...
//$id_tipo_general_capacitacion = 3; //VOLUNTARIA $_REQUEST['id_tipo_general_capacitacion'];
...
$sala        = $_REQUEST['sala'];
$max_capacitaciones = $_REQUEST['max_capacitaciones'];
...
$SQL = "select count(*) as cuenta_capacitaciones from asiscapac_usuario_capacitaciones where ano = $ano and id_usuario = $id_usuario and id_asiscapac_estado in (1,2,3);"; 
$cuentas = consulta_sql($SQL);
//echo("<br>$SQL");
extract($cuentas[0]);
//echo("<br>cuenta_capacitaciones = $cuenta_capacitaciones");
//echo("<br>max_capacitaciones = $max_capacitaciones");


if ($cuenta_capacitaciones >= $max_capacitaciones) {  
  //echo("ENTRA!!");
  echo(msje_js("Ud. no puede agregar más capacitaciones."));
  echo(js("window.history.back();"));
  exit;
}
...
$ano            = $_REQUEST['ano'];
$id_origen      = 1; //$_REQUEST['id_origen'];
...
/*
    ...
    */
    ...
    if ($puedeSeguir) {
      ...
      $registros =  cuentaRegistroCapacitaciones($ano, 
                                              //$id_origen, 
                                              $id_asiscapac_tipo, 
                                              $id_asiscapac_estado, 
                                              $fec_ini_asist, 
...
*/
                ...
                //echo(js("location='$enlbase=capac_usuario_buscar&ano=$ano&id_estado_check=$id_estado_check&id_campo_actividades=$id_campo_actividades&id_usuario_parametro=$id_usuario_parametro&nombre_usuario_parametro=$nombre_usuario_parametro';"));
                echo(js("location='$enlbase=capac_usuario_buscar&ano=$ano&id_origen=$id_origen&id_estado_check=$id_estado_check&id_campo_actividades=$id_campo_actividades&id_usuario_parametro=$id_usuario_parametro&nombre_usuario_parametro=$nombre_usuario_parametro';"));
              } else {
...
$sql_tipo = "select id, glosa nombre from asiscapac_tipo where id in (3,4) order by orden";
...
<div class="texto" style='margin-top: 5px'>
  <form name="formulario" action="principal.php" method="get">
    ...
    <input type="hidden" name="max_capacitaciones" value="<?php echo($max_capacitaciones); ?>">
