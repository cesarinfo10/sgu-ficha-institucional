...
<td class='tituloTabla' style="display:none;" <?php echo($esconder); ?>>Convocatoria <br> <input type='checkbox' id='id_todos_check' name='id_todos_check' onclick=marcarTodos()>Todos</td> 
...
<td class='tituloTabla'>Estado evidencia <br>
<?php
    $chk_selected_validada = ""; 
    $chk_selected_revocada = "";
    $chk_selected_ambas = "";


  if ($id_ordenar_validada <> "") {
    $chk_selected_validada = "checked"; 
    //$id_ordenar_revocada = "";
    //$id_ordenar_ambas = "";
  } else {
    $chk_selected_validada = ""; 
...
?>
            <!--<input type='checkbox' id='id_ordenar_apellido' name='id_ordenar_apellido' onChange="submitform();" <?php echo($chk_selected); ?>> Ordenar x Apellido -->
<!--            <input type='checkbox' id='id_ordenar_validada' name='id_ordenar_validada' onChange="submitform();" <?php echo($chk_selected_validada); ?>><small>Validada</small> &nbsp;
            <input type='checkbox' id='id_ordenar_revocada' name='id_ordenar_revocada' onChange="submitform();" <?php echo($chk_selected_revocada); ?>><small>Revocada</small> &nbsp;
            <input type='checkbox' id='id_ordenar_ambas' name='id_ordenar_ambas' onChange="submitform();" <?php echo($chk_selected_ambas); ?>><small>Ambas</small>
-->
</td> 
...
//$HTML_formar .= "  <td class='textoTabla' align='left' $esconder><input type='checkbox' id='id_incluir_$x' name='id_incluir_$x' onclick=armarQuerys()></td>\n"
//$HTML_formar .= "  <td class='textoTabla'><a href='principal.php?modulo=$modulo&id_curso=$id&eliminar=si&id_alumno=$id_alumno' class='boton'> que sucede </a></td>";
/*
if ($confirmado=="SI") {
...
if ($confirmado=="NO") {
  $HTML_formar .= "  <td class='textoTabla'><span style='color: red'><b> ✗ </b></span></span></td>";   
} else {
  $HTML_formar .= "  <td class='textoTabla'></td>";   
}
*/
...
/*
if ($confirmado=="SI") {
  //$HTML_formar .= "  <td class='textoTabla'><a href='principal.php?modulo=capac_usuarios_evidencias&ano=$ano&id_origen=$id_origen&id_campo_capacitaciones=$id_campo_capacitaciones&id_estado_check=$id_estado_check&id_usuario_confirmar=$id&confirmar=NO' class='text'>OK</a></td>";
  $HTML_formar .= "  <td class='textoTabla'><a href='$enlbase_sm=capac_revocar&ano=$ano&id_origen=$id_origen&id_campo_capacitaciones=$id_campo_capacitaciones&id_estado_check=$id_estado_check&id_usuario_confirmar=$id&confirmar=NO&param_observacion=$observacion&param_observacionrevocar=$observacionrevocar' class='text'  id='sgu_fancybox_small'>Revocar</a></td>";   
} else {
  //$HTML_formar .= "  <td class='textoTabla'><a href='principal.php?modulo=capac_usuarios_evidencias&ano=$ano&id_origen=$id_origen&id_campo_capacitaciones=$id_campo_capacitaciones&id_estado_check=$id_estado_check&id_usuario_confirmar=$id&confirmar=SI' class='text'>Sin confirmar</a></td>";
  $HTML_formar .= "  <td class='textoTabla'><a href='$enlbase_sm=capac_revocar&ano=$ano&id_origen=$id_origen&id_campo_capacitaciones=$id_campo_capacitaciones&id_estado_check=$id_estado_check&id_usuario_confirmar=$id&confirmar=SI&param_observacion=$observacion&param_observacionrevocar=$observacionrevocar' class='text'  id='sgu_fancybox_small'>Sin Confirmar</a></td>";   
}
*/
