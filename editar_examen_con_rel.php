...
if ($_REQUEST['guardar'] == "Guardar") {
	...
	$SQLupdate = "UPDATE cargas_academicas
	              ...
	              WHERE id=$id_ca AND examen_con_rel;";
	consulta_dml($SQLupdate);
	$id_alumno=$_REQUEST['id_alumno'];
	echo(js("window.location='$enlbase=ver_alumno&id_alumno=$id_alumno&vista=examenes_con_rel'"));
}

$SQL_ca = "SELECT vac.id,vac.id_alumno,vac.asignatura,
           ...
           WHERE vac.id=$id_ca AND examen_con_rel";
...
<table bgcolor="#ffffff" cellspacing="1" cellpadding="2" class="tabla">
  ...
  <tr>
    <td class="celdaNombreAttr"><u>Fecha Examen:</u></td>
    <td class="celdaValorAttr">
      <select name="fec_mod_dia">
        <option value="" style="text-align: center; ">- Día -</option>
