	...
	for ($x=0;$x<count($I_item);$x++) {
		if (substr($I_item[$x],0,1) == "#") {
			...
			if (!empty(trim($I_item[$x]))) {
				...
				for ($y=1;$y<=7;$y++) {
					$HTML_I_item .= "<td class='textoTabla' align='center'><input type='radio' name='p$nro_preg' value='$y'></td>\n";
				}
			}
			$nro_preg++;
		}
...
<div class="texto" align="justify">
  ...
  <br><br>
  II. Mencione dos cosas que le gustan y que no le gusten de la Universidad.<br><br>
  <table cellpadding="2" cellspacing="1" class="tabla"  bgcolor="#FFFFFF">
    <tr class='filaTituloTabla'>
      <td class='tituloTabla'>Me gusta</td>
      <td class='tituloTabla'>No me gusta</td>
    </tr>
    <tr class='filaTabla'>
      <td class='textoTabla'>1. <input type='text' name='p71'></td>
      <td class='textoTabla'>1. <input type='text' name='p73'><br>
    </tr>
    <tr class='filaTabla'>
      <td class='textoTabla'>2. <input type='text' name='p72'></td>
      <td class='textoTabla'>2. <input type='text' name='p74'></td>
    </tr>
  </table>
  <br>
