...
<table class="table table-bordered">
    <thead>
      <tr>
        <th class="tituloTabla">Sede [6]</th>
        <th class="tituloTabla">Matricula nueva</th>
        <th class="tituloTabla">Matricula nueva (% Mujer)</th>
        <th class="tituloTabla">Matricula total</th>
        <th class="tituloTabla">Matricula total (% Mujer)</th>
        <th class="tituloTabla">Jornada Completa</th>
        <th class="tituloTabla">Media Jornada</th>
        <th class="tituloTabla">Jornada Hora</th>
        <th class="tituloTabla">M2 construidos por estudiantes</th>
      </tr>
    </thead>
    <tbody>
      <tr>
