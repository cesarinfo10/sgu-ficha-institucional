...
==========================================================================================*/
/*==========================================================================================
                              17.  Beneficios a estudiantes de pregrado
==========================================================================================*/

function cargarBeneficioEstudiante(){
    
  setTimeout(() => {
    var url ="models/dotacion_personal_17.php?getBenEstudiante";
    $.ajax({
        type: "POST",
        url: url,
        async: false,
        success: function(data) {
            $("#tblBenEstudiante").html(data);
        }
...
/*==========================================================================================
                            FIN 19. Investigación
==========================================================================================*/
/*==========================================================================================
                              18. Vinculación con el Medio
==========================================================================================*/

function cargarVinculcionM(){
    
  var url ="ficha-institucional/vinculacion_medio18.php";
  $.ajax({
      type: "POST",
      url: url,
      async: false,
...
/*==========================================================================================
                            FIN 18. Vinculación con el Medio
==========================================================================================*/
...
function cargarInvestigacion(){
  ...
  var url ="ficha-institucional/investigacion19.php";
  $.ajax({
      type: "POST",
      url: url,
      async: false,
