...
// Eliminar ramos no cursados o sin nota final
...
$HTML = "<table border='0.1' cellspacing='0' cellpadding='2' width='100%' class='tabla'>"
      . "  <tr>"
      . "    <td align='center' valign='middle'><b>Nombre de la Asignatura</b></td>"
      . "    <td align='center' valign='middle' width='20%'><b>Nota</b></td>"
      . "    <td align='center' valign='middle' width='12%'><b>Periodo</b></td>"
      . "  </tr>";
...
for ($x=0;$x<count($asig_alumno);$x++) {
	...
	$sum_notas += $nf;
	$filas++;
	if (($filas > 15 && $pag == 1) || ($filas > 25 && $pag > 1)) { $HTML .= "<!-- PAGE BREAK -->"; $pag++; $filas = 0; }
}
$HTML .= "</table>\n";
