...
if (count($fuas) == 1) {
	...
	for($x=0;$x<count($grupofam);$x++) {
		...
		$boton_subir_docto = "<a href='$enlbase_sm=fuasumc_subir_docto_ing&id_gf={$grupofam[$x]['id']}' class='boton' id='sgu_fancybox_small'><small>Subir Docto</small></a>";
...
<div class='texto' style='margin-top: 5px'>
  ...
  <a href="<?php echo("$enlbase_sm=fuasumc_enviar_postulacion&id_fuas=$id_fuas"); ?>" id='sgu_fancybox_medium' class='boton'>Presentar Postulación</a>
  <a href="<?php echo("$enlbase_sm=fuasumc_validar&id_fuas=$id_fuas"); ?>" id='sgu_fancybox_medium' class='boton'>Validar Postulación</a>
  <a href="<?php echo("$enlbase_sm=gestion_fuas"); ?>" id='sgu_fancybox_medium' class='boton'>Volver</a>
</div>
