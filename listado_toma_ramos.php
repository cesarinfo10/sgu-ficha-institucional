...
$SQL_alumnos = "SELECT id AS id_alumno,rut,nombre,carrera,admision
                FROM vista_alumnos
                WHERE cohorte=2007 AND semestre_cohorte=1
                ORDER BY carrera,nombre";
$alumnos = consulta_sql($SQL_alumnos);

$SQL_alumnos2 = "SELECT id FROM alumnos WHERE cohorte=2007 AND semestre_cohorte=1 ORDER BY carrera_actual,apellidos";
