COPY (SELECT 'R' AS tipo_docto_ident,
                ...
                WHERE true  AND (a.estado = '9')  AND (a.estado_fecha between '2023-01-01'::date AND '2023-07-21'::date) AND (a.id IN (SELECT id_alumno FROM matriculas WHERE ano=2023 AND semestre=1))  
