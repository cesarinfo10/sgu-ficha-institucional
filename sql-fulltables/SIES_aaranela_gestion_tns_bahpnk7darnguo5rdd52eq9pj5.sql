COPY (SELECT 2 AS TIPO_REGISTRO,
                ...
                WHERE a.salida_int_fecha IS NOT NULL AND a.salida_int_nroreg_libro IS NOT NULL AND salida_int_calif IS NOT NULL   AND (a.salida_int_fecha between '2022-11-19'::date AND '2022-12-29'::date) AND (c.regimen = 'PRE') 
