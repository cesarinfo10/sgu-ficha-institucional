COPY (SELECT 2 AS TIPO_REGISTRO,
                ...
                WHERE a.salida_int_fecha IS NOT NULL AND a.salida_int_nroreg_libro IS NOT NULL AND salida_int_calif IS NOT NULL  AND (estado = '51') AND (date_part('year',a.salida_int_fecha) = 2021) AND (a.carrera_actual = '19') AND (c.regimen = 'PRE') 
