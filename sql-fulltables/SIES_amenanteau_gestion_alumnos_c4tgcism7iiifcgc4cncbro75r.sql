COPY (SELECT 'R' AS tipo_docto_ident,
                ...
                WHERE true  AND (a.semestre_cohorte = 1 ) AND (a.estado = '5')  AND (a.estado_fecha between '2023-01-01'::date AND '2023-02-23'::date)  AND a.carrera_actual IN (101,62,26,88,18,3,36,67)  
