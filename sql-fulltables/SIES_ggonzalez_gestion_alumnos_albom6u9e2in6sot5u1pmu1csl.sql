COPY (SELECT 'R' AS tipo_docto_ident,
                ...
                WHERE true  AND ((a.cohorte = 2022 AND a.semestre_cohorte = 2 AND a.mes_cohorte = 10) ) AND (a.cohorte = '2022' ) AND (a.estado = '1') AND (c.regimen = 'POST-TD') AND (a.id IN (SELECT id_alumno FROM matriculas WHERE ano=2022 AND semestre=2))  
