COPY (SELECT 'R' AS tipo_docto_ident,
                ...
                WHERE true  AND (a.cohorte = '2023' ) AND (a.estado = '1') AND (a.carrera_actual = 4) AND (a.jornada = 'D') AND (c.regimen = 'PRE') AND (a.id IN (SELECT id_alumno FROM matriculas WHERE ano=2023 AND semestre=1))  
