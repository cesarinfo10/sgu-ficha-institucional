COPY (SELECT 'R' AS tipo_docto_ident,
                ...
                WHERE true  AND (a.estado = '51')  AND (a.estado_fecha between '2023-04-03'::date AND '2023-12-20'::date) AND (a.id NOT IN (SELECT id_alumno FROM matriculas WHERE ano=2023 AND semestre=2))  AND a.carrera_actual IN (95,100,2,69,1,19)  
