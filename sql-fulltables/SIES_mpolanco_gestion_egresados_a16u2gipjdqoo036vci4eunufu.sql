COPY (SELECT 4 AS TIPO_REGISTRO,
                ...
                WHERE ae.nombre='Egresado'   AND (lower(a.nombres||' '||a.apellidos) ~* 'v[aá]l[eé]nt[ií]n[aá]' OR  a.rut ~* 'v[aá]l[eé]nt[ií]n[aá]' OR  text(a.id) ~* 'v[aá]l[eé]nt[ií]n[aá]' )  AND carrera_actual IN (95,100,2,69,1,19) 
