COPY (SELECT 'R' AS tipo_docto_ident,
                ...
                WHERE true  AND ((a.cohorte = 2022 AND a.semestre_cohorte = 1 AND a.mes_cohorte = 3)      OR (a.cohorte_reinc = 2022 AND a.semestre_cohorte_reinc = 1 AND a.mes_cohorte_reinc = 3)) AND (a.cohorte = '2022' OR a.cohorte_reinc = '2022') AND (c.regimen = 'POST-GD')  
