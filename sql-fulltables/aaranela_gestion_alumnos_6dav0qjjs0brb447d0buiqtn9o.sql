COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'sc[aá]rl[eé]tt[eé]' OR  a.rut ~* 'sc[aá]rl[eé]tt[eé]' OR  lower(a.email) ~* 'sc[aá]rl[eé]tt[eé]' OR  text(a.id) ~* 'sc[aá]rl[eé]tt[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]r[oó]l[ií]n[aá]' OR  a.rut ~* 'c[aá]r[oó]l[ií]n[aá]' OR  lower(a.email) ~* 'c[aá]r[oó]l[ií]n[aá]' OR  text(a.id) ~* 'c[aá]r[oó]l[ií]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'fl[oó]r[eé]s' OR  a.rut ~* 'fl[oó]r[eé]s' OR  lower(a.email) ~* 'fl[oó]r[eé]s' OR  text(a.id) ~* 'fl[oó]r[eé]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]rt[eé]z' OR  a.rut ~* 'c[oó]rt[eé]z' OR  lower(a.email) ~* 'c[oó]rt[eé]z' OR  text(a.id) ~* 'c[oó]rt[eé]z' ) 
