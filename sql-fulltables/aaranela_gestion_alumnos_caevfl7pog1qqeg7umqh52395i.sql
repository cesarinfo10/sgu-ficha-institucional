COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'r[oó]s[aá]l[eé]s' OR  a.rut ~* 'r[oó]s[aá]l[eé]s' OR  lower(a.email) ~* 'r[oó]s[aá]l[eé]s' OR  text(a.id) ~* 'r[oó]s[aá]l[eé]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]n[aá]mp[aá]' OR  a.rut ~* '[aá]n[aá]mp[aá]' OR  lower(a.email) ~* '[aá]n[aá]mp[aá]' OR  text(a.id) ~* '[aá]n[aá]mp[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[uú]c[ií][aá]n[aá]' OR  a.rut ~* 'l[uú]c[ií][aá]n[aá]' OR  lower(a.email) ~* 'l[uú]c[ií][aá]n[aá]' OR  text(a.id) ~* 'l[uú]c[ií][aá]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]nt[oó]n[eé]ll' OR  a.rut ~* '[aá]nt[oó]n[eé]ll' OR  lower(a.email) ~* '[aá]nt[oó]n[eé]ll' OR  text(a.id) ~* '[aá]nt[oó]n[eé]ll' ) 
