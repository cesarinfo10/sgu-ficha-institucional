COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'y[eé]v[ií]l[aá][oó]' OR  a.rut ~* 'y[eé]v[ií]l[aá][oó]' OR  lower(a.email) ~* 'y[eé]v[ií]l[aá][oó]' OR  text(a.id) ~* 'y[eé]v[ií]l[aá][oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'g[aá]r[aá]y' OR  a.rut ~* 'g[aá]r[aá]y' OR  lower(a.email) ~* 'g[aá]r[aá]y' OR  text(a.id) ~* 'g[aá]r[aá]y' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'byr[oó]n' OR  a.rut ~* 'byr[oó]n' OR  lower(a.email) ~* 'byr[oó]n' OR  text(a.id) ~* 'byr[oó]n' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]ndr[eé]s' OR  a.rut ~* '[aá]ndr[eé]s' OR  lower(a.email) ~* '[aá]ndr[eé]s' OR  text(a.id) ~* '[aá]ndr[eé]s' ) 
