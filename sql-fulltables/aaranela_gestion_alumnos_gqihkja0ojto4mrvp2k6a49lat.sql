COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]g[aá]ly' OR  a.rut ~* 'm[aá]g[aá]ly' OR  lower(a.email) ~* 'm[aá]g[aá]ly' OR  text(a.id) ~* 'm[aá]g[aá]ly' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[oó]r[eé]n[aá]' OR  a.rut ~* 'l[oó]r[eé]n[aá]' OR  lower(a.email) ~* 'l[oó]r[eé]n[aá]' OR  text(a.id) ~* 'l[oó]r[eé]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 's[aá][eé]z' OR  a.rut ~* 's[aá][eé]z' OR  lower(a.email) ~* 's[aá][eé]z' OR  text(a.id) ~* 's[aá][eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]lv[aá]r[eé]z+' OR  a.rut ~* '[aá]lv[aá]r[eé]z+' OR  lower(a.email) ~* '[aá]lv[aá]r[eé]z+' OR  text(a.id) ~* '[aá]lv[aá]r[eé]z+' ) 
