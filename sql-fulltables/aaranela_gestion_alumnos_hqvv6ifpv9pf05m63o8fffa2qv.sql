COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'r[oó]m[eé]r[oó]' OR  a.rut ~* 'r[oó]m[eé]r[oó]' OR  lower(a.email) ~* 'r[oó]m[eé]r[oó]' OR  text(a.id) ~* 'r[oó]m[eé]r[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'j[eé]r[eé]z' OR  a.rut ~* 'j[eé]r[eé]z' OR  lower(a.email) ~* 'j[eé]r[eé]z' OR  text(a.id) ~* 'j[eé]r[eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]r[ií][aá]' OR  a.rut ~* 'm[aá]r[ií][aá]' OR  lower(a.email) ~* 'm[aá]r[ií][aá]' OR  text(a.id) ~* 'm[aá]r[ií][aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[eé]l[eé]n[aá]' OR  a.rut ~* '[eé]l[eé]n[aá]' OR  lower(a.email) ~* '[eé]l[eé]n[aá]' OR  text(a.id) ~* '[eé]l[eé]n[aá]' ) 
