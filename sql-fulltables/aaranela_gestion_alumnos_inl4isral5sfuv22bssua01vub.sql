COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 's[aá]nt[ií][aá]g[oó]' OR  a.rut ~* 's[aá]nt[ií][aá]g[oó]' OR  lower(a.email) ~* 's[aá]nt[ií][aá]g[oó]' OR  text(a.id) ~* 's[aá]nt[ií][aá]g[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'm[eé]n[eé]s[eé]' OR  a.rut ~* 'm[eé]n[eé]s[eé]' OR  lower(a.email) ~* 'm[eé]n[eé]s[eé]' OR  text(a.id) ~* 'm[eé]n[eé]s[eé]' ) 
