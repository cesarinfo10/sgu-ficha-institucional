COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'p[aá][uú]l[aá]' OR  a.rut ~* 'p[aá][uú]l[aá]' OR  lower(a.email) ~* 'p[aá][uú]l[aá]' OR  text(a.id) ~* 'p[aá][uú]l[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'b[oó]b[aá]d[ií]ll[aá]' OR  a.rut ~* 'b[oó]b[aá]d[ií]ll[aá]' OR  lower(a.email) ~* 'b[oó]b[aá]d[ií]ll[aá]' OR  text(a.id) ~* 'b[oó]b[aá]d[ií]ll[aá]' ) 
