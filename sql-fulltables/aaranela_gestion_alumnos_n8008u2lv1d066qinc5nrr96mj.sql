COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 's[oó]l[aá]ng[eé]' OR  a.rut ~* 's[oó]l[aá]ng[eé]' OR  lower(a.email) ~* 's[oó]l[aá]ng[eé]' OR  text(a.id) ~* 's[oó]l[aá]ng[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'fr[aá]nc[oó][ií]s[eé]' OR  a.rut ~* 'fr[aá]nc[oó][ií]s[eé]' OR  lower(a.email) ~* 'fr[aá]nc[oó][ií]s[eé]' OR  text(a.id) ~* 'fr[aá]nc[oó][ií]s[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'b[aá]rr[aá]' OR  a.rut ~* 'b[aá]rr[aá]' OR  lower(a.email) ~* 'b[aá]rr[aá]' OR  text(a.id) ~* 'b[aá]rr[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]rt[ií]n[eé]z' OR  a.rut ~* 'm[aá]rt[ií]n[eé]z' OR  lower(a.email) ~* 'm[aá]rt[ií]n[eé]z' OR  text(a.id) ~* 'm[aá]rt[ií]n[eé]z' ) 
