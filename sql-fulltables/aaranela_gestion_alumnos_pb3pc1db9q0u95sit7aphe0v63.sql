COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'p[ií]n[oó]ch[eé]t' OR  a.rut ~* 'p[ií]n[oó]ch[eé]t' OR  lower(a.email) ~* 'p[ií]n[oó]ch[eé]t' OR  text(a.id) ~* 'p[ií]n[oó]ch[eé]t' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]v[ií][eé]r[eé]s' OR  a.rut ~* 'c[aá]v[ií][eé]r[eé]s' OR  lower(a.email) ~* 'c[aá]v[ií][eé]r[eé]s' OR  text(a.id) ~* 'c[aá]v[ií][eé]r[eé]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'r[aá]f[aá][eé]l' OR  a.rut ~* 'r[aá]f[aá][eé]l' OR  lower(a.email) ~* 'r[aá]f[aá][eé]l' OR  text(a.id) ~* 'r[aá]f[aá][eé]l' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'p[aá]tr[ií]c[ií][oó]' OR  a.rut ~* 'p[aá]tr[ií]c[ií][oó]' OR  lower(a.email) ~* 'p[aá]tr[ií]c[ií][oó]' OR  text(a.id) ~* 'p[aá]tr[ií]c[ií][oó]' ) 
