COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]r[oó]s' OR  a.rut ~* '[aá]r[oó]s' OR  lower(a.email) ~* '[aá]r[oó]s' OR  text(a.id) ~* '[aá]r[oó]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'g[oó]ng[oó]r[aá]' OR  a.rut ~* 'g[oó]ng[oó]r[aá]' OR  lower(a.email) ~* 'g[oó]ng[oó]r[aá]' OR  text(a.id) ~* 'g[oó]ng[oó]r[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'cr[ií]st[ií][aá]n' OR  a.rut ~* 'cr[ií]st[ií][aá]n' OR  lower(a.email) ~* 'cr[ií]st[ií][aá]n' OR  text(a.id) ~* 'cr[ií]st[ií][aá]n' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]t[ií][aá]s' OR  a.rut ~* 'm[aá]t[ií][aá]s' OR  lower(a.email) ~* 'm[aá]t[ií][aá]s' OR  text(a.id) ~* 'm[aá]t[ií][aá]s' ) 
