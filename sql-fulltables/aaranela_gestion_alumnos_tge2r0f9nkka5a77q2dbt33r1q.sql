COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'g[aá]j[aá]rd[oó]' OR  a.rut ~* 'g[aá]j[aá]rd[oó]' OR  lower(a.email) ~* 'g[aá]j[aá]rd[oó]' OR  text(a.id) ~* 'g[aá]j[aá]rd[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'g[oó]nz[aá]l[eé]z' OR  a.rut ~* 'g[oó]nz[aá]l[eé]z' OR  lower(a.email) ~* 'g[oó]nz[aá]l[eé]z' OR  text(a.id) ~* 'g[oó]nz[aá]l[eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'cr[ií]st[oó]b[aá]l' OR  a.rut ~* 'cr[ií]st[oó]b[aá]l' OR  lower(a.email) ~* 'cr[ií]st[oó]b[aá]l' OR  text(a.id) ~* 'cr[ií]st[oó]b[aá]l' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'fr[aá]nc[ií]sc[oó]' OR  a.rut ~* 'fr[aá]nc[ií]sc[oó]' OR  lower(a.email) ~* 'fr[aá]nc[ií]sc[oó]' OR  text(a.id) ~* 'fr[aá]nc[ií]sc[oó]' ) 
