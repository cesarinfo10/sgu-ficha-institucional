COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]rv[aá]l[aá]n' OR  a.rut ~* 'c[oó]rv[aá]l[aá]n' OR  lower(a.email) ~* 'c[oó]rv[aá]l[aá]n' OR  text(a.id) ~* 'c[oó]rv[aá]l[aá]n' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[eé]l[eé]d[oó]n' OR  a.rut ~* 'c[eé]l[eé]d[oó]n' OR  lower(a.email) ~* 'c[eé]l[eé]d[oó]n' OR  text(a.id) ~* 'c[eé]l[eé]d[oó]n' ) 
