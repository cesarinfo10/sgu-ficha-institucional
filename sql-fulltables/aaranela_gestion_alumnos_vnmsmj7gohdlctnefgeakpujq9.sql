COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'l[oó]rc[aá]' OR  a.rut ~* 'l[oó]rc[aá]' OR  lower(a.email) ~* 'l[oó]rc[aá]' OR  text(a.id) ~* 'l[oó]rc[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'm[eé]r[ií]n[oó]' OR  a.rut ~* 'm[eé]r[ií]n[oó]' OR  lower(a.email) ~* 'm[eé]r[ií]n[oó]' OR  text(a.id) ~* 'm[eé]r[ií]n[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'r[aá][uú]l' OR  a.rut ~* 'r[aá][uú]l' OR  lower(a.email) ~* 'r[aá][uú]l' OR  text(a.id) ~* 'r[aá][uú]l' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[eé]d[uú][aá]rd[oó]' OR  a.rut ~* '[eé]d[uú][aá]rd[oó]' OR  lower(a.email) ~* '[eé]d[uú][aá]rd[oó]' OR  text(a.id) ~* '[eé]d[uú][aá]rd[oó]' ) 
