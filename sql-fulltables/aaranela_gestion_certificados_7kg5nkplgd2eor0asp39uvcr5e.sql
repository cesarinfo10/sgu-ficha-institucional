COPY (SELECT ac.folio,vac.cod,trim(a.rut) AS rut,va.nombre AS alumno,trim(c.alias) AS carrera,a.jornada,r.nombre AS regimen,va.estado AS estado_alumno,cert.nombre AS docto,
                  ...
                  WHERE (lower(a.nombres||' '||a.apellidos) ~* 'g[oó]nz[aá]l[eé]z' OR  a.rut ~* 'g[oó]nz[aá]l[eé]z' OR  text(ac.folio) ~* 'g[oó]nz[aá]l[eé]z' OR  vac.cod ~* 'g[oó]nz[aá]l[eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 's[aá]nt[aá]n[aá]' OR  a.rut ~* 's[aá]nt[aá]n[aá]' OR  text(ac.folio) ~* 's[aá]nt[aá]n[aá]' OR  vac.cod ~* 's[aá]nt[aá]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[oó]d[eé]tt[eé]' OR  a.rut ~* '[oó]d[eé]tt[eé]' OR  text(ac.folio) ~* '[oó]d[eé]tt[eé]' OR  vac.cod ~* '[oó]d[eé]tt[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]th[eé]r[ií]n[eé]' OR  a.rut ~* 'c[aá]th[eé]r[ií]n[eé]' OR  text(ac.folio) ~* 'c[aá]th[eé]r[ií]n[eé]' OR  vac.cod ~* 'c[aá]th[eé]r[ií]n[eé]' ) 
