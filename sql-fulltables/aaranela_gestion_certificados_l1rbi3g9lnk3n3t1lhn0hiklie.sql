COPY (SELECT ac.folio,vac.cod,trim(a.rut) AS rut,va.nombre AS alumno,trim(c.alias) AS carrera,a.jornada,r.nombre AS regimen,va.estado AS estado_alumno,cert.nombre AS docto,
                  ...
                  WHERE (lower(a.nombres||' '||a.apellidos) ~* 'n[uú]ñ[eé]z' OR  a.rut ~* 'n[uú]ñ[eé]z' OR  text(ac.folio) ~* 'n[uú]ñ[eé]z' OR  vac.cod ~* 'n[uú]ñ[eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'g[uú][eé]rr[eé]r[oó]' OR  a.rut ~* 'g[uú][eé]rr[eé]r[oó]' OR  text(ac.folio) ~* 'g[uú][eé]rr[eé]r[oó]' OR  vac.cod ~* 'g[uú][eé]rr[eé]r[oó]' ) 
