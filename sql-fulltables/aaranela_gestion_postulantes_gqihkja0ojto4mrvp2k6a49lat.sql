COPY (SELECT trim(pap.rut) AS rut,vp.id,vp.nombre,to_char(vp.fecha_post,'DD-MM-YYYY') AS fecha_post,
                    ...
                    WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'h[eé]rm[oó]s[ií]ll[aá]' OR  pap.rut ~* 'h[eé]rm[oó]s[ií]ll[aá]' OR  text(pap.id) ~* 'h[eé]rm[oó]s[ií]ll[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]lm[oó]n[aá]c[ií]d' OR  pap.rut ~* '[aá]lm[oó]n[aá]c[ií]d' OR  text(pap.id) ~* '[aá]lm[oó]n[aá]c[ií]d' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'd[eé]n[ií]ss[eé]' OR  pap.rut ~* 'd[eé]n[ií]ss[eé]' OR  text(pap.id) ~* 'd[eé]n[ií]ss[eé]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[ií]v[oó]nn[eé]' OR  pap.rut ~* '[ií]v[oó]nn[eé]' OR  text(pap.id) ~* '[ií]v[oó]nn[eé]' ) 
