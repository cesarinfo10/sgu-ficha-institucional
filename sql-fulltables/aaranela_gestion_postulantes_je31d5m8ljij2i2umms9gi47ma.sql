COPY (SELECT trim(pap.rut) AS rut,vp.id,vp.nombre,to_char(vp.fecha_post,'DD-MM-YYYY') AS fecha_post,
                    ...
                    WHERE (lower(pap.nombres||' '||pap.apellidos) ~* '[oó]rt[eé]g[aá]' OR  pap.rut ~* '[oó]rt[eé]g[aá]' OR  text(pap.id) ~* '[oó]rt[eé]g[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[oó]br[eé]g[oó]n' OR  pap.rut ~* '[oó]br[eé]g[oó]n' OR  text(pap.id) ~* '[oó]br[eé]g[oó]n' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'm[aá]x[ií]m[ií]l[ií][aá]n[oó]' OR  pap.rut ~* 'm[aá]x[ií]m[ií]l[ií][aá]n[oó]' OR  text(pap.id) ~* 'm[aá]x[ií]m[ií]l[ií][aá]n[oó]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'p[aá][oó]l[oó]' OR  pap.rut ~* 'p[aá][oó]l[oó]' OR  text(pap.id) ~* 'p[aá][oó]l[oó]' ) 
