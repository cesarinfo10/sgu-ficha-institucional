COPY (SELECT trim(pap.rut) AS rut,vp.id,vp.nombre,to_char(vp.fecha_post,'DD-MM-YYYY') AS fecha_post,
                    ...
                    WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 's[oó]t[oó]' OR  pap.rut ~* 's[oó]t[oó]' OR  text(pap.id) ~* 's[oó]t[oó]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[ií]n[oó]str[oó]z[aá]' OR  pap.rut ~* '[ií]n[oó]str[oó]z[aá]' OR  text(pap.id) ~* '[ií]n[oó]str[oó]z[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]t[eé]n[eé][aá]' OR  pap.rut ~* '[aá]t[eé]n[eé][aá]' OR  text(pap.id) ~* '[aá]t[eé]n[eé][aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]l[eé]x[aá]ndr[aá]' OR  pap.rut ~* '[aá]l[eé]x[aá]ndr[aá]' OR  text(pap.id) ~* '[aá]l[eé]x[aá]ndr[aá]' ) 
