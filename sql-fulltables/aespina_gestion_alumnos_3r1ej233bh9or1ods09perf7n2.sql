COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'j[oó]rg[eé]' OR  a.rut ~* 'j[oó]rg[eé]' OR  lower(a.email) ~* 'j[oó]rg[eé]' OR  text(a.id) ~* 'j[oó]rg[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]l[eé]j[aá]ndr[oó]' OR  a.rut ~* '[aá]l[eé]j[aá]ndr[oó]' OR  lower(a.email) ~* '[aá]l[eé]j[aá]ndr[oó]' OR  text(a.id) ~* '[aá]l[eé]j[aá]ndr[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'g[aá]ll[eé]g[oó]s' OR  a.rut ~* 'g[aá]ll[eé]g[oó]s' OR  lower(a.email) ~* 'g[aá]ll[eé]g[oó]s' OR  text(a.id) ~* 'g[aá]ll[eé]g[oó]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'g[uú][aá]j[aá]rd[oó]' OR  a.rut ~* 'g[uú][aá]j[aá]rd[oó]' OR  lower(a.email) ~* 'g[uú][aá]j[aá]rd[oó]' OR  text(a.id) ~* 'g[uú][aá]j[aá]rd[oó]' ) 
