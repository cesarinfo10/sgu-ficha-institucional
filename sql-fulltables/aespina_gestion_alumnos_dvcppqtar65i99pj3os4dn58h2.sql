COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'k[aá]rl[aá]' OR  a.rut ~* 'k[aá]rl[aá]' OR  lower(a.email) ~* 'k[aá]rl[aá]' OR  text(a.id) ~* 'k[aá]rl[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[ií]ss[eé]tt[eé]' OR  a.rut ~* 'l[ií]ss[eé]tt[eé]' OR  lower(a.email) ~* 'l[ií]ss[eé]tt[eé]' OR  text(a.id) ~* 'l[ií]ss[eé]tt[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]b[eé]l[eé]' OR  a.rut ~* '[aá]b[eé]l[eé]' OR  lower(a.email) ~* '[aá]b[eé]l[eé]' OR  text(a.id) ~* '[aá]b[eé]l[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'v[aá]ld[eé]b[eé]n[ií]t[oó]' OR  a.rut ~* 'v[aá]ld[eé]b[eé]n[ií]t[oó]' OR  lower(a.email) ~* 'v[aá]ld[eé]b[eé]n[ií]t[oó]' OR  text(a.id) ~* 'v[aá]ld[eé]b[eé]n[ií]t[oó]' ) 
