COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'j[oó]s[eé]f[aá]' OR  a.rut ~* 'j[oó]s[eé]f[aá]' OR  lower(a.email) ~* 'j[oó]s[eé]f[aá]' OR  text(a.id) ~* 'j[oó]s[eé]f[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'g[aá]br[ií][eé]l[aá]' OR  a.rut ~* 'g[aá]br[ií][eé]l[aá]' OR  lower(a.email) ~* 'g[aá]br[ií][eé]l[aá]' OR  text(a.id) ~* 'g[aá]br[ií][eé]l[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'fryd[eé]r[uú]p' OR  a.rut ~* 'fryd[eé]r[uú]p' OR  lower(a.email) ~* 'fryd[eé]r[uú]p' OR  text(a.id) ~* 'fryd[eé]r[uú]p' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[eé]r[oó]n' OR  a.rut ~* 'c[eé]r[oó]n' OR  lower(a.email) ~* 'c[eé]r[oó]n' OR  text(a.id) ~* 'c[eé]r[oó]n' ) 
