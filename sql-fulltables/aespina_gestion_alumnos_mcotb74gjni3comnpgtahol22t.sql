COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'h[eé]rvyn' OR  a.rut ~* 'h[eé]rvyn' OR  lower(a.email) ~* 'h[eé]rvyn' OR  text(a.id) ~* 'h[eé]rvyn' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'j[oó]n[aá]th[aá]n' OR  a.rut ~* 'j[oó]n[aá]th[aá]n' OR  lower(a.email) ~* 'j[oó]n[aá]th[aá]n' OR  text(a.id) ~* 'j[oó]n[aá]th[aá]n' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]g[uú]d[eé]l[oó]' OR  a.rut ~* '[aá]g[uú]d[eé]l[oó]' OR  lower(a.email) ~* '[aá]g[uú]d[eé]l[oó]' OR  text(a.id) ~* '[aá]g[uú]d[eé]l[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'v[aá]l[eé]nc[ií][aá]' OR  a.rut ~* 'v[aá]l[eé]nc[ií][aá]' OR  lower(a.email) ~* 'v[aá]l[eé]nc[ií][aá]' OR  text(a.id) ~* 'v[aá]l[eé]nc[ií][aá]' ) 
