COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]m[ií]l[aá]' OR  a.rut ~* 'c[aá]m[ií]l[aá]' OR  lower(a.email) ~* 'c[aá]m[ií]l[aá]' OR  text(a.id) ~* 'c[aá]m[ií]l[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'f[eé]rn[aá]nd[aá]' OR  a.rut ~* 'f[eé]rn[aá]nd[aá]' OR  lower(a.email) ~* 'f[eé]rn[aá]nd[aá]' OR  text(a.id) ~* 'f[eé]rn[aá]nd[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'gr[ií]ll[eé]' OR  a.rut ~* 'gr[ií]ll[eé]' OR  lower(a.email) ~* 'gr[ií]ll[eé]' OR  text(a.id) ~* 'gr[ií]ll[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[eé]yt[oó]n' OR  a.rut ~* 'l[eé]yt[oó]n' OR  lower(a.email) ~* 'l[eé]yt[oó]n' OR  text(a.id) ~* 'l[eé]yt[oó]n' ) 
