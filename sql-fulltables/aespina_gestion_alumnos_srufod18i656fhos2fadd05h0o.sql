COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[eé]r[ií]k[aá]' OR  a.rut ~* '[eé]r[ií]k[aá]' OR  lower(a.email) ~* '[eé]r[ií]k[aá]' OR  text(a.id) ~* '[eé]r[ií]k[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'v[aá]l[eé]nt[ií]n[aá]' OR  a.rut ~* 'v[aá]l[eé]nt[ií]n[aá]' OR  lower(a.email) ~* 'v[aá]l[eé]nt[ií]n[aá]' OR  text(a.id) ~* 'v[aá]l[eé]nt[ií]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[eé]b[aá]ll[oó]s' OR  a.rut ~* 'c[eé]b[aá]ll[oó]s' OR  lower(a.email) ~* 'c[eé]b[aá]ll[oó]s' OR  text(a.id) ~* 'c[eé]b[aá]ll[oó]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'th[oó]m[aá]nn' OR  a.rut ~* 'th[oó]m[aá]nn' OR  lower(a.email) ~* 'th[oó]m[aá]nn' OR  text(a.id) ~* 'th[oó]m[aá]nn' ) 
