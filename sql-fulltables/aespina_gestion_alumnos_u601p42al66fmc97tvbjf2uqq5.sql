COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'l[uú][ií]s[aá]' OR  a.rut ~* 'l[uú][ií]s[aá]' OR  lower(a.email) ~* 'l[uú][ií]s[aá]' OR  text(a.id) ~* 'l[uú][ií]s[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]rc[eé]l[ií]n[aá]' OR  a.rut ~* 'm[aá]rc[eé]l[ií]n[aá]' OR  lower(a.email) ~* 'm[aá]rc[eé]l[ií]n[aá]' OR  text(a.id) ~* 'm[aá]rc[eé]l[ií]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]rn[eé]j[oó]' OR  a.rut ~* 'c[oó]rn[eé]j[oó]' OR  lower(a.email) ~* 'c[oó]rn[eé]j[oó]' OR  text(a.id) ~* 'c[oó]rn[eé]j[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'g[oó]nz[aá]l[eé]z' OR  a.rut ~* 'g[oó]nz[aá]l[eé]z' OR  lower(a.email) ~* 'g[oó]nz[aá]l[eé]z' OR  text(a.id) ~* 'g[oó]nz[aá]l[eé]z' ) 
