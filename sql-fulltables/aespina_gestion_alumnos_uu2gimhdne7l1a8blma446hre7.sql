COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]nt[ií]ll[aá]n[oó]' OR  a.rut ~* 'c[aá]nt[ií]ll[aá]n[oó]' OR  lower(a.email) ~* 'c[aá]nt[ií]ll[aá]n[oó]' OR  text(a.id) ~* 'c[aá]nt[ií]ll[aá]n[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'p[aá]lm[aá]' OR  a.rut ~* 'p[aá]lm[aá]' OR  lower(a.email) ~* 'p[aá]lm[aá]' OR  text(a.id) ~* 'p[aá]lm[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]l[eé]j[aá]ndr[oó]' OR  a.rut ~* '[aá]l[eé]j[aá]ndr[oó]' OR  lower(a.email) ~* '[aá]l[eé]j[aá]ndr[oó]' OR  text(a.id) ~* '[aá]l[eé]j[aá]ndr[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]m[eé]r[ií]c[oó]' OR  a.rut ~* '[aá]m[eé]r[ií]c[oó]' OR  lower(a.email) ~* '[aá]m[eé]r[ií]c[oó]' OR  text(a.id) ~* '[aá]m[eé]r[ií]c[oó]' ) 
