COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'h[oó]l[eé]nd[eé]r' OR  a.rut ~* 'h[oó]l[eé]nd[eé]r' OR  lower(a.email) ~* 'h[oó]l[eé]nd[eé]r' OR  text(a.id) ~* 'h[oó]l[eé]nd[eé]r' )  AND a.carrera_actual IN (95,100,19,2,69,1) 
