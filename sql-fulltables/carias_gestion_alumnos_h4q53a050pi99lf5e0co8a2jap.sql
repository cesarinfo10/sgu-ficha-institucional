COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'l[oó]z[aá]n[oó]' OR  a.rut ~* 'l[oó]z[aá]n[oó]' OR  lower(a.email) ~* 'l[oó]z[aá]n[oó]' OR  text(a.id) ~* 'l[oó]z[aá]n[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]st[aá]nz[oó]' OR  a.rut ~* 'c[oó]st[aá]nz[oó]' OR  lower(a.email) ~* 'c[oó]st[aá]nz[oó]' OR  text(a.id) ~* 'c[oó]st[aá]nz[oó]' ) 
