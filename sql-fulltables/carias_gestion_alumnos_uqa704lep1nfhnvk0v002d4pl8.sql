COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[oó]rn[eé]ll[aá]' OR  a.rut ~* '[oó]rn[eé]ll[aá]' OR  lower(a.email) ~* '[oó]rn[eé]ll[aá]' OR  text(a.id) ~* '[oó]rn[eé]ll[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[oó]t[eé][ií]z[aá]' OR  a.rut ~* '[oó]t[eé][ií]z[aá]' OR  lower(a.email) ~* '[oó]t[eé][ií]z[aá]' OR  text(a.id) ~* '[oó]t[eé][ií]z[aá]' ) 
