COPY (SELECT * FROM (SELECT DISTINCT ON (coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura)) p.id,coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura) AS nro_docto,
                ...
                WHERE (nro_boleta IS NOT NULL OR nro_boleta_e IS NOT NULL) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'c[uú][eé]v[aá]s' OR  pap.rut ~* 'c[uú][eé]v[aá]s' OR lower(a.nombres||' '||a.apellidos) ~* 'c[uú][eé]v[aá]s' OR lower(a3.nombres||' '||a3.apellidos) ~* 'c[uú][eé]v[aá]s' OR  a.rut ~* 'c[uú][eé]v[aá]s' OR a2.rut ~* 'c[uú][eé]v[aá]s' OR a3.rut ~* 'c[uú][eé]v[aá]s' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'q[uú][ií]ñ[oó]n[eé]s' OR  pap.rut ~* 'q[uú][ií]ñ[oó]n[eé]s' OR lower(a.nombres||' '||a.apellidos) ~* 'q[uú][ií]ñ[oó]n[eé]s' OR lower(a3.nombres||' '||a3.apellidos) ~* 'q[uú][ií]ñ[oó]n[eé]s' OR  a.rut ~* 'q[uú][ií]ñ[oó]n[eé]s' OR a2.rut ~* 'q[uú][ií]ñ[oó]n[eé]s' OR a3.rut ~* 'q[uú][ií]ñ[oó]n[eé]s' )  
