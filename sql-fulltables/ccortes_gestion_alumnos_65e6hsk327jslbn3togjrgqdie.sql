COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[ií]ntr[oó]d[uú]cc[ií][oó]n' OR  a.rut ~* '[ií]ntr[oó]d[uú]cc[ií][oó]n' OR  lower(a.email) ~* '[ií]ntr[oó]d[uú]cc[ií][oó]n' OR  text(a.id) ~* '[ií]ntr[oó]d[uú]cc[ií][oó]n' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]' OR  a.rut ~* '[aá]' OR  lower(a.email) ~* '[aá]' OR  text(a.id) ~* '[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[aá]' OR  a.rut ~* 'l[aá]' OR  lower(a.email) ~* 'l[aá]' OR  text(a.id) ~* 'l[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'v[ií]d[aá]' OR  a.rut ~* 'v[ií]d[aá]' OR  lower(a.email) ~* 'v[ií]d[aá]' OR  text(a.id) ~* 'v[ií]d[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]c[aá]d[eé]m[ií]c[aá]' OR  a.rut ~* '[aá]c[aá]d[eé]m[ií]c[aá]' OR  lower(a.email) ~* '[aá]c[aá]d[eé]m[ií]c[aá]' OR  text(a.id) ~* '[aá]c[aá]d[eé]m[ií]c[aá]' )  AND a.carrera_actual IN (95,100,2,69,1,19) 
