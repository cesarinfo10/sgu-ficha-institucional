COPY (SELECT trim(pap.rut) AS rut,vp.id,vp.nombre,to_char(vp.fecha_post,'DD-MM-YYYY') AS fecha_post,
                    ...
                    WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'c[aá]r[oó]l[ií]n[aá]' OR  pap.rut ~* 'c[aá]r[oó]l[ií]n[aá]' OR  text(pap.id) ~* 'c[aá]r[oó]l[ií]n[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'd[eé]l' OR  pap.rut ~* 'd[eé]l' OR  text(pap.id) ~* 'd[eé]l' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'c[aá]rm[eé]n' OR  pap.rut ~* 'c[aá]rm[eé]n' OR  text(pap.id) ~* 'c[aá]rm[eé]n' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'm[oó]r[aá]l[eé]s' OR  pap.rut ~* 'm[oó]r[aá]l[eé]s' OR  text(pap.id) ~* 'm[oó]r[aá]l[eé]s' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[oó]l[ií]v[aá]r[eé]s' OR  pap.rut ~* '[oó]l[ií]v[aá]r[eé]s' OR  text(pap.id) ~* '[oó]l[ií]v[aá]r[eé]s' ) 
