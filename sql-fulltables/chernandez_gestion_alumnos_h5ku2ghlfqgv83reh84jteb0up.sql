COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'l[eé][oó]n[aá]rd[oó]' OR  a.rut ~* 'l[eé][oó]n[aá]rd[oó]' OR  lower(a.email) ~* 'l[eé][oó]n[aá]rd[oó]' OR  text(a.id) ~* 'l[eé][oó]n[aá]rd[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'z[aá]v[aá]l[aá]' OR  a.rut ~* 'z[aá]v[aá]l[aá]' OR  lower(a.email) ~* 'z[aá]v[aá]l[aá]' OR  text(a.id) ~* 'z[aá]v[aá]l[aá]' )  AND a.carrera_actual IN (94,97,104,110,98,105,102,91,15,103,126,4) 
