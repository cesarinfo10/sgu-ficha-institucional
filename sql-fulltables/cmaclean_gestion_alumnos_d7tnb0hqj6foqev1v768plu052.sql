COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[oó]l[ií]v[eé]r' OR  a.rut ~* '[oó]l[ií]v[eé]r' OR  lower(a.email) ~* '[oó]l[ií]v[eé]r' OR  text(a.id) ~* '[oó]l[ií]v[eé]r' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'r[oó]ll[aá]n[oó]' OR  a.rut ~* 'r[oó]ll[aá]n[oó]' OR  lower(a.email) ~* 'r[oó]ll[aá]n[oó]' OR  text(a.id) ~* 'r[oó]ll[aá]n[oó]' ) 
