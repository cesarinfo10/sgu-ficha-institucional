COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'g[ií]s[eé]l[eé]' OR  a.rut ~* 'g[ií]s[eé]l[eé]' OR  lower(a.email) ~* 'g[ií]s[eé]l[eé]' OR  text(a.id) ~* 'g[ií]s[eé]l[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'n[aá]t[aá]l[ií]' OR  a.rut ~* 'n[aá]t[aá]l[ií]' OR  lower(a.email) ~* 'n[aá]t[aá]l[ií]' OR  text(a.id) ~* 'n[aá]t[aá]l[ií]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 's[aá][eé]z' OR  a.rut ~* 's[aá][eé]z' OR  lower(a.email) ~* 's[aá][eé]z' OR  text(a.id) ~* 's[aá][eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 's[aá]nh[uú][eé]z[aá]' OR  a.rut ~* 's[aá]nh[uú][eé]z[aá]' OR  lower(a.email) ~* 's[aá]nh[uú][eé]z[aá]' OR  text(a.id) ~* 's[aá]nh[uú][eé]z[aá]' ) 
