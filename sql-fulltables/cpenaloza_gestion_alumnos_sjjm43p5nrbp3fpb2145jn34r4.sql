COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'ps[ií]c[oó]l[oó]g[ií][aá]' OR  a.rut ~* 'ps[ií]c[oó]l[oó]g[ií][aá]' OR  lower(a.email) ~* 'ps[ií]c[oó]l[oó]g[ií][aá]' OR  text(a.id) ~* 'ps[ií]c[oó]l[oó]g[ií][aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 's[oó]c[ií][aá]l' OR  a.rut ~* 's[oó]c[ií][aá]l' OR  lower(a.email) ~* 's[oó]c[ií][aá]l' OR  text(a.id) ~* 's[oó]c[ií][aá]l' )  AND a.carrera_actual IN (101,62,26,88,18,3,36,67) 
