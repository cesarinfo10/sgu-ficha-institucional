COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'sh[aá]nd[oó]r' OR  a.rut ~* 'sh[aá]nd[oó]r' OR  lower(a.email) ~* 'sh[aá]nd[oó]r' OR  text(a.id) ~* 'sh[aá]nd[oó]r' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'd[aá]n[ií][eé]l' OR  a.rut ~* 'd[aá]n[ií][eé]l' OR  lower(a.email) ~* 'd[aá]n[ií][eé]l' OR  text(a.id) ~* 'd[aá]n[ií][eé]l' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'dr[oó]g[uú][eé]tt' OR  a.rut ~* 'dr[oó]g[uú][eé]tt' OR  lower(a.email) ~* 'dr[oó]g[uú][eé]tt' OR  text(a.id) ~* 'dr[oó]g[uú][eé]tt' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]rr[eé][aá]' OR  a.rut ~* 'c[oó]rr[eé][aá]' OR  lower(a.email) ~* 'c[oó]rr[eé][aá]' OR  text(a.id) ~* 'c[oó]rr[eé][aá]' ) 
