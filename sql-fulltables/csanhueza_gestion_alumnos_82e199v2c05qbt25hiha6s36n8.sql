COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[eé]v[eé]lyn' OR  a.rut ~* '[eé]v[eé]lyn' OR  lower(a.email) ~* '[eé]v[eé]lyn' OR  text(a.id) ~* '[eé]v[eé]lyn' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'y[eé]l[ií]s[aá]' OR  a.rut ~* 'y[eé]l[ií]s[aá]' OR  lower(a.email) ~* 'y[eé]l[ií]s[aá]' OR  text(a.id) ~* 'y[eé]l[ií]s[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'd[eé]' OR  a.rut ~* 'd[eé]' OR  lower(a.email) ~* 'd[eé]' OR  text(a.id) ~* 'd[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'f[eé]r[aá]r[ií]' OR  a.rut ~* 'f[eé]r[aá]r[ií]' OR  lower(a.email) ~* 'f[eé]r[aá]r[ií]' OR  text(a.id) ~* 'f[eé]r[aá]r[ií]' ) 
