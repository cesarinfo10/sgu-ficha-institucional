COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'd[aá]n[ií][aá]' OR  a.rut ~* 'd[aá]n[ií][aá]' OR  lower(a.email) ~* 'd[aá]n[ií][aá]' OR  text(a.id) ~* 'd[aá]n[ií][aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'g[oó]nz[aá]l[eé]z' OR  a.rut ~* 'g[oó]nz[aá]l[eé]z' OR  lower(a.email) ~* 'g[oó]nz[aá]l[eé]z' OR  text(a.id) ~* 'g[oó]nz[aá]l[eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 't[oó]l[oó]s[aá]' OR  a.rut ~* 't[oó]l[oó]s[aá]' OR  lower(a.email) ~* 't[oó]l[oó]s[aá]' OR  text(a.id) ~* 't[oó]l[oó]s[aá]' ) 
