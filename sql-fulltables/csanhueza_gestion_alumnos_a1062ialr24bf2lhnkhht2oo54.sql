COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'j[aá]n[ií]c[eé]' OR  a.rut ~* 'j[aá]n[ií]c[eé]' OR  lower(a.email) ~* 'j[aá]n[ií]c[eé]' OR  text(a.id) ~* 'j[aá]n[ií]c[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'k[ií][aá]b[eé]th' OR  a.rut ~* 'k[ií][aá]b[eé]th' OR  lower(a.email) ~* 'k[ií][aá]b[eé]th' OR  text(a.id) ~* 'k[ií][aá]b[eé]th' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'j[uú]sc[aá]m[aá]yt[aá]' OR  a.rut ~* 'j[uú]sc[aá]m[aá]yt[aá]' OR  lower(a.email) ~* 'j[uú]sc[aá]m[aá]yt[aá]' OR  text(a.id) ~* 'j[uú]sc[aá]m[aá]yt[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá][ií]c[eé]d[oó]' OR  a.rut ~* 'c[aá][ií]c[eé]d[oó]' OR  lower(a.email) ~* 'c[aá][ií]c[eé]d[oó]' OR  text(a.id) ~* 'c[aá][ií]c[eé]d[oó]' ) 
