COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'n[ií]c[oó]l[eé]' OR  a.rut ~* 'n[ií]c[oó]l[eé]' OR  lower(a.email) ~* 'n[ií]c[oó]l[eé]' OR  text(a.id) ~* 'n[ií]c[oó]l[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[eé]v[eé]lyn' OR  a.rut ~* '[eé]v[eé]lyn' OR  lower(a.email) ~* '[eé]v[eé]lyn' OR  text(a.id) ~* '[eé]v[eé]lyn' ) AND (lower(a.nombres||' '||a.apellidos) ~* 's[uú]b[ií][aá]br[eé]' OR  a.rut ~* 's[uú]b[ií][aá]br[eé]' OR  lower(a.email) ~* 's[uú]b[ií][aá]br[eé]' OR  text(a.id) ~* 's[uú]b[ií][aá]br[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'v[ií]ll[aá]gr[aá]' OR  a.rut ~* 'v[ií]ll[aá]gr[aá]' OR  lower(a.email) ~* 'v[ií]ll[aá]gr[aá]' OR  text(a.id) ~* 'v[ií]ll[aá]gr[aá]' ) 
