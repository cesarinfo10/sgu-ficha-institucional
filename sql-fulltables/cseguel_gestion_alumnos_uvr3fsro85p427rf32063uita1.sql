COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'r[oó]dr[ií]g[oó]' OR  a.rut ~* 'r[oó]dr[ií]g[oó]' OR  lower(a.email) ~* 'r[oó]dr[ií]g[oó]' OR  text(a.id) ~* 'r[oó]dr[ií]g[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'q[uú][ií]l[aá]l[eé][oó]' OR  a.rut ~* 'q[uú][ií]l[aá]l[eé][oó]' OR  lower(a.email) ~* 'q[uú][ií]l[aá]l[eé][oó]' OR  text(a.id) ~* 'q[uú][ií]l[aá]l[eé][oó]' )  AND a.carrera_actual IN (61,68,21) 
