COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'm[oó]l[ií]n[aá]v[eé]l[ií]z' OR  a.rut ~* 'm[oó]l[ií]n[aá]v[eé]l[ií]z' OR  lower(a.email) ~* 'm[oó]l[ií]n[aá]v[eé]l[ií]z' OR  text(a.id) ~* 'm[oó]l[ií]n[aá]v[eé]l[ií]z' ) 
