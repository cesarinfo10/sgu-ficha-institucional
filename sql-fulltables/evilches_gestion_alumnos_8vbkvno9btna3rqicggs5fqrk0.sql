COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'l[eé][oó]n[aá]rd[oó]' OR  a.rut ~* 'l[eé][oó]n[aá]rd[oó]' OR  lower(a.email) ~* 'l[eé][oó]n[aá]rd[oó]' OR  text(a.id) ~* 'l[eé][oó]n[aá]rd[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 't[oó]r[oó]' OR  a.rut ~* 't[oó]r[oó]' OR  lower(a.email) ~* 't[oó]r[oó]' OR  text(a.id) ~* 't[oó]r[oó]' ) 
