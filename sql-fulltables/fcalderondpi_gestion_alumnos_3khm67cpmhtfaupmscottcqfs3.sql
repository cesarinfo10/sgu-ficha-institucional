COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'r[eé]n[eé]' OR  a.rut ~* 'r[eé]n[eé]' OR  lower(a.email) ~* 'r[eé]n[eé]' OR  text(a.id) ~* 'r[eé]n[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'b[aá]lb[oó]nt[ií]n' OR  a.rut ~* 'b[aá]lb[oó]nt[ií]n' OR  lower(a.email) ~* 'b[aá]lb[oó]nt[ií]n' OR  text(a.id) ~* 'b[aá]lb[oó]nt[ií]n' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[eé]ch[eé]v[eé]rr[ií][aá]' OR  a.rut ~* '[eé]ch[eé]v[eé]rr[ií][aá]' OR  lower(a.email) ~* '[eé]ch[eé]v[eé]rr[ií][aá]' OR  text(a.id) ~* '[eé]ch[eé]v[eé]rr[ií][aá]' )  AND a.carrera_actual IN (59,57,27,28,33,54,56,31,58,60,55,30,32,29,76,79,82,81,83,78,80,38,115,114,77,125,147,148,161,160,163) 
