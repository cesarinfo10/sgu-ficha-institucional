COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 's[eé]rg[ií][oó]' OR  a.rut ~* 's[eé]rg[ií][oó]' OR  lower(a.email) ~* 's[eé]rg[ií][oó]' OR  text(a.id) ~* 's[eé]rg[ií][oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[ií]t[uú]rr[ií]' OR  a.rut ~* '[ií]t[uú]rr[ií]' OR  lower(a.email) ~* '[ií]t[uú]rr[ií]' OR  text(a.id) ~* '[ií]t[uú]rr[ií]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[uú]c[eé]r[oó]' OR  a.rut ~* 'l[uú]c[eé]r[oó]' OR  lower(a.email) ~* 'l[uú]c[eé]r[oó]' OR  text(a.id) ~* 'l[uú]c[eé]r[oó]' ) 
