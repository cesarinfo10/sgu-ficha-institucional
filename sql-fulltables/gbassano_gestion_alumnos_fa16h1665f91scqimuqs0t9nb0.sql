COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'l[uú][ií]s' OR  a.rut ~* 'l[uú][ií]s' OR  lower(a.email) ~* 'l[uú][ií]s' OR  text(a.id) ~* 'l[uú][ií]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'p[aá]tr[ií]c[ií][oó]' OR  a.rut ~* 'p[aá]tr[ií]c[ií][oó]' OR  lower(a.email) ~* 'p[aá]tr[ií]c[ií][oó]' OR  text(a.id) ~* 'p[aá]tr[ií]c[ií][oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'b[eé]rm[uú]d[eé]z' OR  a.rut ~* 'b[eé]rm[uú]d[eé]z' OR  lower(a.email) ~* 'b[eé]rm[uú]d[eé]z' OR  text(a.id) ~* 'b[eé]rm[uú]d[eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[eé][oó]n' OR  a.rut ~* 'l[eé][oó]n' OR  lower(a.email) ~* 'l[eé][oó]n' OR  text(a.id) ~* 'l[eé][oó]n' ) 
