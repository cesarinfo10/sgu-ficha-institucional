COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]cr[eé]n[aá]' OR  a.rut ~* 'm[aá]cr[eé]n[aá]' OR  lower(a.email) ~* 'm[aá]cr[eé]n[aá]' OR  text(a.id) ~* 'm[aá]cr[eé]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[oó]y[aá]rz[uú]n' OR  a.rut ~* '[oó]y[aá]rz[uú]n' OR  lower(a.email) ~* '[oó]y[aá]rz[uú]n' OR  text(a.id) ~* '[oó]y[aá]rz[uú]n' ) AND (lower(a.nombres||' '||a.apellidos) ~* '' OR  a.rut ~* '' OR  lower(a.email) ~* '' OR  text(a.id) ~* '' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]s[aá]n[oó]v[aá]' OR  a.rut ~* 'c[aá]s[aá]n[oó]v[aá]' OR  lower(a.email) ~* 'c[aá]s[aá]n[oó]v[aá]' OR  text(a.id) ~* 'c[aá]s[aá]n[oó]v[aá]' ) 
