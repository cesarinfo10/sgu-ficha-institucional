COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'v[aá]n[eé]s[aá]' OR  a.rut ~* 'v[aá]n[eé]s[aá]' OR  lower(a.email) ~* 'v[aá]n[eé]s[aá]' OR  text(a.id) ~* 'v[aá]n[eé]s[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 's[aá]ld[aá]ñ[oó]' OR  a.rut ~* 's[aá]ld[aá]ñ[oó]' OR  lower(a.email) ~* 's[aá]ld[aá]ñ[oó]' OR  text(a.id) ~* 's[aá]ld[aá]ñ[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]r[aá]v[eé]n[aá]' OR  a.rut ~* '[aá]r[aá]v[eé]n[aá]' OR  lower(a.email) ~* '[aá]r[aá]v[eé]n[aá]' OR  text(a.id) ~* '[aá]r[aá]v[eé]n[aá]' ) 
