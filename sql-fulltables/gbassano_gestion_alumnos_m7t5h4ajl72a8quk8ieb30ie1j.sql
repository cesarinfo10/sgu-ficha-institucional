COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]rm[aá]nd[oó]' OR  a.rut ~* '[aá]rm[aá]nd[oó]' OR  lower(a.email) ~* '[aá]rm[aá]nd[oó]' OR  text(a.id) ~* '[aá]rm[aá]nd[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]v[eé][oó]' OR  a.rut ~* 'c[aá]v[eé][oó]' OR  lower(a.email) ~* 'c[aá]v[eé][oó]' OR  text(a.id) ~* 'c[aá]v[eé][oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 's[aá]ng[uú][ií]n[eé]t[ií]' OR  a.rut ~* 's[aá]ng[uú][ií]n[eé]t[ií]' OR  lower(a.email) ~* 's[aá]ng[uú][ií]n[eé]t[ií]' OR  text(a.id) ~* 's[aá]ng[uú][ií]n[eé]t[ií]' ) 
