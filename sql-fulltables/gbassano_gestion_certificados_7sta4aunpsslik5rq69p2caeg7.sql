COPY (SELECT ac.folio,vac.cod,trim(a.rut) AS rut,va.nombre AS alumno,trim(c.alias) AS carrera,a.jornada,r.nombre AS regimen,va.estado AS estado_alumno,cert.nombre AS docto,
                  ...
                  WHERE (lower(a.nombres||' '||a.apellidos) ~* 'l[eé][aá]ndr[aá]' OR  a.rut ~* 'l[eé][aá]ndr[aá]' OR  text(ac.folio) ~* 'l[eé][aá]ndr[aá]' OR  vac.cod ~* 'l[eé][aá]ndr[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]lm[aá]rc[eé]g[uú][ií]' OR  a.rut ~* '[aá]lm[aá]rc[eé]g[uú][ií]' OR  text(ac.folio) ~* '[aá]lm[aá]rc[eé]g[uú][ií]' OR  vac.cod ~* '[aá]lm[aá]rc[eé]g[uú][ií]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]r[oó]n[aá]d[oó]' OR  a.rut ~* 'c[oó]r[oó]n[aá]d[oó]' OR  text(ac.folio) ~* 'c[oó]r[oó]n[aá]d[oó]' OR  vac.cod ~* 'c[oó]r[oó]n[aá]d[oó]' ) 
