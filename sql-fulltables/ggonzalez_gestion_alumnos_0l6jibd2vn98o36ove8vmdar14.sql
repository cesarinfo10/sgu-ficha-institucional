COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'r[oó]l[aá]nd[oó]' OR  a.rut ~* 'r[oó]l[aá]nd[oó]' OR  lower(a.email) ~* 'r[oó]l[aá]nd[oó]' OR  text(a.id) ~* 'r[oó]l[aá]nd[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]c[oó]st[aá]' OR  a.rut ~* '[aá]c[oó]st[aá]' OR  lower(a.email) ~* '[aá]c[oó]st[aá]' OR  text(a.id) ~* '[aá]c[oó]st[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'h[uú][aá]ll[aá]' OR  a.rut ~* 'h[uú][aá]ll[aá]' OR  lower(a.email) ~* 'h[uú][aá]ll[aá]' OR  text(a.id) ~* 'h[uú][aá]ll[aá]' ) 
