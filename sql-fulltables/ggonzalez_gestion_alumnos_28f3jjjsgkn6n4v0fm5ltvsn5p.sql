COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'l[eé][oó]n[oó]r' OR  a.rut ~* 'l[eé][oó]n[oó]r' OR  lower(a.email) ~* 'l[eé][oó]n[oó]r' OR  text(a.id) ~* 'l[eé][oó]n[oó]r' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'p[oó]l[eé]tt[eé]' OR  a.rut ~* 'p[oó]l[eé]tt[eé]' OR  lower(a.email) ~* 'p[oó]l[eé]tt[eé]' OR  text(a.id) ~* 'p[oó]l[eé]tt[eé]' ) 
