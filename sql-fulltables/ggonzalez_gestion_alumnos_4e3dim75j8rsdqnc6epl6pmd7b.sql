COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'j[uú][aá]n' OR  a.rut ~* 'j[uú][aá]n' OR  lower(a.email) ~* 'j[uú][aá]n' OR  text(a.id) ~* 'j[uú][aá]n' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]nch[aá]' OR  a.rut ~* 'c[oó]nch[aá]' OR  lower(a.email) ~* 'c[oó]nch[aá]' OR  text(a.id) ~* 'c[oó]nch[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]nch[aá]' OR  a.rut ~* 'c[oó]nch[aá]' OR  lower(a.email) ~* 'c[oó]nch[aá]' OR  text(a.id) ~* 'c[oó]nch[aá]' ) 
