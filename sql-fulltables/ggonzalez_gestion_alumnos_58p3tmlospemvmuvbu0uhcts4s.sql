COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'f[eé]l[ií]p[eé]' OR  a.rut ~* 'f[eé]l[ií]p[eé]' OR  lower(a.email) ~* 'f[eé]l[ií]p[eé]' OR  text(a.id) ~* 'f[eé]l[ií]p[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]rn[aá]ld[oó]' OR  a.rut ~* '[aá]rn[aá]ld[oó]' OR  lower(a.email) ~* '[aá]rn[aá]ld[oó]' OR  text(a.id) ~* '[aá]rn[aá]ld[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]v[aá]l[oó]s' OR  a.rut ~* '[aá]v[aá]l[oó]s' OR  lower(a.email) ~* '[aá]v[aá]l[oó]s' OR  text(a.id) ~* '[aá]v[aá]l[oó]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'g[uú][ií]ñ[eé]z' OR  a.rut ~* 'g[uú][ií]ñ[eé]z' OR  lower(a.email) ~* 'g[uú][ií]ñ[eé]z' OR  text(a.id) ~* 'g[uú][ií]ñ[eé]z' ) 
