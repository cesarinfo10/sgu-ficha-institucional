COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'h[eé]nr[ií]q[uú][eé]z' OR  a.rut ~* 'h[eé]nr[ií]q[uú][eé]z' OR  lower(a.email) ~* 'h[eé]nr[ií]q[uú][eé]z' OR  text(a.id) ~* 'h[eé]nr[ií]q[uú][eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[eé]t[eé]l[ií][eé]r' OR  a.rut ~* 'l[eé]t[eé]l[ií][eé]r' OR  lower(a.email) ~* 'l[eé]t[eé]l[ií][eé]r' OR  text(a.id) ~* 'l[eé]t[eé]l[ií][eé]r' ) 
