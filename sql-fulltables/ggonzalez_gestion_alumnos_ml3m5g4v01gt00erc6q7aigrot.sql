COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'c[eé]l[ií]n[aá]' OR  a.rut ~* 'c[eé]l[ií]n[aá]' OR  lower(a.email) ~* 'c[eé]l[ií]n[aá]' OR  text(a.id) ~* 'c[eé]l[ií]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'f[uú][eé]nz[aá]l[ií]d[aá]' OR  a.rut ~* 'f[uú][eé]nz[aá]l[ií]d[aá]' OR  lower(a.email) ~* 'f[uú][eé]nz[aá]l[ií]d[aá]' OR  text(a.id) ~* 'f[uú][eé]nz[aá]l[ií]d[aá]' ) 
