COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'd[aá]y[aá]n' OR  a.rut ~* 'd[aá]y[aá]n' OR  lower(a.email) ~* 'd[aá]y[aá]n' OR  text(a.id) ~* 'd[aá]y[aá]n' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]r[oó]n[aá]d[oó]' OR  a.rut ~* 'c[oó]r[oó]n[aá]d[oó]' OR  lower(a.email) ~* 'c[oó]r[oó]n[aá]d[oó]' OR  text(a.id) ~* 'c[oó]r[oó]n[aá]d[oó]' ) 
