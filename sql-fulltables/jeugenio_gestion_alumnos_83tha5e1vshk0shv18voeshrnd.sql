COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'cl[aá][uú]d[ií][aá]' OR  a.rut ~* 'cl[aá][uú]d[ií][aá]' OR  lower(a.email) ~* 'cl[aá][uú]d[ií][aá]' OR  text(a.id) ~* 'cl[aá][uú]d[ií][aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]l[eé]gr[ií][aá]' OR  a.rut ~* '[aá]l[eé]gr[ií][aá]' OR  lower(a.email) ~* '[aá]l[eé]gr[ií][aá]' OR  text(a.id) ~* '[aá]l[eé]gr[ií][aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá][uú]j[eé]r' OR  a.rut ~* 'm[aá][uú]j[eé]r' OR  lower(a.email) ~* 'm[aá][uú]j[eé]r' OR  text(a.id) ~* 'm[aá][uú]j[eé]r' ) 
