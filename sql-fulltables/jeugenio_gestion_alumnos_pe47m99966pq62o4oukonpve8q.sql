COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'k[aá]r[eé]nlm[aá]rt[ií]n[eé]zf@gm[aá][ií]l.c[oó]m' OR  a.rut ~* 'k[aá]r[eé]nlm[aá]rt[ií]n[eé]zf@gm[aá][ií]l.c[oó]m' OR  lower(a.email) ~* 'k[aá]r[eé]nlm[aá]rt[ií]n[eé]zf@gm[aá][ií]l.c[oó]m' OR  text(a.id) ~* 'k[aá]r[eé]nlm[aá]rt[ií]n[eé]zf@gm[aá][ií]l.c[oó]m' ) 
