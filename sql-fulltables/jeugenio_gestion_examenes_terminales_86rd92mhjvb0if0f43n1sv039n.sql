COPY (SELECT et.id,to_char(et.fecha_reg,'dd-tmMon-YYYY HH24:MI') AS fecha_reg,
				  ...
				  WHERE true   AND (vete.nombres::text ~* 'h[eé]ct[oó]r' OR  vete.ruts::text ~* 'h[eé]ct[oó]r' ) AND (vete.nombres::text ~* 'c[uú]b[ií]ll[oó]s' OR  vete.ruts::text ~* 'c[uú]b[ií]ll[oó]s' )  			  
