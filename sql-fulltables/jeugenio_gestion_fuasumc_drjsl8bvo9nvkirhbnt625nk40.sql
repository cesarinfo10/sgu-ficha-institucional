COPY (SELECT fuas.id,fuas.ano,a.id AS id_alumno,a.rut,a.nombres,apellidos,c.alias||'-'||a.jornada AS carrera,
             ...
             WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'l[uú][ií]s' OR  a.rut ~* 'l[uú][ií]s' OR  text(a.id) ~* 'l[uú][ií]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]l[eé]j[aá]ndr[oó]' OR  a.rut ~* '[aá]l[eé]j[aá]ndr[oó]' OR  text(a.id) ~* '[aá]l[eé]j[aá]ndr[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[aá]t[oó]rr[eé]' OR  a.rut ~* 'l[aá]t[oó]rr[eé]' OR  text(a.id) ~* 'l[aá]t[oó]rr[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[aá]t[oó]rr' OR  a.rut ~* 'l[aá]t[oó]rr' OR  text(a.id) ~* 'l[aá]t[oó]rr' ) 
