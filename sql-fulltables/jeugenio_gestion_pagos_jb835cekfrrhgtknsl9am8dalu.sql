COPY (SELECT * FROM (SELECT DISTINCT ON (coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura)) p.id,coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura) AS nro_docto,
                ...
                WHERE (nro_boleta IS NOT NULL OR nro_boleta_e IS NOT NULL) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'r[oó]j[aá]s' OR  pap.rut ~* 'r[oó]j[aá]s' OR lower(a.nombres||' '||a.apellidos) ~* 'r[oó]j[aá]s' OR lower(a3.nombres||' '||a3.apellidos) ~* 'r[oó]j[aá]s' OR  a.rut ~* 'r[oó]j[aá]s' OR a2.rut ~* 'r[oó]j[aá]s' OR a3.rut ~* 'r[oó]j[aá]s' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]g[uú][ií]rr[eé]' OR  pap.rut ~* '[aá]g[uú][ií]rr[eé]' OR lower(a.nombres||' '||a.apellidos) ~* '[aá]g[uú][ií]rr[eé]' OR lower(a3.nombres||' '||a3.apellidos) ~* '[aá]g[uú][ií]rr[eé]' OR  a.rut ~* '[aá]g[uú][ií]rr[eé]' OR a2.rut ~* '[aá]g[uú][ií]rr[eé]' OR a3.rut ~* '[aá]g[uú][ií]rr[eé]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'k[aá]r[ií]n[aá]' OR  pap.rut ~* 'k[aá]r[ií]n[aá]' OR lower(a.nombres||' '||a.apellidos) ~* 'k[aá]r[ií]n[aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* 'k[aá]r[ií]n[aá]' OR  a.rut ~* 'k[aá]r[ií]n[aá]' OR a2.rut ~* 'k[aá]r[ií]n[aá]' OR a3.rut ~* 'k[aá]r[ií]n[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]r[aá]c[eé]ly' OR  pap.rut ~* '[aá]r[aá]c[eé]ly' OR lower(a.nombres||' '||a.apellidos) ~* '[aá]r[aá]c[eé]ly' OR lower(a3.nombres||' '||a3.apellidos) ~* '[aá]r[aá]c[eé]ly' OR  a.rut ~* '[aá]r[aá]c[eé]ly' OR a2.rut ~* '[aá]r[aá]c[eé]ly' OR a3.rut ~* '[aá]r[aá]c[eé]ly' )  
