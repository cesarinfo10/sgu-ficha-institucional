COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'f[oó]rt[uú]n[aá]t[oó]' OR  a.rut ~* 'f[oó]rt[uú]n[aá]t[oó]' OR  lower(a.email) ~* 'f[oó]rt[uú]n[aá]t[oó]' OR  text(a.id) ~* 'f[oó]rt[uú]n[aá]t[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'p[ií]r[aá][ií]n[oó]' OR  a.rut ~* 'p[ií]r[aá][ií]n[oó]' OR  lower(a.email) ~* 'p[ií]r[aá][ií]n[oó]' OR  text(a.id) ~* 'p[ií]r[aá][ií]n[oó]' ) 
