COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'pspc[aá]rl[eé][eé]@gm[aá][ií]l.c[oó]m' OR  a.rut ~* 'pspc[aá]rl[eé][eé]@gm[aá][ií]l.c[oó]m' OR  lower(a.email) ~* 'pspc[aá]rl[eé][eé]@gm[aá][ií]l.c[oó]m' OR  text(a.id) ~* 'pspc[aá]rl[eé][eé]@gm[aá][ií]l.c[oó]m' ) 
