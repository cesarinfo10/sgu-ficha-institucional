COPY (SELECT *,CASE WHEN tasa_riesgo BETWEEN 75 and 100 THEN 'Alto'
                ...
                FROM (SELECT *,round((riesgo_morosidad+riesgo_asistencia+riesgo_af5+riesgo_acra+riesgo_c1)::float*100/(25              +10               +10        +10+10)) AS tasa_riesgo,
                      (riesgo_morosidad+riesgo_asistencia+riesgo_af5+riesgo_acra+riesgo_c1) AS suma_puntos_riesgo,
					  (25              +10               +10        +10+10) AS base_riesgo 
