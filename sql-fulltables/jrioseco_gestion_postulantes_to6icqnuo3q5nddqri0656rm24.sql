COPY (SELECT trim(pap.rut) AS rut,vp.id,vp.nombre,to_char(vp.fecha_post,'DD-MM-YYYY') AS fecha_post,
                    ...
                    WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'c[aá]m[ií]l[oó]' OR  pap.rut ~* 'c[aá]m[ií]l[oó]' OR  text(pap.id) ~* 'c[aá]m[ií]l[oó]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'n[ií]c[oó]l[aá]s' OR  pap.rut ~* 'n[ií]c[oó]l[aá]s' OR  text(pap.id) ~* 'n[ií]c[oó]l[aá]s' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'br[aá]y[aá]n' OR  pap.rut ~* 'br[aá]y[aá]n' OR  text(pap.id) ~* 'br[aá]y[aá]n' ) 
