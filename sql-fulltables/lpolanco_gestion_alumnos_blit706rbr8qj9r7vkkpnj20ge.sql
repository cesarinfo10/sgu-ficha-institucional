COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]r[ií][aá]' OR  a.rut ~* 'm[aá]r[ií][aá]' OR  lower(a.email) ~* 'm[aá]r[ií][aá]' OR  text(a.id) ~* 'm[aá]r[ií][aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'fr[aá]nc[ií]sc[aá]' OR  a.rut ~* 'fr[aá]nc[ií]sc[aá]' OR  lower(a.email) ~* 'fr[aá]nc[ií]sc[aá]' OR  text(a.id) ~* 'fr[aá]nc[ií]sc[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]ll[ií]p[aá]l' OR  a.rut ~* 'c[oó]ll[ií]p[aá]l' OR  lower(a.email) ~* 'c[oó]ll[ií]p[aá]l' OR  text(a.id) ~* 'c[oó]ll[ií]p[aá]l' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'h[uú][aá]nq[uú][ií]' OR  a.rut ~* 'h[uú][aá]nq[uú][ií]' OR  lower(a.email) ~* 'h[uú][aá]nq[uú][ií]' OR  text(a.id) ~* 'h[uú][aá]nq[uú][ií]' ) 
