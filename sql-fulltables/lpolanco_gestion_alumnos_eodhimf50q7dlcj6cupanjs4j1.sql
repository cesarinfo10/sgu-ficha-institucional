COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'r[eé]y[eé]s' OR  a.rut ~* 'r[eé]y[eé]s' OR  lower(a.email) ~* 'r[eé]y[eé]s' OR  text(a.id) ~* 'r[eé]y[eé]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[eé]t[eé]l[ií][eé]r' OR  a.rut ~* 'l[eé]t[eé]l[ií][eé]r' OR  lower(a.email) ~* 'l[eé]t[eé]l[ií][eé]r' OR  text(a.id) ~* 'l[eé]t[eé]l[ií][eé]r' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'r[oó]l[aá]nd[oó]' OR  a.rut ~* 'r[oó]l[aá]nd[oó]' OR  lower(a.email) ~* 'r[oó]l[aá]nd[oó]' OR  text(a.id) ~* 'r[oó]l[aá]nd[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]ndr[eé]s' OR  a.rut ~* '[aá]ndr[eé]s' OR  lower(a.email) ~* '[aá]ndr[eé]s' OR  text(a.id) ~* '[aá]ndr[eé]s' ) 
