COPY (SELECT *,CASE WHEN tasa_riesgo BETWEEN 75 and 100 THEN 'Alto'
			    ...
			    FROM (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos) AS apellidos,initcap(a.nombres) AS nombres,
                       ...
                       (SELECT count(id_alumno) FROM cargas_academicas WHERE id_alumno=a.id AND id_curso IN (SELECT id FROM cursos WHERE semestre=2 AND ano=2023) AND (id_estado IS NULL OR id_estado <> 6)) AS cant_cursos_insc,
                       (SELECT count(id_alumno) FROM cargas_academicas WHERE id_alumno=a.id AND id_curso IN (SELECT id FROM cursos WHERE semestre=1 AND ano=2023) AND (id_estado IS NULL OR id_estado <> 6)) AS cant_cursos_insc_2dosem,
                       ...
                       WHERE id_sesion IN (SELECT id FROM cursos_sesiones WHERE fecha BETWEEN now()::date-'4 weeks'::interval AND now()::date 
                                                                            AND id_curso IN (SELECT id FROM cursos WHERE ano=2023 AND semestre=2)) 
                   ...
                   WHERE rut_alumno=a.rut AND sp.alias='AF5') ELSE 10 END AS riesgo_af5,
                    ...
                    WHERE rut_alumno=a.rut AND sp.alias='ACRA') ELSE 10 END AS riesgo_acra,
                       ...
                       END AS riesgo_c1,
                       CASE WHEN (SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND c1='N/A' GROUP BY id_alumno) = (SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id ) THEN 10 ELSE 0 END AS base_riesgo_c1,
                       CASE WHEN round((SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne1='Aprob' GROUP BY id_alumno)::numeric*100/(SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id )) BETWEEN 67 AND 100 THEN 0
                            ...
                            WHEN round((SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne1='Aprob' GROUP BY id_alumno)::numeric*100/(SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id )) BETWEEN 0  AND 33  THEN 15
                            WHEN (SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne1='Aprob' GROUP BY id_alumno) IS NULL                                          THEN 15
                       END AS riesgo_s1,
                       CASE WHEN (SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne1='N/A' GROUP BY id_alumno) = (SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id ) THEN 15 ELSE 0 END AS base_riesgo_s1,
                       CASE WHEN round((SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne2='Aprob' GROUP BY id_alumno)::numeric*100/(SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id )) BETWEEN 67 AND 100 THEN 0
                            ...
                            WHEN round((SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne2='Aprob' GROUP BY id_alumno)::numeric*100/(SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id )) BETWEEN 0  AND 33  THEN 20
                            WHEN (SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne2='Aprob' GROUP BY id_alumno) IS NULL                                          THEN 20
                       END AS riesgo_s2,
                       CASE WHEN (SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne2='N/A' GROUP BY id_alumno) = (SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id ) THEN 20 ELSE 0 END AS base_riesgo_s2,
                       ...
                       CASE WHEN (SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND c1='N/A' GROUP BY id_alumno) = (SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id ) THEN 10 ELSE 0 END AS base_riesgo_c1_sem2,
                       CASE WHEN round((SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne1='Aprob' GROUP BY id_alumno)::numeric*100/(SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id )) BETWEEN 67 AND 100 THEN 0
                            ...
                            WHEN round((SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne1='Aprob' GROUP BY id_alumno)::numeric*100/(SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id )) BETWEEN 0  AND 33  THEN 20
                            WHEN (SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne1='Aprob' GROUP BY id_alumno) IS NULL                                          THEN 20
                       END AS riesgo_s1_sem2,
                       CASE WHEN (SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne1='N/A' GROUP BY id_alumno) = (SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id ) THEN 20 ELSE 0 END AS base_riesgo_s1_sem2,
                       CASE WHEN round((SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne2='Aprob' GROUP BY id_alumno)::numeric*100/(SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id )) BETWEEN 67 AND 100 THEN 0
                            ...
                            WHEN round((SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne2='Aprob' GROUP BY id_alumno)::numeric*100/(SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id )) BETWEEN 0  AND 33  THEN 15
                            WHEN (SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne2='Aprob' GROUP BY id_alumno) IS NULL                                          THEN 15
                       END AS riesgo_s2_sem2,
                       CASE WHEN (SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne2='N/A' GROUP BY id_alumno) = (SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id ) THEN 20 ELSE 0 END AS base_riesgo_s2_sem2,
                       (SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND c1='NSP' GROUP BY id_alumno) AS c1_nsp,(SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND c1='N/A' GROUP BY id_alumno) AS c1_na,(SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND c1='Reprob' GROUP BY id_alumno) AS c1_reprob,(SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND c1='Aprob' GROUP BY id_alumno) AS c1_aprob,
                       (SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne1='NSP' GROUP BY id_alumno) AS s1_nsp,(SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne1='N/A' GROUP BY id_alumno) AS s1_na,(SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne1='Reprob' GROUP BY id_alumno) AS s1_reprob,(SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne1='Aprob' GROUP BY id_alumno) AS s1_aprob,
                       (SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne2='NSP' GROUP BY id_alumno) AS s2_nsp,(SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne2='N/A' GROUP BY id_alumno) AS s2_na,(SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne2='Reprob' GROUP BY id_alumno) AS s2_reprob,(SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=2 AND id_alumno=a.id AND solemne2='Aprob' GROUP BY id_alumno) AS s2_aprob,
                       (SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND c1='NSP' GROUP BY id_alumno) AS c1_nsp_2sem,(SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND c1='N/A' GROUP BY id_alumno) AS c1_na_2sem,(SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND c1='Reprob' GROUP BY id_alumno) AS c1_reprob_2sem,(SELECT count(c1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND c1='Aprob' GROUP BY id_alumno) AS c1_aprob_2sem,
                       (SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne1='NSP' GROUP BY id_alumno) AS s1_nsp_2sem,(SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne1='N/A' GROUP BY id_alumno) AS s1_na_2sem,(SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne1='Reprob' GROUP BY id_alumno) AS s1_reprob_2sem,(SELECT count(solemne1) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne1='Aprob' GROUP BY id_alumno) AS s1_aprob_2sem,
                       (SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne2='NSP' GROUP BY id_alumno) AS s2_nsp_2sem,(SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne2='N/A' GROUP BY id_alumno) AS s2_na_2sem,(SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne2='Reprob' GROUP BY id_alumno) AS s2_reprob_2sem,(SELECT count(solemne2) FROM vista_seg_rendacad WHERE ano=2023 AND semestre=1 AND id_alumno=a.id AND solemne2='Aprob' GROUP BY id_alumno) AS s2_aprob_2sem,
                ...
                WHERE true  AND (a.cohorte = '2023') AND (a.semestre_cohorte = 2) AND (a.estado = '1') AND (a.id IN (SELECT id_alumno FROM matriculas WHERE ano=2023 AND semestre=2))  AND a.carrera_actual IN (59,57,27,28,33,54,56,31,58,60,55,30,32,29,76,79,82,81,83,78,80,38,115,114,77,125,147,148) 
