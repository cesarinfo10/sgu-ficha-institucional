COPY (SELECT trim(pap.rut) AS rut,vp.id,vp.nombre,to_char(vp.fecha_post,'DD-MM-YYYY') AS fecha_post,
                    ...
                    WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'c[aá]mp[oó]s' OR  pap.rut ~* 'c[aá]mp[oó]s' OR  text(pap.id) ~* 'c[aá]mp[oó]s' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'c[eé][aá]' OR  pap.rut ~* 'c[eé][aá]' OR  text(pap.id) ~* 'c[eé][aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '' OR  pap.rut ~* '' OR  text(pap.id) ~* '' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'r[eé]n[aá]t[aá]' OR  pap.rut ~* 'r[eé]n[aá]t[aá]' OR  text(pap.id) ~* 'r[eé]n[aá]t[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]nt[oó]n[ií][aá]' OR  pap.rut ~* '[aá]nt[oó]n[ií][aá]' OR  text(pap.id) ~* '[aá]nt[oó]n[ií][aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '' OR  pap.rut ~* '' OR  text(pap.id) ~* '' ) 
