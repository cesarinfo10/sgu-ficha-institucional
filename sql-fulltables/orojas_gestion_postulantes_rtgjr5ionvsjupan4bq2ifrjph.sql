COPY (SELECT trim(pap.rut) AS rut,vp.id,vp.nombre,to_char(vp.fecha_post,'DD-MM-YYYY') AS fecha_post,
                    ...
                    WHERE (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]c[eé][ií]t[uú]n[oó]' OR  pap.rut ~* '[aá]c[eé][ií]t[uú]n[oó]' OR  text(pap.id) ~* '[aá]c[eé][ií]t[uú]n[oó]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'g[oó]d[oó]y' OR  pap.rut ~* 'g[oó]d[oó]y' OR  text(pap.id) ~* 'g[oó]d[oó]y' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 's[ií][oó]m[aá]r[aá]' OR  pap.rut ~* 's[ií][oó]m[aá]r[aá]' OR  text(pap.id) ~* 's[ií][oó]m[aá]r[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '' OR  pap.rut ~* '' OR  text(pap.id) ~* '' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]l[eé]j[aá]ndr[aá]' OR  pap.rut ~* '[aá]l[eé]j[aá]ndr[aá]' OR  text(pap.id) ~* '[aá]l[eé]j[aá]ndr[aá]' ) 
