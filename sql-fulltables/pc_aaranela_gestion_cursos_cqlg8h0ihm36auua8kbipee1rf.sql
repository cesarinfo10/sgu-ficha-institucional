COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'n[eé]g[oó]c[ií][oó]' OR       cod_asignatura ~* 'n[eé]g[oó]c[ií][oó]' OR       text(c.id) ~* 'n[eé]g[oó]c[ií][oó]' OR       lower(profesor) ~* 'n[eé]g[oó]c[ií][oó]')  AND (lower(asignatura) ~* '[ií]nt[eé]rn[aá]c[ií][oó]n[aá]l' OR       cod_asignatura ~* '[ií]nt[eé]rn[aá]c[ií][oó]n[aá]l' OR       text(c.id) ~* '[ií]nt[eé]rn[aá]c[ií][oó]n[aá]l' OR       lower(profesor) ~* '[ií]nt[eé]rn[aá]c[ií][oó]n[aá]l')  
