COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'v[aá]l[eé]r[ií][aá]' OR       cod_asignatura ~* 'v[aá]l[eé]r[ií][aá]' OR       text(c.id) ~* 'v[aá]l[eé]r[ií][aá]' OR       lower(profesor) ~* 'v[aá]l[eé]r[ií][aá]')  AND (lower(asignatura) ~* 'm[ií]q[uú][eé]l[eé]s' OR       cod_asignatura ~* 'm[ií]q[uú][eé]l[eé]s' OR       text(c.id) ~* 'm[ií]q[uú][eé]l[eé]s' OR       lower(profesor) ~* 'm[ií]q[uú][eé]l[eé]s')  AND (lower(asignatura) ~* 'm[oó]r[aá]l[eé]s' OR       cod_asignatura ~* 'm[oó]r[aá]l[eé]s' OR       text(c.id) ~* 'm[oó]r[aá]l[eé]s' OR       lower(profesor) ~* 'm[oó]r[aá]l[eé]s')  
