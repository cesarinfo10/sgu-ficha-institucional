COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'n[eé][uú]r[oó]-[aá]n[aá]t[oó]m[oó]f[ií]s[ií][oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* 'n[eé][uú]r[oó]-[aá]n[aá]t[oó]m[oó]f[ií]s[ií][oó]l[oó]g[ií][aá]' OR       text(c.id) ~* 'n[eé][uú]r[oó]-[aá]n[aá]t[oó]m[oó]f[ií]s[ií][oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* 'n[eé][uú]r[oó]-[aá]n[aá]t[oó]m[oó]f[ií]s[ií][oó]l[oó]g[ií][aá]')  
