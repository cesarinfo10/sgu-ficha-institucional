COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'r[oó]ss[aá]n[aá]' OR       cod_asignatura ~* 'r[oó]ss[aá]n[aá]' OR       text(c.id) ~* 'r[oó]ss[aá]n[aá]' OR       lower(profesor) ~* 'r[oó]ss[aá]n[aá]')  AND (lower(asignatura) ~* 'p[aá][uú]l[ií]n[aá]' OR       cod_asignatura ~* 'p[aá][uú]l[ií]n[aá]' OR       text(c.id) ~* 'p[aá][uú]l[ií]n[aá]' OR       lower(profesor) ~* 'p[aá][uú]l[ií]n[aá]')  AND (lower(asignatura) ~* 'c[aá]ñ[eé]t[eé]' OR       cod_asignatura ~* 'c[aá]ñ[eé]t[eé]' OR       text(c.id) ~* 'c[aá]ñ[eé]t[eé]' OR       lower(profesor) ~* 'c[aá]ñ[eé]t[eé]')  AND (lower(asignatura) ~* 'd[uú][aá]rt[eé]' OR       cod_asignatura ~* 'd[uú][aá]rt[eé]' OR       text(c.id) ~* 'd[uú][aá]rt[eé]' OR       lower(profesor) ~* 'd[uú][aá]rt[eé]')  
