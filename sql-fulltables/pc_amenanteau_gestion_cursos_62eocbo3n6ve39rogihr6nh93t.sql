COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'c[aá]r[oó]l[ií]n[aá]' OR       cod_asignatura ~* 'c[aá]r[oó]l[ií]n[aá]' OR       text(c.id) ~* 'c[aá]r[oó]l[ií]n[aá]' OR       lower(profesor) ~* 'c[aá]r[oó]l[ií]n[aá]')  AND (lower(asignatura) ~* '[eé]ls[aá]' OR       cod_asignatura ~* '[eé]ls[aá]' OR       text(c.id) ~* '[eé]ls[aá]' OR       lower(profesor) ~* '[eé]ls[aá]')  AND (lower(asignatura) ~* '[ií]c[eé]l[aá]' OR       cod_asignatura ~* '[ií]c[eé]l[aá]' OR       text(c.id) ~* '[ií]c[eé]l[aá]' OR       lower(profesor) ~* '[ií]c[eé]l[aá]')  AND (lower(asignatura) ~* '' OR       cod_asignatura ~* '' OR       text(c.id) ~* '' OR       lower(profesor) ~* '')  AND (lower(asignatura) ~* 'c[uú]c[uú]m[ií]d[eé]s' OR       cod_asignatura ~* 'c[uú]c[uú]m[ií]d[eé]s' OR       text(c.id) ~* 'c[uú]c[uú]m[ií]d[eé]s' OR       lower(profesor) ~* 'c[uú]c[uú]m[ií]d[eé]s')  AND (lower(asignatura) ~* 'c[aá]ld[eé]r[oó]n' OR       cod_asignatura ~* 'c[aá]ld[eé]r[oó]n' OR       text(c.id) ~* 'c[aá]ld[eé]r[oó]n' OR       lower(profesor) ~* 'c[aá]ld[eé]r[oó]n')  AND array[101,62,26,88,18,3,36,67,150,12] && (ids_carreras)  
