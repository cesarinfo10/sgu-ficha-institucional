COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[aá]lfr[eé]d[oó]' OR       cod_asignatura ~* '[aá]lfr[eé]d[oó]' OR       text(c.id) ~* '[aá]lfr[eé]d[oó]' OR       lower(profesor) ~* '[aá]lfr[eé]d[oó]')  AND (lower(asignatura) ~* 'd[aá]n[ií]l[oó]' OR       cod_asignatura ~* 'd[aá]n[ií]l[oó]' OR       text(c.id) ~* 'd[aá]n[ií]l[oó]' OR       lower(profesor) ~* 'd[aá]n[ií]l[oó]')  AND (lower(asignatura) ~* 'g[oó]nz[aá]l[eé]z' OR       cod_asignatura ~* 'g[oó]nz[aá]l[eé]z' OR       text(c.id) ~* 'g[oó]nz[aá]l[eé]z' OR       lower(profesor) ~* 'g[oó]nz[aá]l[eé]z')  AND (lower(asignatura) ~* 'm[eé]d[ií]n[aá]' OR       cod_asignatura ~* 'm[eé]d[ií]n[aá]' OR       text(c.id) ~* 'm[eé]d[ií]n[aá]' OR       lower(profesor) ~* 'm[eé]d[ií]n[aá]')  AND array[101,62,26,88,18,3,36,67,150,12] && (ids_carreras)  
