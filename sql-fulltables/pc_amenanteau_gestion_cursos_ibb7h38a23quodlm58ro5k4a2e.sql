COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND c.ano=2023  AND c.semestre=1  AND (car.regimen = 'PRE')  AND 1 IN (c.dia1,c.dia2,c.dia3)  AND id_carrera IN (101,62,26,88,18,3,36,67,12)  
