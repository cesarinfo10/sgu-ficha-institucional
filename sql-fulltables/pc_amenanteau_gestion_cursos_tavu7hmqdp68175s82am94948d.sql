COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[ií]t[aá]l[oó]' OR       cod_asignatura ~* '[ií]t[aá]l[oó]' OR       text(c.id) ~* '[ií]t[aá]l[oó]' OR       lower(profesor) ~* '[ií]t[aá]l[oó]')  AND (lower(asignatura) ~* 'v[ií]rg[ií]l[ií][oó]' OR       cod_asignatura ~* 'v[ií]rg[ií]l[ií][oó]' OR       text(c.id) ~* 'v[ií]rg[ií]l[ií][oó]' OR       lower(profesor) ~* 'v[ií]rg[ií]l[ií][oó]')  AND (lower(asignatura) ~* 'g[ií]r[aá][uú]d[oó]' OR       cod_asignatura ~* 'g[ií]r[aá][uú]d[oó]' OR       text(c.id) ~* 'g[ií]r[aá][uú]d[oó]' OR       lower(profesor) ~* 'g[ií]r[aá][uú]d[oó]')  AND (lower(asignatura) ~* 't[oó]rr[eé]s' OR       cod_asignatura ~* 't[oó]rr[eé]s' OR       text(c.id) ~* 't[oó]rr[eé]s' OR       lower(profesor) ~* 't[oó]rr[eé]s')  AND id_carrera IN (101,62,26,88,18,3,36,67,12)  
