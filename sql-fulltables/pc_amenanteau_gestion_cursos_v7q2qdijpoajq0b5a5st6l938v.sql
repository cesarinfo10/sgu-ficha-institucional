COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND c.ano=2023  AND c.semestre=1  AND c.seccion BETWEEN 5 AND 9  AND NOT c.cerrado  AND c.tipo_clase = 'a Distancia'  AND (car.regimen = 'PRE')  AND id_carrera IN (101,62,26,88,18,3,36,67,12)  
