COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '14014' OR       cod_asignatura ~* '14014' OR       text(c.id) ~* '14014' OR       lower(profesor) ~* '14014')  AND id_carrera IN (101,62,26,88,18,3,36,67,12)  
