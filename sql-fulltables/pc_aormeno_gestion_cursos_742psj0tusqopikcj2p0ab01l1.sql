COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'j[eé]nn[ií]f[eé]r' OR       cod_asignatura ~* 'j[eé]nn[ií]f[eé]r' OR       text(c.id) ~* 'j[eé]nn[ií]f[eé]r' OR       lower(profesor) ~* 'j[eé]nn[ií]f[eé]r')  AND (lower(asignatura) ~* 'z[uú]r[ií]n[aá]' OR       cod_asignatura ~* 'z[uú]r[ií]n[aá]' OR       text(c.id) ~* 'z[uú]r[ií]n[aá]' OR       lower(profesor) ~* 'z[uú]r[ií]n[aá]')  AND (lower(asignatura) ~* 'q[uú][ií]ñ[oó]n[eé]z' OR       cod_asignatura ~* 'q[uú][ií]ñ[oó]n[eé]z' OR       text(c.id) ~* 'q[uú][ií]ñ[oó]n[eé]z' OR       lower(profesor) ~* 'q[uú][ií]ñ[oó]n[eé]z')  AND (lower(asignatura) ~* 'f[uú][eé]nt[eé]s' OR       cod_asignatura ~* 'f[uú][eé]nt[eé]s' OR       text(c.id) ~* 'f[uú][eé]nt[eé]s' OR       lower(profesor) ~* 'f[uú][eé]nt[eé]s')  AND (lower(asignatura) ~* '' OR       cod_asignatura ~* '' OR       text(c.id) ~* '' OR       lower(profesor) ~* '')  AND id_carrera IN (59,57,27,28,33,54,56,31,58,60,55,30,32,29,76,79,82,81,83,78,80,38,115,114,77,125,12)  
