COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'c[aá]r[oó]l[ií]n[aá]' OR       cod_asignatura ~* 'c[aá]r[oó]l[ií]n[aá]' OR       text(c.id) ~* 'c[aá]r[oó]l[ií]n[aá]' OR       lower(profesor) ~* 'c[aá]r[oó]l[ií]n[aá]')  AND (lower(asignatura) ~* '[aá]l[eé]x[aá]ndr[aá]' OR       cod_asignatura ~* '[aá]l[eé]x[aá]ndr[aá]' OR       text(c.id) ~* '[aá]l[eé]x[aá]ndr[aá]' OR       lower(profesor) ~* '[aá]l[eé]x[aá]ndr[aá]')  AND (lower(asignatura) ~* '' OR       cod_asignatura ~* '' OR       text(c.id) ~* '' OR       lower(profesor) ~* '')  AND (lower(asignatura) ~* 's[eé]g[uú][eé]l' OR       cod_asignatura ~* 's[eé]g[uú][eé]l' OR       text(c.id) ~* 's[eé]g[uú][eé]l' OR       lower(profesor) ~* 's[eé]g[uú][eé]l')  AND (lower(asignatura) ~* 'g[aá]ll[eé]g[oó]s' OR       cod_asignatura ~* 'g[aá]ll[eé]g[oó]s' OR       text(c.id) ~* 'g[aá]ll[eé]g[oó]s' OR       lower(profesor) ~* 'g[aá]ll[eé]g[oó]s')  
