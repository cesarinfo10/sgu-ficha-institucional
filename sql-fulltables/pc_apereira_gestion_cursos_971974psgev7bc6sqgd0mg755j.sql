COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'tr[oó]nc[oó]s[oó]' OR       cod_asignatura ~* 'tr[oó]nc[oó]s[oó]' OR       text(c.id) ~* 'tr[oó]nc[oó]s[oó]' OR       lower(profesor) ~* 'tr[oó]nc[oó]s[oó]')  
