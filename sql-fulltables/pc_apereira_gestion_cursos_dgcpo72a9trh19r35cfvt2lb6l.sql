COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'c[aá]r[oó]l[ií]n[aá]' OR       cod_asignatura ~* 'c[aá]r[oó]l[ií]n[aá]' OR       text(c.id) ~* 'c[aá]r[oó]l[ií]n[aá]' OR       lower(profesor) ~* 'c[aá]r[oó]l[ií]n[aá]')  AND (lower(asignatura) ~* 'p[aá]m[eé]l[aá]' OR       cod_asignatura ~* 'p[aá]m[eé]l[aá]' OR       text(c.id) ~* 'p[aá]m[eé]l[aá]' OR       lower(profesor) ~* 'p[aá]m[eé]l[aá]')  AND (lower(asignatura) ~* 'p[aá]rr[aá]' OR       cod_asignatura ~* 'p[aá]rr[aá]' OR       text(c.id) ~* 'p[aá]rr[aá]' OR       lower(profesor) ~* 'p[aá]rr[aá]')  AND (lower(asignatura) ~* '[uú]rb[ií]n[aá]' OR       cod_asignatura ~* '[uú]rb[ií]n[aá]' OR       text(c.id) ~* '[uú]rb[ií]n[aá]' OR       lower(profesor) ~* '[uú]rb[ií]n[aá]')  AND (lower(asignatura) ~* '' OR       cod_asignatura ~* '' OR       text(c.id) ~* '' OR       lower(profesor) ~* '')  
