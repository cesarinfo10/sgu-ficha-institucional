COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'm[uú]nd[oó]' OR       cod_asignatura ~* 'm[uú]nd[oó]' OR       text(c.id) ~* 'm[uú]nd[oó]' OR       lower(profesor) ~* 'm[uú]nd[oó]')  AND (lower(asignatura) ~* 'b[ií][oó]l[oó]g[ií]c[oó]' OR       cod_asignatura ~* 'b[ií][oó]l[oó]g[ií]c[oó]' OR       text(c.id) ~* 'b[ií][oó]l[oó]g[ií]c[oó]' OR       lower(profesor) ~* 'b[ií][oó]l[oó]g[ií]c[oó]')  
