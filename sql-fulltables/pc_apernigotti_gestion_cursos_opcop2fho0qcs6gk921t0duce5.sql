COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'n[aá]v[aá]rr[oó]' OR       cod_asignatura ~* 'n[aá]v[aá]rr[oó]' OR       text(c.id) ~* 'n[aá]v[aá]rr[oó]' OR       lower(profesor) ~* 'n[aá]v[aá]rr[oó]')  AND id_carrera IN (95,100,2,69,1,19,12)  
