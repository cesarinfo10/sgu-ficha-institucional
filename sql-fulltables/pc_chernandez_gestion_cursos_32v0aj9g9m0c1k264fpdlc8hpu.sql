COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'pr[aá]ct[ií]c[aá]' OR       cod_asignatura ~* 'pr[aá]ct[ií]c[aá]' OR       text(c.id) ~* 'pr[aá]ct[ií]c[aá]' OR       lower(profesor) ~* 'pr[aá]ct[ií]c[aá]')  AND (lower(asignatura) ~* 'pr[oó]f[eé]s[ií][oó]n[aá]l' OR       cod_asignatura ~* 'pr[oó]f[eé]s[ií][oó]n[aá]l' OR       text(c.id) ~* 'pr[oó]f[eé]s[ií][oó]n[aá]l' OR       lower(profesor) ~* 'pr[oó]f[eé]s[ií][oó]n[aá]l')  AND (lower(asignatura) ~* '[aá]mb[ií]t[oó]' OR       cod_asignatura ~* '[aá]mb[ií]t[oó]' OR       text(c.id) ~* '[aá]mb[ií]t[oó]' OR       lower(profesor) ~* '[aá]mb[ií]t[oó]')  AND (lower(asignatura) ~* 's[oó]c[ií][aá]l' OR       cod_asignatura ~* 's[oó]c[ií][aá]l' OR       text(c.id) ~* 's[oó]c[ií][aá]l' OR       lower(profesor) ~* 's[oó]c[ií][aá]l')  AND array[94,97,104,110,98,105,102,91,15,103,126,4,12] && (ids_carreras)  
