COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'gr[eé]g[oó]r[ií][oó]' OR       cod_asignatura ~* 'gr[eé]g[oó]r[ií][oó]' OR       text(c.id) ~* 'gr[eé]g[oó]r[ií][oó]' OR       lower(profesor) ~* 'gr[eé]g[oó]r[ií][oó]')  AND array[94,97,104,110,98,105,102,91,15,103,126,4,157,12] && (ids_carreras)  
