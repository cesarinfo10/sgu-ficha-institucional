COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       text(c.id) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]')  AND array[94,97,104,110,98,105,102,91,15,103,126,4,12] && (ids_carreras)  
