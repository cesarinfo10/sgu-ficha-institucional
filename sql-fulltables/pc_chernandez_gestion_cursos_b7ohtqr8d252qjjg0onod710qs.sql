COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[aá]ng[eé]l[aá]' OR       cod_asignatura ~* '[aá]ng[eé]l[aá]' OR       text(c.id) ~* '[aá]ng[eé]l[aá]' OR       lower(profesor) ~* '[aá]ng[eé]l[aá]')  AND (lower(asignatura) ~* '[ií]s[aá]b[eé]l' OR       cod_asignatura ~* '[ií]s[aá]b[eé]l' OR       text(c.id) ~* '[ií]s[aá]b[eé]l' OR       lower(profesor) ~* '[ií]s[aá]b[eé]l')  AND (lower(asignatura) ~* 'v[eé]rg[aá]r[aá]' OR       cod_asignatura ~* 'v[eé]rg[aá]r[aá]' OR       text(c.id) ~* 'v[eé]rg[aá]r[aá]' OR       lower(profesor) ~* 'v[eé]rg[aá]r[aá]')  AND (lower(asignatura) ~* 'v[aá]l[eé]nz[uú][eé]l[aá]' OR       cod_asignatura ~* 'v[aá]l[eé]nz[uú][eé]l[aá]' OR       text(c.id) ~* 'v[aá]l[eé]nz[uú][eé]l[aá]' OR       lower(profesor) ~* 'v[aá]l[eé]nz[uú][eé]l[aá]')  AND id_carrera IN (94,97,104,110,98,105,102,91,15,103,126,4,12)  
