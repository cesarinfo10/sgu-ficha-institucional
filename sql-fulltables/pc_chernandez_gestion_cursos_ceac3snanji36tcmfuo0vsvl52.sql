COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'gr[eé]g[oó]r[ií][oó]' OR       cod_asignatura ~* 'gr[eé]g[oó]r[ií][oó]' OR       text(c.id) ~* 'gr[eé]g[oó]r[ií][oó]' OR       lower(profesor) ~* 'gr[eé]g[oó]r[ií][oó]')  AND id_carrera IN (94,97,104,110,98,105,102,91,15,103,126,4,12)  
