COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'l[eé]t[eé]l[ií][eé]r' OR       cod_asignatura ~* 'l[eé]t[eé]l[ií][eé]r' OR       text(c.id) ~* 'l[eé]t[eé]l[ií][eé]r' OR       lower(profesor) ~* 'l[eé]t[eé]l[ií][eé]r')  AND id_carrera IN (94,97,104,110,98,105,102,91,15,103,126,4,12)  
