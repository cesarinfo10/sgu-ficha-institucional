COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'g[eé]n[eé]r[oó]' OR       cod_asignatura ~* 'g[eé]n[eé]r[oó]' OR       text(c.id) ~* 'g[eé]n[eé]r[oó]' OR       lower(profesor) ~* 'g[eé]n[eé]r[oó]')  AND array[94,97,104,110,98,105,102,91,15,103,126,4,157,12] && (ids_carreras)  
