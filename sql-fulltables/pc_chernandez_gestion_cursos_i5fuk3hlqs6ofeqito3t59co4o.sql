COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       text(c.id) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]')  AND id_carrera IN (94,97,104,110,98,105,102,91,15,103,126,4,12)  
