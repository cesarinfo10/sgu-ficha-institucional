COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'c[oó]gn[ií]c[ií][oó]n' OR       cod_asignatura ~* 'c[oó]gn[ií]c[ií][oó]n' OR       text(c.id) ~* 'c[oó]gn[ií]c[ií][oó]n' OR       lower(profesor) ~* 'c[oó]gn[ií]c[ií][oó]n')  AND (lower(asignatura) ~* 'y' OR       cod_asignatura ~* 'y' OR       text(c.id) ~* 'y' OR       lower(profesor) ~* 'y')  AND (lower(asignatura) ~* 'n[eé][uú]r[oó]c[ií][eé]nc[ií][aá]' OR       cod_asignatura ~* 'n[eé][uú]r[oó]c[ií][eé]nc[ií][aá]' OR       text(c.id) ~* 'n[eé][uú]r[oó]c[ií][eé]nc[ií][aá]' OR       lower(profesor) ~* 'n[eé][uú]r[oó]c[ií][eé]nc[ií][aá]')  AND array[94,97,104,110,98,105,102,91,15,103,126,157,4,12] && (ids_carreras)  
