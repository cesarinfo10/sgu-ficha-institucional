COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[aá]lb[eé]rt[oó]' OR       cod_asignatura ~* '[aá]lb[eé]rt[oó]' OR       text(c.id) ~* '[aá]lb[eé]rt[oó]' OR       lower(profesor) ~* '[aá]lb[eé]rt[oó]')  AND (lower(asignatura) ~* 'j[oó]s[eé]' OR       cod_asignatura ~* 'j[oó]s[eé]' OR       text(c.id) ~* 'j[oó]s[eé]' OR       lower(profesor) ~* 'j[oó]s[eé]')  AND (lower(asignatura) ~* 'l[uú][eé]ng[oó]' OR       cod_asignatura ~* 'l[uú][eé]ng[oó]' OR       text(c.id) ~* 'l[uú][eé]ng[oó]' OR       lower(profesor) ~* 'l[uú][eé]ng[oó]')  AND (lower(asignatura) ~* 'f[eé]r[eé][ií]r[aá]' OR       cod_asignatura ~* 'f[eé]r[eé][ií]r[aá]' OR       text(c.id) ~* 'f[eé]r[eé][ií]r[aá]' OR       lower(profesor) ~* 'f[eé]r[eé][ií]r[aá]')  AND id_carrera IN (94,97,104,110,98,105,102,91,15,103,126,4,12)  
