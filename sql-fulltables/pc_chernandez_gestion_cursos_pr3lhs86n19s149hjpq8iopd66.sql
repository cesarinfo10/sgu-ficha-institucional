COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[aá]ntr[oó]p[oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* '[aá]ntr[oó]p[oó]l[oó]g[ií][aá]' OR       text(c.id) ~* '[aá]ntr[oó]p[oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* '[aá]ntr[oó]p[oó]l[oó]g[ií][aá]')  AND array[94,97,104,110,98,105,102,91,15,103,126,4,157,12] && (ids_carreras)  
