COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'l[eé][oó]n[aá]rd[oó]' OR       cod_asignatura ~* 'l[eé][oó]n[aá]rd[oó]' OR       text(c.id) ~* 'l[eé][oó]n[aá]rd[oó]' OR       lower(profesor) ~* 'l[eé][oó]n[aá]rd[oó]')  AND (lower(asignatura) ~* 'r[oó]dr[ií]g[oó]' OR       cod_asignatura ~* 'r[oó]dr[ií]g[oó]' OR       text(c.id) ~* 'r[oó]dr[ií]g[oó]' OR       lower(profesor) ~* 'r[oó]dr[ií]g[oó]')  AND (lower(asignatura) ~* 'v[ií]ll[aá]rr[oó][eé]l' OR       cod_asignatura ~* 'v[ií]ll[aá]rr[oó][eé]l' OR       text(c.id) ~* 'v[ií]ll[aá]rr[oó][eé]l' OR       lower(profesor) ~* 'v[ií]ll[aá]rr[oó][eé]l')  AND (lower(asignatura) ~* '[ií]l[ií]c' OR       cod_asignatura ~* '[ií]l[ií]c' OR       text(c.id) ~* '[ií]l[ií]c' OR       lower(profesor) ~* '[ií]l[ií]c')  AND id_carrera IN (94,97,104,110,98,105,102,91,15,103,126,4,12)  
