COPY (SELECT c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'd[aá]n[ií][eé]l' OR       cod_asignatura ~* 'd[aá]n[ií][eé]l' OR       text(c.id) ~* 'd[aá]n[ií][eé]l' OR       lower(profesor) ~* 'd[aá]n[ií][eé]l')  AND (lower(asignatura) ~* 'g[oó]nz[aá]l[oó]' OR       cod_asignatura ~* 'g[oó]nz[aá]l[oó]' OR       text(c.id) ~* 'g[oó]nz[aá]l[oó]' OR       lower(profesor) ~* 'g[oó]nz[aá]l[oó]')  AND (lower(asignatura) ~* 'p[aá]sc[aá]l' OR       cod_asignatura ~* 'p[aá]sc[aá]l' OR       text(c.id) ~* 'p[aá]sc[aá]l' OR       lower(profesor) ~* 'p[aá]sc[aá]l')  AND (lower(asignatura) ~* 's[aá]nt[ií]b[aá]ñ[eé]z' OR       cod_asignatura ~* 's[aá]nt[ií]b[aá]ñ[eé]z' OR       text(c.id) ~* 's[aá]nt[ií]b[aá]ñ[eé]z' OR       lower(profesor) ~* 's[aá]nt[ií]b[aá]ñ[eé]z')  AND (lower(asignatura) ~* 'g[uú][eé]rr[eé]r[oó]' OR       cod_asignatura ~* 'g[uú][eé]rr[eé]r[oó]' OR       text(c.id) ~* 'g[uú][eé]rr[eé]r[oó]' OR       lower(profesor) ~* 'g[uú][eé]rr[eé]r[oó]')  AND id_carrera IN (94,97,104,110,98,105,102,91,15,103,126,4,12)  
