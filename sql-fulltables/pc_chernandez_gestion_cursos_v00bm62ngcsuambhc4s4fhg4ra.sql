COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'f[aá]t[ií]m[aá]' OR       cod_asignatura ~* 'f[aá]t[ií]m[aá]' OR       text(c.id) ~* 'f[aá]t[ií]m[aá]' OR       lower(profesor) ~* 'f[aá]t[ií]m[aá]')  AND (lower(asignatura) ~* 'j[oó]s[eé]f[ií]n[aá]' OR       cod_asignatura ~* 'j[oó]s[eé]f[ií]n[aá]' OR       text(c.id) ~* 'j[oó]s[eé]f[ií]n[aá]' OR       lower(profesor) ~* 'j[oó]s[eé]f[ií]n[aá]')  AND (lower(asignatura) ~* 'n[eé]v[aá]d[oó]' OR       cod_asignatura ~* 'n[eé]v[aá]d[oó]' OR       text(c.id) ~* 'n[eé]v[aá]d[oó]' OR       lower(profesor) ~* 'n[eé]v[aá]d[oó]')  AND (lower(asignatura) ~* '[oó]l[ií]v[aá]r[eé]s' OR       cod_asignatura ~* '[oó]l[ií]v[aá]r[eé]s' OR       text(c.id) ~* '[oó]l[ií]v[aá]r[eé]s' OR       lower(profesor) ~* '[oó]l[ií]v[aá]r[eé]s')  AND array[94,97,104,110,98,105,102,91,15,103,126,4,157,12] && (ids_carreras)  
