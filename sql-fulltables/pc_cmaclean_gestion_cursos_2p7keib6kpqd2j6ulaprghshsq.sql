COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'ps[ií]c[oó]f[ií]s[ií][oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* 'ps[ií]c[oó]f[ií]s[ií][oó]l[oó]g[ií][aá]' OR       text(c.id) ~* 'ps[ií]c[oó]f[ií]s[ií][oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* 'ps[ií]c[oó]f[ií]s[ií][oó]l[oó]g[ií][aá]')  
