COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'd[eé]s[aá]rr[oó]ll[oó]' OR       cod_asignatura ~* 'd[eé]s[aá]rr[oó]ll[oó]' OR       text(c.id) ~* 'd[eé]s[aá]rr[oó]ll[oó]' OR       lower(profesor) ~* 'd[eé]s[aá]rr[oó]ll[oó]')  AND (lower(asignatura) ~* 'd[eé]l' OR       cod_asignatura ~* 'd[eé]l' OR       text(c.id) ~* 'd[eé]l' OR       lower(profesor) ~* 'd[eé]l')  AND (lower(asignatura) ~* 'p[eé]ns[aá]m[ií][eé]nt[oó]' OR       cod_asignatura ~* 'p[eé]ns[aá]m[ií][eé]nt[oó]' OR       text(c.id) ~* 'p[eé]ns[aá]m[ií][eé]nt[oó]' OR       lower(profesor) ~* 'p[eé]ns[aá]m[ií][eé]nt[oó]')  AND (lower(asignatura) ~* '' OR       cod_asignatura ~* '' OR       text(c.id) ~* '' OR       lower(profesor) ~* '')  
