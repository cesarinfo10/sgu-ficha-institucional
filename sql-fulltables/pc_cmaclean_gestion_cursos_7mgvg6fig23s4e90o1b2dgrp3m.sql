COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       text(c.id) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]')  AND (lower(asignatura) ~* 'd[eé]' OR       cod_asignatura ~* 'd[eé]' OR       text(c.id) ~* 'd[eé]' OR       lower(profesor) ~* 'd[eé]')  AND (lower(asignatura) ~* 'l[aá]' OR       cod_asignatura ~* 'l[aá]' OR       text(c.id) ~* 'l[aá]' OR       lower(profesor) ~* 'l[aá]')  AND (lower(asignatura) ~* 'ps[ií]c[oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* 'ps[ií]c[oó]l[oó]g[ií][aá]' OR       text(c.id) ~* 'ps[ií]c[oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* 'ps[ií]c[oó]l[oó]g[ií][aá]')  
