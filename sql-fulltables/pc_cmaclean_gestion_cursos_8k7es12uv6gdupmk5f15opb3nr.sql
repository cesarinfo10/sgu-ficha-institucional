COPY (SELECT c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[aá]lfr[eé]d[oó]' OR       cod_asignatura ~* '[aá]lfr[eé]d[oó]' OR       text(c.id) ~* '[aá]lfr[eé]d[oó]' OR       lower(profesor) ~* '[aá]lfr[eé]d[oó]')  AND (lower(asignatura) ~* 'g[oó]nz[aá]l[eé]z' OR       cod_asignatura ~* 'g[oó]nz[aá]l[eé]z' OR       text(c.id) ~* 'g[oó]nz[aá]l[eé]z' OR       lower(profesor) ~* 'g[oó]nz[aá]l[eé]z')  
