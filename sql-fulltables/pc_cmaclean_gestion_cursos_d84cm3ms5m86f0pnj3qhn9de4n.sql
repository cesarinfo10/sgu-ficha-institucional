COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'h[aá]b[ií]l[ií]d[aá]d[eé]s' OR       cod_asignatura ~* 'h[aá]b[ií]l[ií]d[aá]d[eé]s' OR       text(c.id) ~* 'h[aá]b[ií]l[ií]d[aá]d[eé]s' OR       lower(profesor) ~* 'h[aá]b[ií]l[ií]d[aá]d[eé]s')  AND (lower(asignatura) ~* 'c[oó]m[uú]n[ií]c[aá]t[ií]v[aá]s' OR       cod_asignatura ~* 'c[oó]m[uú]n[ií]c[aá]t[ií]v[aá]s' OR       text(c.id) ~* 'c[oó]m[uú]n[ií]c[aá]t[ií]v[aá]s' OR       lower(profesor) ~* 'c[oó]m[uú]n[ií]c[aá]t[ií]v[aá]s')  AND (lower(asignatura) ~* '[oó]r[aá]l[eé]s' OR       cod_asignatura ~* '[oó]r[aá]l[eé]s' OR       text(c.id) ~* '[oó]r[aá]l[eé]s' OR       lower(profesor) ~* '[oó]r[aá]l[eé]s')  
