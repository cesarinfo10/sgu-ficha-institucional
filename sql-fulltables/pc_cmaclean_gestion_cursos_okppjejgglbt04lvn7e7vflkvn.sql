COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'j[aá][ií]m[eé]' OR       cod_asignatura ~* 'j[aá][ií]m[eé]' OR       text(c.id) ~* 'j[aá][ií]m[eé]' OR       lower(profesor) ~* 'j[aá][ií]m[eé]')  AND (lower(asignatura) ~* '[eé][uú]g[eé]n[ií][oó]' OR       cod_asignatura ~* '[eé][uú]g[eé]n[ií][oó]' OR       text(c.id) ~* '[eé][uú]g[eé]n[ií][oó]' OR       lower(profesor) ~* '[eé][uú]g[eé]n[ií][oó]')  AND (lower(asignatura) ~* '[eé]sp[ií]n[oó]s[aá]' OR       cod_asignatura ~* '[eé]sp[ií]n[oó]s[aá]' OR       text(c.id) ~* '[eé]sp[ií]n[oó]s[aá]' OR       lower(profesor) ~* '[eé]sp[ií]n[oó]s[aá]')  AND (lower(asignatura) ~* '[aá]r[aá]y[aá]' OR       cod_asignatura ~* '[aá]r[aá]y[aá]' OR       text(c.id) ~* '[aá]r[aá]y[aá]' OR       lower(profesor) ~* '[aá]r[aá]y[aá]')  
