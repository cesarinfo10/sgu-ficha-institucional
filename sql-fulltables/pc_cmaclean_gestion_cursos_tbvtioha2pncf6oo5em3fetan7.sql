COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'f[uú]nd[aá]m[eé]nt[oó]s' OR       cod_asignatura ~* 'f[uú]nd[aá]m[eé]nt[oó]s' OR       text(c.id) ~* 'f[uú]nd[aá]m[eé]nt[oó]s' OR       lower(profesor) ~* 'f[uú]nd[aá]m[eé]nt[oó]s')  AND (lower(asignatura) ~* 's[oó]c[ií][aá]l[eé]s' OR       cod_asignatura ~* 's[oó]c[ií][aá]l[eé]s' OR       text(c.id) ~* 's[oó]c[ií][aá]l[eé]s' OR       lower(profesor) ~* 's[oó]c[ií][aá]l[eé]s')  AND (lower(asignatura) ~* 'y' OR       cod_asignatura ~* 'y' OR       text(c.id) ~* 'y' OR       lower(profesor) ~* 'y')  AND (lower(asignatura) ~* 'c[uú]lt[uú]r[aá]l[eé]s' OR       cod_asignatura ~* 'c[uú]lt[uú]r[aá]l[eé]s' OR       text(c.id) ~* 'c[uú]lt[uú]r[aá]l[eé]s' OR       lower(profesor) ~* 'c[uú]lt[uú]r[aá]l[eé]s')  
