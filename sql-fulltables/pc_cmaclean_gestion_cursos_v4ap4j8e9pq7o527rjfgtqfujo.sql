COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND id_carrera=19  AND c.ano=2023  AND c.semestre=1  AND c.seccion BETWEEN 5 AND 9  AND c.tipo_clase = 'Presencial'  AND (car.regimen = 'PRE')  
