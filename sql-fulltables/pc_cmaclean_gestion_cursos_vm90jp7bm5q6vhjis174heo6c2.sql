COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 't[eé][oó]r[ií][aá]s' OR       cod_asignatura ~* 't[eé][oó]r[ií][aá]s' OR       text(c.id) ~* 't[eé][oó]r[ií][aá]s' OR       lower(profesor) ~* 't[eé][oó]r[ií][aá]s')  AND (lower(asignatura) ~* 'y' OR       cod_asignatura ~* 'y' OR       text(c.id) ~* 'y' OR       lower(profesor) ~* 'y')  AND (lower(asignatura) ~* 's[ií]st[eé]m[aá]s' OR       cod_asignatura ~* 's[ií]st[eé]m[aá]s' OR       text(c.id) ~* 's[ií]st[eé]m[aá]s' OR       lower(profesor) ~* 's[ií]st[eé]m[aá]s')  AND (lower(asignatura) ~* 'ps[ií]c[oó]l[oó]g[ií]c[oó]s' OR       cod_asignatura ~* 'ps[ií]c[oó]l[oó]g[ií]c[oó]s' OR       text(c.id) ~* 'ps[ií]c[oó]l[oó]g[ií]c[oó]s' OR       lower(profesor) ~* 'ps[ií]c[oó]l[oó]g[ií]c[oó]s')  AND (lower(asignatura) ~* 'c[oó]nt[eé]mp[oó]r[aá]n[eé][oó]s' OR       cod_asignatura ~* 'c[oó]nt[eé]mp[oó]r[aá]n[eé][oó]s' OR       text(c.id) ~* 'c[oó]nt[eé]mp[oó]r[aá]n[eé][oó]s' OR       lower(profesor) ~* 'c[oó]nt[eé]mp[oó]r[aá]n[eé][oó]s')  
