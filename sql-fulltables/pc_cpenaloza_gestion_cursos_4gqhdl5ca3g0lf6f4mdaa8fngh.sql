COPY (SELECT c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'm[eé]t[oó]d[oó]l[oó]g' OR       cod_asignatura ~* 'm[eé]t[oó]d[oó]l[oó]g' OR       text(c.id) ~* 'm[eé]t[oó]d[oó]l[oó]g' OR       lower(profesor) ~* 'm[eé]t[oó]d[oó]l[oó]g')  AND id_carrera IN (101,62,26,88,18,3,36,67,12)  
