COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'm[eé]t[oó]d[oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* 'm[eé]t[oó]d[oó]l[oó]g[ií][aá]' OR       text(c.id) ~* 'm[eé]t[oó]d[oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* 'm[eé]t[oó]d[oó]l[oó]g[ií][aá]')  AND id_carrera IN (101,62,26,88,18,3,36,67,12)  
