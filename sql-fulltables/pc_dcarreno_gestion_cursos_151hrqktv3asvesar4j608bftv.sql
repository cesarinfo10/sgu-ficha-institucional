COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[eé]d[ií]th' OR       cod_asignatura ~* '[eé]d[ií]th' OR       text(c.id) ~* '[eé]d[ií]th' OR       lower(profesor) ~* '[eé]d[ií]th')  AND (lower(asignatura) ~* 'd[eé]l' OR       cod_asignatura ~* 'd[eé]l' OR       text(c.id) ~* 'd[eé]l' OR       lower(profesor) ~* 'd[eé]l')  AND (lower(asignatura) ~* 'c[aá]rm[eé]n' OR       cod_asignatura ~* 'c[aá]rm[eé]n' OR       text(c.id) ~* 'c[aá]rm[eé]n' OR       lower(profesor) ~* 'c[aá]rm[eé]n')  AND (lower(asignatura) ~* 'c[aá]str[oó]' OR       cod_asignatura ~* 'c[aá]str[oó]' OR       text(c.id) ~* 'c[aá]str[oó]' OR       lower(profesor) ~* 'c[aá]str[oó]')  AND (lower(asignatura) ~* 'c[aá]rd[eé]n[aá]s' OR       cod_asignatura ~* 'c[aá]rd[eé]n[aá]s' OR       text(c.id) ~* 'c[aá]rd[eé]n[aá]s' OR       lower(profesor) ~* 'c[aá]rd[eé]n[aá]s')  
