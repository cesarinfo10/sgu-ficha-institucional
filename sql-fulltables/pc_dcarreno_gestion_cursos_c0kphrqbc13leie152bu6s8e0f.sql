COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'r[aá]q[uú][eé]l' OR       cod_asignatura ~* 'r[aá]q[uú][eé]l' OR       text(c.id) ~* 'r[aá]q[uú][eé]l' OR       lower(profesor) ~* 'r[aá]q[uú][eé]l')  AND (lower(asignatura) ~* 'c[eé]c[ií]l[ií][aá]' OR       cod_asignatura ~* 'c[eé]c[ií]l[ií][aá]' OR       text(c.id) ~* 'c[eé]c[ií]l[ií][aá]' OR       lower(profesor) ~* 'c[eé]c[ií]l[ií][aá]')  AND (lower(asignatura) ~* 'p[eé]r[eé][ií]r[aá]' OR       cod_asignatura ~* 'p[eé]r[eé][ií]r[aá]' OR       text(c.id) ~* 'p[eé]r[eé][ií]r[aá]' OR       lower(profesor) ~* 'p[eé]r[eé][ií]r[aá]')  AND (lower(asignatura) ~* 'l[oó]p[eé]z' OR       cod_asignatura ~* 'l[oó]p[eé]z' OR       text(c.id) ~* 'l[oó]p[eé]z' OR       lower(profesor) ~* 'l[oó]p[eé]z')  
