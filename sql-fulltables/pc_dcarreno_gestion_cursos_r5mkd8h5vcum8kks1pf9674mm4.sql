COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[aá]l[eé]j[aá]ndr[oó]' OR       cod_asignatura ~* '[aá]l[eé]j[aá]ndr[oó]' OR       text(c.id) ~* '[aá]l[eé]j[aá]ndr[oó]' OR       lower(profesor) ~* '[aá]l[eé]j[aá]ndr[oó]')  AND (lower(asignatura) ~* '[aá]l[aá]rc[oó]n' OR       cod_asignatura ~* '[aá]l[aá]rc[oó]n' OR       text(c.id) ~* '[aá]l[aá]rc[oó]n' OR       lower(profesor) ~* '[aá]l[aá]rc[oó]n')  AND (lower(asignatura) ~* 'q[uú][ií]nt[eé]r[oó]s' OR       cod_asignatura ~* 'q[uú][ií]nt[eé]r[oó]s' OR       text(c.id) ~* 'q[uú][ií]nt[eé]r[oó]s' OR       lower(profesor) ~* 'q[uú][ií]nt[eé]r[oó]s')  
