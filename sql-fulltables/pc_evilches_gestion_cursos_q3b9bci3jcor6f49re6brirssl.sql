COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'g[eé]n[aá]r[oó]' OR       cod_asignatura ~* 'g[eé]n[aá]r[oó]' OR       text(c.id) ~* 'g[eé]n[aá]r[oó]' OR       lower(profesor) ~* 'g[eé]n[aá]r[oó]')  AND (lower(asignatura) ~* '[aá]l[eé]j[aá]ndr[oó]' OR       cod_asignatura ~* '[aá]l[eé]j[aá]ndr[oó]' OR       text(c.id) ~* '[aá]l[eé]j[aá]ndr[oó]' OR       lower(profesor) ~* '[aá]l[eé]j[aá]ndr[oó]')  AND (lower(asignatura) ~* 'm[oó]y[aá]n[oó]' OR       cod_asignatura ~* 'm[oó]y[aá]n[oó]' OR       text(c.id) ~* 'm[oó]y[aá]n[oó]' OR       lower(profesor) ~* 'm[oó]y[aá]n[oó]')  AND (lower(asignatura) ~* '[aá]rc[oó]s' OR       cod_asignatura ~* '[aá]rc[oó]s' OR       text(c.id) ~* '[aá]rc[oó]s' OR       lower(profesor) ~* '[aá]rc[oó]s')  
