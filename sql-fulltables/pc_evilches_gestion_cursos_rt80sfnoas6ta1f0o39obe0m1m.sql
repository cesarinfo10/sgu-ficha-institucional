COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'm[aá]r[ií]s[oó]l' OR       cod_asignatura ~* 'm[aá]r[ií]s[oó]l' OR       text(c.id) ~* 'm[aá]r[ií]s[oó]l' OR       lower(profesor) ~* 'm[aá]r[ií]s[oó]l')  AND (lower(asignatura) ~* 'n[oó][eé]m[ií]' OR       cod_asignatura ~* 'n[oó][eé]m[ií]' OR       text(c.id) ~* 'n[oó][eé]m[ií]' OR       lower(profesor) ~* 'n[oó][eé]m[ií]')  AND (lower(asignatura) ~* 'g[aá]rc[ií][aá]' OR       cod_asignatura ~* 'g[aá]rc[ií][aá]' OR       text(c.id) ~* 'g[aá]rc[ií][aá]' OR       lower(profesor) ~* 'g[aá]rc[ií][aá]')  AND (lower(asignatura) ~* 'c[aá]rr[eé]r[aá]' OR       cod_asignatura ~* 'c[aá]rr[eé]r[aá]' OR       text(c.id) ~* 'c[aá]rr[eé]r[aá]' OR       lower(profesor) ~* 'c[aá]rr[eé]r[aá]')  
