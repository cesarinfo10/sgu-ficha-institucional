COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'f[eé]rn[aá]nd[oó]' OR       cod_asignatura ~* 'f[eé]rn[aá]nd[oó]' OR       text(c.id) ~* 'f[eé]rn[aá]nd[oó]' OR       lower(profesor) ~* 'f[eé]rn[aá]nd[oó]')  AND (lower(asignatura) ~* '[aá]l[eé]j[aá]ndr[oó]' OR       cod_asignatura ~* '[aá]l[eé]j[aá]ndr[oó]' OR       text(c.id) ~* '[aá]l[eé]j[aá]ndr[oó]' OR       lower(profesor) ~* '[aá]l[eé]j[aá]ndr[oó]')  AND (lower(asignatura) ~* 'h[eé]rr[eé]r[aá]' OR       cod_asignatura ~* 'h[eé]rr[eé]r[aá]' OR       text(c.id) ~* 'h[eé]rr[eé]r[aá]' OR       lower(profesor) ~* 'h[eé]rr[eé]r[aá]')  AND (lower(asignatura) ~* 'm[aá]rt[ií]n[eé]z' OR       cod_asignatura ~* 'm[aá]rt[ií]n[eé]z' OR       text(c.id) ~* 'm[aá]rt[ií]n[eé]z' OR       lower(profesor) ~* 'm[aá]rt[ií]n[eé]z')  AND array[59,57,27,28,33,54,56,31,58,60,55,30,32,29,76,79,82,81,83,78,80,38,115,114,77,125,12] && (ids_carreras)  
