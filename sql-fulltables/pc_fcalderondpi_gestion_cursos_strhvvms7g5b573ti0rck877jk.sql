COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[aá]rm[aá]nd[oó]' OR       cod_asignatura ~* '[aá]rm[aá]nd[oó]' OR       text(c.id) ~* '[aá]rm[aá]nd[oó]' OR       lower(profesor) ~* '[aá]rm[aá]nd[oó]')  AND (lower(asignatura) ~* '[aá]l[eé]j[aá]ndr[oó]' OR       cod_asignatura ~* '[aá]l[eé]j[aá]ndr[oó]' OR       text(c.id) ~* '[aá]l[eé]j[aá]ndr[oó]' OR       lower(profesor) ~* '[aá]l[eé]j[aá]ndr[oó]')  AND (lower(asignatura) ~* '[oó]rm[eé]ñ[oó]' OR       cod_asignatura ~* '[oó]rm[eé]ñ[oó]' OR       text(c.id) ~* '[oó]rm[eé]ñ[oó]' OR       lower(profesor) ~* '[oó]rm[eé]ñ[oó]')  AND (lower(asignatura) ~* '[oó]rt[ií]z' OR       cod_asignatura ~* '[oó]rt[ií]z' OR       text(c.id) ~* '[oó]rt[ií]z' OR       lower(profesor) ~* '[oó]rt[ií]z')  AND array[59,57,27,28,33,54,56,31,58,60,55,30,32,29,76,79,82,81,83,78,80,38,115,114,77,125,12] && (ids_carreras)  
