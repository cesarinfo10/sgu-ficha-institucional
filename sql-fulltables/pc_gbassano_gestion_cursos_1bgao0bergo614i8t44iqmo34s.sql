COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'v[ií]ct[oó]r' OR       cod_asignatura ~* 'v[ií]ct[oó]r' OR       text(c.id) ~* 'v[ií]ct[oó]r' OR       lower(profesor) ~* 'v[ií]ct[oó]r')  AND (lower(asignatura) ~* '[aá]ndr[eé]s' OR       cod_asignatura ~* '[aá]ndr[eé]s' OR       text(c.id) ~* '[aá]ndr[eé]s' OR       lower(profesor) ~* '[aá]ndr[eé]s')  AND (lower(asignatura) ~* '[aá]lm[oó]n[aá]c[ií]d' OR       cod_asignatura ~* '[aá]lm[oó]n[aá]c[ií]d' OR       text(c.id) ~* '[aá]lm[oó]n[aá]c[ií]d' OR       lower(profesor) ~* '[aá]lm[oó]n[aá]c[ií]d')  AND (lower(asignatura) ~* 'c[oó]r[oó]n[aá]d[oó]' OR       cod_asignatura ~* 'c[oó]r[oó]n[aá]d[oó]' OR       text(c.id) ~* 'c[oó]r[oó]n[aá]d[oó]' OR       lower(profesor) ~* 'c[oó]r[oó]n[aá]d[oó]')  
