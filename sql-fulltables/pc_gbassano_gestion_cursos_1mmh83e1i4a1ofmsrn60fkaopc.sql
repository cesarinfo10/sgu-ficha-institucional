COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'cr[ií]st[ií][aá]n' OR       cod_asignatura ~* 'cr[ií]st[ií][aá]n' OR       text(c.id) ~* 'cr[ií]st[ií][aá]n' OR       lower(profesor) ~* 'cr[ií]st[ií][aá]n')  AND (lower(asignatura) ~* 'j[aá]v[ií][eé]r' OR       cod_asignatura ~* 'j[aá]v[ií][eé]r' OR       text(c.id) ~* 'j[aá]v[ií][eé]r' OR       lower(profesor) ~* 'j[aá]v[ií][eé]r')  AND (lower(asignatura) ~* 'm[uú]ñ[oó]z' OR       cod_asignatura ~* 'm[uú]ñ[oó]z' OR       text(c.id) ~* 'm[uú]ñ[oó]z' OR       lower(profesor) ~* 'm[uú]ñ[oó]z')  AND (lower(asignatura) ~* 'v[aá]l[eé]nz[uú][eé]l[aá]' OR       cod_asignatura ~* 'v[aá]l[eé]nz[uú][eé]l[aá]' OR       text(c.id) ~* 'v[aá]l[eé]nz[uú][eé]l[aá]' OR       lower(profesor) ~* 'v[aá]l[eé]nz[uú][eé]l[aá]')  
