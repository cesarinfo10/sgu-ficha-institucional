COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'p[aá][uú]l[ií]n[aá]' OR       cod_asignatura ~* 'p[aá][uú]l[ií]n[aá]' OR       text(c.id) ~* 'p[aá][uú]l[ií]n[aá]' OR       lower(profesor) ~* 'p[aá][uú]l[ií]n[aá]')  AND (lower(asignatura) ~* '[eé]mp[eé]r[aá]tr[ií]z' OR       cod_asignatura ~* '[eé]mp[eé]r[aá]tr[ií]z' OR       text(c.id) ~* '[eé]mp[eé]r[aá]tr[ií]z' OR       lower(profesor) ~* '[eé]mp[eé]r[aá]tr[ií]z')  AND (lower(asignatura) ~* 'g[oó]nz[aá]l[eé]z' OR       cod_asignatura ~* 'g[oó]nz[aá]l[eé]z' OR       text(c.id) ~* 'g[oó]nz[aá]l[eé]z' OR       lower(profesor) ~* 'g[oó]nz[aá]l[eé]z')  AND (lower(asignatura) ~* '[aá]lv[eé][aá]r' OR       cod_asignatura ~* '[aá]lv[eé][aá]r' OR       text(c.id) ~* '[aá]lv[eé][aá]r' OR       lower(profesor) ~* '[aá]lv[eé][aá]r')  
