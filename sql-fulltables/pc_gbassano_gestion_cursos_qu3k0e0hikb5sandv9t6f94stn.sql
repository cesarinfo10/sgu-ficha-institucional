COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[aá]l[eé]j[aá]ndr[oó]' OR       cod_asignatura ~* '[aá]l[eé]j[aá]ndr[oó]' OR       text(c.id) ~* '[aá]l[eé]j[aá]ndr[oó]' OR       lower(profesor) ~* '[aá]l[eé]j[aá]ndr[oó]')  AND (lower(asignatura) ~* 'h[eé]rn[aá]n' OR       cod_asignatura ~* 'h[eé]rn[aá]n' OR       text(c.id) ~* 'h[eé]rn[aá]n' OR       lower(profesor) ~* 'h[eé]rn[aá]n')  AND (lower(asignatura) ~* 'm[eé]n[aá]nt[eé][aá][uú]' OR       cod_asignatura ~* 'm[eé]n[aá]nt[eé][aá][uú]' OR       text(c.id) ~* 'm[eé]n[aá]nt[eé][aá][uú]' OR       lower(profesor) ~* 'm[eé]n[aá]nt[eé][aá][uú]')  AND (lower(asignatura) ~* '[oó]lm[ií]' OR       cod_asignatura ~* '[oó]lm[ií]' OR       text(c.id) ~* '[oó]lm[ií]' OR       lower(profesor) ~* '[oó]lm[ií]')  
