COPY (SELECT c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'v[aá]l[eé]nt[ií]n[aá]' OR       cod_asignatura ~* 'v[aá]l[eé]nt[ií]n[aá]' OR       text(c.id) ~* 'v[aá]l[eé]nt[ií]n[aá]' OR       lower(profesor) ~* 'v[aá]l[eé]nt[ií]n[aá]')  AND (lower(asignatura) ~* 'l[oó]b[oó]s' OR       cod_asignatura ~* 'l[oó]b[oó]s' OR       text(c.id) ~* 'l[oó]b[oó]s' OR       lower(profesor) ~* 'l[oó]b[oó]s')  AND (lower(asignatura) ~* 'c[aá]rr[eé]ñ[oó]' OR       cod_asignatura ~* 'c[aá]rr[eé]ñ[oó]' OR       text(c.id) ~* 'c[aá]rr[eé]ñ[oó]' OR       lower(profesor) ~* 'c[aá]rr[eé]ñ[oó]')  
