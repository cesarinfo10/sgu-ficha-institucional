COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'b[eé]ts[aá]b[eé].pr[oó]f[eé]s[oó]r[aá]@h[oó]tm[aá][ií]l.c[oó]m' OR       cod_asignatura ~* 'b[eé]ts[aá]b[eé].pr[oó]f[eé]s[oó]r[aá]@h[oó]tm[aá][ií]l.c[oó]m' OR       text(c.id) ~* 'b[eé]ts[aá]b[eé].pr[oó]f[eé]s[oó]r[aá]@h[oó]tm[aá][ií]l.c[oó]m' OR       lower(profesor) ~* 'b[eé]ts[aá]b[eé].pr[oó]f[eé]s[oó]r[aá]@h[oó]tm[aá][ií]l.c[oó]m')  
