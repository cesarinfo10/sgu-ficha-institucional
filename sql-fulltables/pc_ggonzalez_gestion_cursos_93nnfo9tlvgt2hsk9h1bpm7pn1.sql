COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'g[aá]st[oó]n' OR       cod_asignatura ~* 'g[aá]st[oó]n' OR       text(c.id) ~* 'g[aá]st[oó]n' OR       lower(profesor) ~* 'g[aá]st[oó]n')  AND (lower(asignatura) ~* 'p[aá]tr[ií]c[ií][oó]' OR       cod_asignatura ~* 'p[aá]tr[ií]c[ií][oó]' OR       text(c.id) ~* 'p[aá]tr[ií]c[ií][oó]' OR       lower(profesor) ~* 'p[aá]tr[ií]c[ií][oó]')  AND (lower(asignatura) ~* 'g[oó]nz[aá]l[eé]z' OR       cod_asignatura ~* 'g[oó]nz[aá]l[eé]z' OR       text(c.id) ~* 'g[oó]nz[aá]l[eé]z' OR       lower(profesor) ~* 'g[oó]nz[aá]l[eé]z')  AND (lower(asignatura) ~* 'c[aá]rr[eé]ñ[oó]' OR       cod_asignatura ~* 'c[aá]rr[eé]ñ[oó]' OR       text(c.id) ~* 'c[aá]rr[eé]ñ[oó]' OR       lower(profesor) ~* 'c[aá]rr[eé]ñ[oó]')  
