COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'n[ií]c[oó]l[aá]s' OR       cod_asignatura ~* 'n[ií]c[oó]l[aá]s' OR       text(c.id) ~* 'n[ií]c[oó]l[aá]s' OR       lower(profesor) ~* 'n[ií]c[oó]l[aá]s')  AND (lower(asignatura) ~* 'p[aá]bl[oó]' OR       cod_asignatura ~* 'p[aá]bl[oó]' OR       text(c.id) ~* 'p[aá]bl[oó]' OR       lower(profesor) ~* 'p[aá]bl[oó]')  AND (lower(asignatura) ~* 'b[aá]rr[ií][eé]nt[oó]s' OR       cod_asignatura ~* 'b[aá]rr[ií][eé]nt[oó]s' OR       text(c.id) ~* 'b[aá]rr[ií][eé]nt[oó]s' OR       lower(profesor) ~* 'b[aá]rr[ií][eé]nt[oó]s')  AND (lower(asignatura) ~* '[oó]r[aá]d[ií]n[ií]' OR       cod_asignatura ~* '[oó]r[aá]d[ií]n[ií]' OR       text(c.id) ~* '[oó]r[aá]d[ií]n[ií]' OR       lower(profesor) ~* '[oó]r[aá]d[ií]n[ií]')  
