COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'd[oó]r[ií]s' OR       cod_asignatura ~* 'd[oó]r[ií]s' OR       text(c.id) ~* 'd[oó]r[ií]s' OR       lower(profesor) ~* 'd[oó]r[ií]s')  AND (lower(asignatura) ~* 'j[oó]s[eé]f[ií]n[aá]' OR       cod_asignatura ~* 'j[oó]s[eé]f[ií]n[aá]' OR       text(c.id) ~* 'j[oó]s[eé]f[ií]n[aá]' OR       lower(profesor) ~* 'j[oó]s[eé]f[ií]n[aá]')  AND (lower(asignatura) ~* 's[oó]l[ií]s' OR       cod_asignatura ~* 's[oó]l[ií]s' OR       text(c.id) ~* 's[oó]l[ií]s' OR       lower(profesor) ~* 's[oó]l[ií]s')  AND (lower(asignatura) ~* 'm[eé]j[ií][aá]s' OR       cod_asignatura ~* 'm[eé]j[ií][aá]s' OR       text(c.id) ~* 'm[eé]j[ií][aá]s' OR       lower(profesor) ~* 'm[eé]j[ií][aá]s')  
