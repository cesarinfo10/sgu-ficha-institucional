COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'v[aá]n[eé]ss[aá]' OR       cod_asignatura ~* 'v[aá]n[eé]ss[aá]' OR       text(c.id) ~* 'v[aá]n[eé]ss[aá]' OR       lower(profesor) ~* 'v[aá]n[eé]ss[aá]')  AND (lower(asignatura) ~* 'cr[ií]st[ií]n[aá]' OR       cod_asignatura ~* 'cr[ií]st[ií]n[aá]' OR       text(c.id) ~* 'cr[ií]st[ií]n[aá]' OR       lower(profesor) ~* 'cr[ií]st[ií]n[aá]')  AND (lower(asignatura) ~* '[ií]n[aá]y' OR       cod_asignatura ~* '[ií]n[aá]y' OR       text(c.id) ~* '[ií]n[aá]y' OR       lower(profesor) ~* '[ií]n[aá]y')  AND (lower(asignatura) ~* 's[aá]r[aá]b[ií][aá]' OR       cod_asignatura ~* 's[aá]r[aá]b[ií][aá]' OR       text(c.id) ~* 's[aá]r[aá]b[ií][aá]' OR       lower(profesor) ~* 's[aá]r[aá]b[ií][aá]')  
