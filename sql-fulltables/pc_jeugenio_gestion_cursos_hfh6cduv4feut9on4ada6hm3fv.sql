COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'm[aá]r[ií][oó]' OR       cod_asignatura ~* 'm[aá]r[ií][oó]' OR       text(c.id) ~* 'm[aá]r[ií][oó]' OR       lower(profesor) ~* 'm[aá]r[ií][oó]')  AND (lower(asignatura) ~* '[eé]l[ií]z[oó]nd[oó]' OR       cod_asignatura ~* '[eé]l[ií]z[oó]nd[oó]' OR       text(c.id) ~* '[eé]l[ií]z[oó]nd[oó]' OR       lower(profesor) ~* '[eé]l[ií]z[oó]nd[oó]')  
