COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[ií]nt[eé]l[ií]g[eé]nc[ií][aá]' OR       cod_asignatura ~* '[ií]nt[eé]l[ií]g[eé]nc[ií][aá]' OR       text(c.id) ~* '[ií]nt[eé]l[ií]g[eé]nc[ií][aá]' OR       lower(profesor) ~* '[ií]nt[eé]l[ií]g[eé]nc[ií][aá]')  AND (lower(asignatura) ~* '[eé]str[aá]t[eé]g[ií]c[aá]' OR       cod_asignatura ~* '[eé]str[aá]t[eé]g[ií]c[aá]' OR       text(c.id) ~* '[eé]str[aá]t[eé]g[ií]c[aá]' OR       lower(profesor) ~* '[eé]str[aá]t[eé]g[ií]c[aá]')  
