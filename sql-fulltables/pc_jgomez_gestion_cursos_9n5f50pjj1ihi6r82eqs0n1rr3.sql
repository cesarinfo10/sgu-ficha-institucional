COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[aá]ntr[oó]p[oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* '[aá]ntr[oó]p[oó]l[oó]g[ií][aá]' OR       text(c.id) ~* '[aá]ntr[oó]p[oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* '[aá]ntr[oó]p[oó]l[oó]g[ií][aá]')  AND array[108,96,25,109,37,70,135,112,17,153,12] && (ids_carreras)  
