COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       text(c.id) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* '[eé]p[ií]st[eé]m[oó]l[oó]g[ií][aá]')  AND array[108,96,25,109,37,70,135,153,112,17,12] && (ids_carreras)  
