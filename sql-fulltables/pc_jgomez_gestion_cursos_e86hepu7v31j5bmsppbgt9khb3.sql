COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'l[oó]b[oó]s' OR       cod_asignatura ~* 'l[oó]b[oó]s' OR       text(c.id) ~* 'l[oó]b[oó]s' OR       lower(profesor) ~* 'l[oó]b[oó]s')  AND array[108,96,25,109,37,70,135,112,17,12] && (ids_carreras)  
