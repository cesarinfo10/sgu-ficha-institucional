COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'j[oó]rg[eé]' OR       cod_asignatura ~* 'j[oó]rg[eé]' OR       text(c.id) ~* 'j[oó]rg[eé]' OR       lower(profesor) ~* 'j[oó]rg[eé]')  AND (lower(asignatura) ~* '[aá]nt[oó]n[ií][oó]' OR       cod_asignatura ~* '[aá]nt[oó]n[ií][oó]' OR       text(c.id) ~* '[aá]nt[oó]n[ií][oó]' OR       lower(profesor) ~* '[aá]nt[oó]n[ií][oó]')  AND (lower(asignatura) ~* 'm[aá]ld[oó]n[aá]d[oó]' OR       cod_asignatura ~* 'm[aá]ld[oó]n[aá]d[oó]' OR       text(c.id) ~* 'm[aá]ld[oó]n[aá]d[oó]' OR       lower(profesor) ~* 'm[aá]ld[oó]n[aá]d[oó]')  AND (lower(asignatura) ~* 'r[oó]ld[aá]n' OR       cod_asignatura ~* 'r[oó]ld[aá]n' OR       text(c.id) ~* 'r[oó]ld[aá]n' OR       lower(profesor) ~* 'r[oó]ld[aá]n')  AND id_carrera IN (108,96,25,109,37,135,70,112,17,12)  
