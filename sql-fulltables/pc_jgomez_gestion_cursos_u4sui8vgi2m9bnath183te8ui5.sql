COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'l[oó]b[oó]s' OR       cod_asignatura ~* 'l[oó]b[oó]s' OR       text(c.id) ~* 'l[oó]b[oó]s' OR       lower(profesor) ~* 'l[oó]b[oó]s')  AND id_carrera IN (108,96,25,109,37,70,112,17,12)  
