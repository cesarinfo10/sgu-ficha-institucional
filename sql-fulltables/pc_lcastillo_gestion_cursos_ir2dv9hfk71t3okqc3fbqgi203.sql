COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'f[eé]rn[aá]nd[oó]' OR       cod_asignatura ~* 'f[eé]rn[aá]nd[oó]' OR       text(c.id) ~* 'f[eé]rn[aá]nd[oó]' OR       lower(profesor) ~* 'f[eé]rn[aá]nd[oó]')  AND (lower(asignatura) ~* '[aá]dr[ií][aá]n' OR       cod_asignatura ~* '[aá]dr[ií][aá]n' OR       text(c.id) ~* '[aá]dr[ií][aá]n' OR       lower(profesor) ~* '[aá]dr[ií][aá]n')  AND (lower(asignatura) ~* '[aá]nt[oó]n[ií][oó]' OR       cod_asignatura ~* '[aá]nt[oó]n[ií][oó]' OR       text(c.id) ~* '[aá]nt[oó]n[ií][oó]' OR       lower(profesor) ~* '[aá]nt[oó]n[ií][oó]')  AND (lower(asignatura) ~* 'm[uú]ñ[oó]z' OR       cod_asignatura ~* 'm[uú]ñ[oó]z' OR       text(c.id) ~* 'm[uú]ñ[oó]z' OR       lower(profesor) ~* 'm[uú]ñ[oó]z')  AND (lower(asignatura) ~* 's[eé]p[uú]lv[eé]d[aá]' OR       cod_asignatura ~* 's[eé]p[uú]lv[eé]d[aá]' OR       text(c.id) ~* 's[eé]p[uú]lv[eé]d[aá]' OR       lower(profesor) ~* 's[eé]p[uú]lv[eé]d[aá]')  AND array[95,100,2,69,1,19,12] && (ids_carreras)  
