COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'c[eé]l[ií][aá]' OR       cod_asignatura ~* 'c[eé]l[ií][aá]' OR       text(c.id) ~* 'c[eé]l[ií][aá]' OR       lower(profesor) ~* 'c[eé]l[ií][aá]')  AND (lower(asignatura) ~* 'd[eé]l' OR       cod_asignatura ~* 'd[eé]l' OR       text(c.id) ~* 'd[eé]l' OR       lower(profesor) ~* 'd[eé]l')  AND (lower(asignatura) ~* 'p[ií]l[aá]r' OR       cod_asignatura ~* 'p[ií]l[aá]r' OR       text(c.id) ~* 'p[ií]l[aá]r' OR       lower(profesor) ~* 'p[ií]l[aá]r')  AND (lower(asignatura) ~* 'v[aá]ld[eé]s' OR       cod_asignatura ~* 'v[aá]ld[eé]s' OR       text(c.id) ~* 'v[aá]ld[eé]s' OR       lower(profesor) ~* 'v[aá]ld[eé]s')  AND (lower(asignatura) ~* 'h[eé]rn[aá]nd[eé]z' OR       cod_asignatura ~* 'h[eé]rn[aá]nd[eé]z' OR       text(c.id) ~* 'h[eé]rn[aá]nd[eé]z' OR       lower(profesor) ~* 'h[eé]rn[aá]nd[eé]z')  
