COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 't[eé][oó]r[ií][aá]' OR       cod_asignatura ~* 't[eé][oó]r[ií][aá]' OR       text(c.id) ~* 't[eé][oó]r[ií][aá]' OR       lower(profesor) ~* 't[eé][oó]r[ií][aá]')  AND (lower(asignatura) ~* '[eé]c[oó]n[oó]m[ií]c[aá]' OR       cod_asignatura ~* '[eé]c[oó]n[oó]m[ií]c[aá]' OR       text(c.id) ~* '[eé]c[oó]n[oó]m[ií]c[aá]' OR       lower(profesor) ~* '[eé]c[oó]n[oó]m[ií]c[aá]')  AND id_carrera IN (95,100,2,69,1,19,12)  
