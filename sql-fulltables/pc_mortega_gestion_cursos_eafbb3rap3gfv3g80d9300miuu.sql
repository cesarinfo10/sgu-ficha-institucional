COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 's[eé]rg[ií][oó]' OR       cod_asignatura ~* 's[eé]rg[ií][oó]' OR       text(c.id) ~* 's[eé]rg[ií][oó]' OR       lower(profesor) ~* 's[eé]rg[ií][oó]')  AND (lower(asignatura) ~* 'l[eé][aá]ndr[oó]' OR       cod_asignatura ~* 'l[eé][aá]ndr[oó]' OR       text(c.id) ~* 'l[eé][aá]ndr[oó]' OR       lower(profesor) ~* 'l[eé][aá]ndr[oó]')  AND (lower(asignatura) ~* 'g[uú][aá]j[aá]rd[oó]' OR       cod_asignatura ~* 'g[uú][aá]j[aá]rd[oó]' OR       text(c.id) ~* 'g[uú][aá]j[aá]rd[oó]' OR       lower(profesor) ~* 'g[uú][aá]j[aá]rd[oó]')  AND (lower(asignatura) ~* 'c[oó]ntr[eé]r[aá]s' OR       cod_asignatura ~* 'c[oó]ntr[eé]r[aá]s' OR       text(c.id) ~* 'c[oó]ntr[eé]r[aá]s' OR       lower(profesor) ~* 'c[oó]ntr[eé]r[aá]s')  AND id_carrera IN (95,100,19,2,69,1,12)  
