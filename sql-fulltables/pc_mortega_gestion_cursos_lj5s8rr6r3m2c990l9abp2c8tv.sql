COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'l[oó]r[eé]nz[oó]' OR       cod_asignatura ~* 'l[oó]r[eé]nz[oó]' OR       text(c.id) ~* 'l[oó]r[eé]nz[oó]' OR       lower(profesor) ~* 'l[oó]r[eé]nz[oó]')  AND (lower(asignatura) ~* 'j[aá]v[ií][eé]r' OR       cod_asignatura ~* 'j[aá]v[ií][eé]r' OR       text(c.id) ~* 'j[aá]v[ií][eé]r' OR       lower(profesor) ~* 'j[aá]v[ií][eé]r')  AND (lower(asignatura) ~* 'v[eé]r[aá]' OR       cod_asignatura ~* 'v[eé]r[aá]' OR       text(c.id) ~* 'v[eé]r[aá]' OR       lower(profesor) ~* 'v[eé]r[aá]')  AND (lower(asignatura) ~* 'h[ií]d[aá]lg[oó]' OR       cod_asignatura ~* 'h[ií]d[aá]lg[oó]' OR       text(c.id) ~* 'h[ií]d[aá]lg[oó]' OR       lower(profesor) ~* 'h[ií]d[aá]lg[oó]')  AND id_carrera IN (95,100,19,2,69,1,12)  
