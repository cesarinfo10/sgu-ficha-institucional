COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 't[aá]ll[eé]r' OR       cod_asignatura ~* 't[aá]ll[eé]r' OR       text(c.id) ~* 't[aá]ll[eé]r' OR       lower(profesor) ~* 't[aá]ll[eé]r')  AND (lower(asignatura) ~* 'd[eé]' OR       cod_asignatura ~* 'd[eé]' OR       text(c.id) ~* 'd[eé]' OR       lower(profesor) ~* 'd[eé]')  AND (lower(asignatura) ~* 'pr[oó]c[eé]d[ií]m[ií][eé]nt[oó]' OR       cod_asignatura ~* 'pr[oó]c[eé]d[ií]m[ií][eé]nt[oó]' OR       text(c.id) ~* 'pr[oó]c[eé]d[ií]m[ií][eé]nt[oó]' OR       lower(profesor) ~* 'pr[oó]c[eé]d[ií]m[ií][eé]nt[oó]')  AND (lower(asignatura) ~* 'j[uú]d[ií]c[ií][aá]l' OR       cod_asignatura ~* 'j[uú]d[ií]c[ií][aá]l' OR       text(c.id) ~* 'j[uú]d[ií]c[ií][aá]l' OR       lower(profesor) ~* 'j[uú]d[ií]c[ií][aá]l')  AND array[95,100,2,69,1,19,12] && (ids_carreras)  
