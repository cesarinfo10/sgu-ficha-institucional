COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'p[oó]l[ií]t[ií]c[aá]' OR       cod_asignatura ~* 'p[oó]l[ií]t[ií]c[aá]' OR       text(c.id) ~* 'p[oó]l[ií]t[ií]c[aá]' OR       lower(profesor) ~* 'p[oó]l[ií]t[ií]c[aá]')  AND (lower(asignatura) ~* '[eé]c[oó]n[oó]m[ií]c[aá]' OR       cod_asignatura ~* '[eé]c[oó]n[oó]m[ií]c[aá]' OR       text(c.id) ~* '[eé]c[oó]n[oó]m[ií]c[aá]' OR       lower(profesor) ~* '[eé]c[oó]n[oó]m[ií]c[aá]')  AND array[95,100,2,69,1,19,12] && (ids_carreras)  
