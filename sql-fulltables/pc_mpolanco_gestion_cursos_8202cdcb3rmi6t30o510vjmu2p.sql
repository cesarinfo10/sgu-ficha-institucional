COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 's[oó]t[oó]m[aá]y[oó]r' OR       cod_asignatura ~* 's[oó]t[oó]m[aá]y[oó]r' OR       text(c.id) ~* 's[oó]t[oó]m[aá]y[oó]r' OR       lower(profesor) ~* 's[oó]t[oó]m[aá]y[oó]r')  AND id_carrera IN (95,100,2,69,1,19,12)  
