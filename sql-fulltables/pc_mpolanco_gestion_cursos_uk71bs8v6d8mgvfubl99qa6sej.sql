COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '18122' OR       cod_asignatura ~* '18122' OR       text(c.id) ~* '18122' OR       lower(profesor) ~* '18122')  AND id_carrera IN (95,100,2,69,1,19,12)  
