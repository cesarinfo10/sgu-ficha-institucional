COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'm[aá]rt[ií]n' OR       cod_asignatura ~* 'm[aá]rt[ií]n' OR       text(c.id) ~* 'm[aá]rt[ií]n' OR       lower(profesor) ~* 'm[aá]rt[ií]n')  AND (lower(asignatura) ~* '[aá]rn[aá]ld[oó]' OR       cod_asignatura ~* '[aá]rn[aá]ld[oó]' OR       text(c.id) ~* '[aá]rn[aá]ld[oó]' OR       lower(profesor) ~* '[aá]rn[aá]ld[oó]')  AND (lower(asignatura) ~* 'g[aá]rr[ií]d[oó]' OR       cod_asignatura ~* 'g[aá]rr[ií]d[oó]' OR       text(c.id) ~* 'g[aá]rr[ií]d[oó]' OR       lower(profesor) ~* 'g[aá]rr[ií]d[oó]')  AND (lower(asignatura) ~* '[aá]r[aá]y[aá]' OR       cod_asignatura ~* '[aá]r[aá]y[aá]' OR       text(c.id) ~* '[aá]r[aá]y[aá]' OR       lower(profesor) ~* '[aá]r[aá]y[aá]')  AND array[95,100,2,69,1,19,12] && (ids_carreras)  
