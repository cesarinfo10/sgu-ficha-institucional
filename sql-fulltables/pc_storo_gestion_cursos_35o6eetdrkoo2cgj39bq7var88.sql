COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 't[eé][oó]r[ií][aá]' OR       cod_asignatura ~* 't[eé][oó]r[ií][aá]' OR       text(c.id) ~* 't[eé][oó]r[ií][aá]' OR       lower(profesor) ~* 't[eé][oó]r[ií][aá]')  AND (lower(asignatura) ~* 'd[eé]' OR       cod_asignatura ~* 'd[eé]' OR       text(c.id) ~* 'd[eé]' OR       lower(profesor) ~* 'd[eé]')  AND (lower(asignatura) ~* 'l[aá]s' OR       cod_asignatura ~* 'l[aá]s' OR       text(c.id) ~* 'l[aá]s' OR       lower(profesor) ~* 'l[aá]s')  AND (lower(asignatura) ~* '[oó]bl[ií]g[aá]c[ií][oó]n[eé]s' OR       cod_asignatura ~* '[oó]bl[ií]g[aá]c[ií][oó]n[eé]s' OR       text(c.id) ~* '[oó]bl[ií]g[aá]c[ií][oó]n[eé]s' OR       lower(profesor) ~* '[oó]bl[ií]g[aá]c[ií][oó]n[eé]s')  AND (lower(asignatura) ~* '[ií][ií]' OR       cod_asignatura ~* '[ií][ií]' OR       text(c.id) ~* '[ií][ií]' OR       lower(profesor) ~* '[ií][ií]')  AND array[95,100,2,69,1,19,12] && (ids_carreras)  
