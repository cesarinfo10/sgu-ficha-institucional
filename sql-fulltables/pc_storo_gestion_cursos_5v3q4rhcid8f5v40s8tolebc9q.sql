COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'r[eé]gl[aá]s' OR       cod_asignatura ~* 'r[eé]gl[aá]s' OR       text(c.id) ~* 'r[eé]gl[aá]s' OR       lower(profesor) ~* 'r[eé]gl[aá]s')  AND (lower(asignatura) ~* 'c[oó]m[uú]n[eé]s' OR       cod_asignatura ~* 'c[oó]m[uú]n[eé]s' OR       text(c.id) ~* 'c[oó]m[uú]n[eé]s' OR       lower(profesor) ~* 'c[oó]m[uú]n[eé]s')  AND (lower(asignatura) ~* '[aá]' OR       cod_asignatura ~* '[aá]' OR       text(c.id) ~* '[aá]' OR       lower(profesor) ~* '[aá]')  AND (lower(asignatura) ~* 't[oó]d[oó]' OR       cod_asignatura ~* 't[oó]d[oó]' OR       text(c.id) ~* 't[oó]d[oó]' OR       lower(profesor) ~* 't[oó]d[oó]')  AND (lower(asignatura) ~* 'pr[oó]c[eé]d[ií]m[ií][eé]nt[oó]' OR       cod_asignatura ~* 'pr[oó]c[eé]d[ií]m[ií][eé]nt[oó]' OR       text(c.id) ~* 'pr[oó]c[eé]d[ií]m[ií][eé]nt[oó]' OR       lower(profesor) ~* 'pr[oó]c[eé]d[ií]m[ií][eé]nt[oó]')  AND array[95,100,2,69,1,19,12] && (ids_carreras)  
