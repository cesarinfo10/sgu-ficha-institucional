COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'd[eé]r[eé]ch[oó]' OR       cod_asignatura ~* 'd[eé]r[eé]ch[oó]' OR       text(c.id) ~* 'd[eé]r[eé]ch[oó]' OR       lower(profesor) ~* 'd[eé]r[eé]ch[oó]')  AND (lower(asignatura) ~* '[ií]nt[eé]rn[aá]c[ií][oó]n[aá]l' OR       cod_asignatura ~* '[ií]nt[eé]rn[aá]c[ií][oó]n[aá]l' OR       text(c.id) ~* '[ií]nt[eé]rn[aá]c[ií][oó]n[aá]l' OR       lower(profesor) ~* '[ií]nt[eé]rn[aá]c[ií][oó]n[aá]l')  AND (lower(asignatura) ~* 'p[uú]bl[ií]c[oó]' OR       cod_asignatura ~* 'p[uú]bl[ií]c[oó]' OR       text(c.id) ~* 'p[uú]bl[ií]c[oó]' OR       lower(profesor) ~* 'p[uú]bl[ií]c[oó]')  AND array[95,100,2,69,1,19,12] && (ids_carreras)  
