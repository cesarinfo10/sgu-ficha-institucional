COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'm[eé]t[oó]d[oó]l[oó]g[ií][aá]' OR       cod_asignatura ~* 'm[eé]t[oó]d[oó]l[oó]g[ií][aá]' OR       text(c.id) ~* 'm[eé]t[oó]d[oó]l[oó]g[ií][aá]' OR       lower(profesor) ~* 'm[eé]t[oó]d[oó]l[oó]g[ií][aá]')  AND (lower(asignatura) ~* 'd[eé]' OR       cod_asignatura ~* 'd[eé]' OR       text(c.id) ~* 'd[eé]' OR       lower(profesor) ~* 'd[eé]')  AND (lower(asignatura) ~* 'l[aá]' OR       cod_asignatura ~* 'l[aá]' OR       text(c.id) ~* 'l[aá]' OR       lower(profesor) ~* 'l[aá]')  AND (lower(asignatura) ~* '[ií]nv[eé]st[ií]g[aá]c[ií][oó]n' OR       cod_asignatura ~* '[ií]nv[eé]st[ií]g[aá]c[ií][oó]n' OR       text(c.id) ~* '[ií]nv[eé]st[ií]g[aá]c[ií][oó]n' OR       lower(profesor) ~* '[ií]nv[eé]st[ií]g[aá]c[ií][oó]n')  AND (lower(asignatura) ~* 'j[uú]r[ií]d[ií]c[aá]' OR       cod_asignatura ~* 'j[uú]r[ií]d[ií]c[aá]' OR       text(c.id) ~* 'j[uú]r[ií]d[ií]c[aá]' OR       lower(profesor) ~* 'j[uú]r[ií]d[ií]c[aá]')  AND array[95,100,2,69,1,19,12] && (ids_carreras)  
