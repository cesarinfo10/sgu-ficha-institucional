COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'r[eé]l[aá]c[ií][oó]n' OR       cod_asignatura ~* 'r[eé]l[aá]c[ií][oó]n' OR       text(c.id) ~* 'r[eé]l[aá]c[ií][oó]n' OR       lower(profesor) ~* 'r[eé]l[aá]c[ií][oó]n')  AND (lower(asignatura) ~* 'c[oó]l[eé]ct[ií]v[aá]' OR       cod_asignatura ~* 'c[oó]l[eé]ct[ií]v[aá]' OR       text(c.id) ~* 'c[oó]l[eé]ct[ií]v[aá]' OR       lower(profesor) ~* 'c[oó]l[eé]ct[ií]v[aá]')  AND (lower(asignatura) ~* 'd[eé]l' OR       cod_asignatura ~* 'd[eé]l' OR       text(c.id) ~* 'd[eé]l' OR       lower(profesor) ~* 'd[eé]l')  AND (lower(asignatura) ~* 'tr[aá]b[aá]j[oó]' OR       cod_asignatura ~* 'tr[aá]b[aá]j[oó]' OR       text(c.id) ~* 'tr[aá]b[aá]j[oó]' OR       lower(profesor) ~* 'tr[aá]b[aá]j[oó]')  AND array[95,100,2,69,1,19,12] && (ids_carreras)  
