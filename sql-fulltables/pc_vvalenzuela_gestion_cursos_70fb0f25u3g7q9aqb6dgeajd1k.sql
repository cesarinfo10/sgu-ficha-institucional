COPY (SELECT vc.carreras,c.id,vc.cod_asignatura||'-'||c.seccion||' '||vc.asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* 'myr[ií][aá]m' OR       cod_asignatura ~* 'myr[ií][aá]m' OR       text(c.id) ~* 'myr[ií][aá]m' OR       lower(profesor) ~* 'myr[ií][aá]m')  AND (lower(asignatura) ~* 'd[eé]l' OR       cod_asignatura ~* 'd[eé]l' OR       text(c.id) ~* 'd[eé]l' OR       lower(profesor) ~* 'd[eé]l')  AND (lower(asignatura) ~* 'c[aá]rm[eé]n' OR       cod_asignatura ~* 'c[aá]rm[eé]n' OR       text(c.id) ~* 'c[aá]rm[eé]n' OR       lower(profesor) ~* 'c[aá]rm[eé]n')  AND (lower(asignatura) ~* '[oó]rt[eé]g[aá]' OR       cod_asignatura ~* '[oó]rt[eé]g[aá]' OR       text(c.id) ~* '[oó]rt[eé]g[aá]' OR       lower(profesor) ~* '[oó]rt[eé]g[aá]')  AND (lower(asignatura) ~* 's[aá]l[aá]z[aá]r' OR       cod_asignatura ~* 's[aá]l[aá]z[aá]r' OR       text(c.id) ~* 's[aá]l[aá]z[aá]r' OR       lower(profesor) ~* 's[aá]l[aá]z[aá]r')  AND array[108,96,25,109,37,70,135,112,17,12] && (ids_carreras)  
