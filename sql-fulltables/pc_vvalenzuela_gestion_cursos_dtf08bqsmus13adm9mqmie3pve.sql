COPY (SELECT c.id,cod_asignatura||'-'||c.seccion||' '||asignatura AS asignatura,profesor,rut,
                    ...
                    WHERE id_fusion IS NULL  AND (lower(asignatura) ~* '[aá]r[ií][eé]l' OR       cod_asignatura ~* '[aá]r[ií][eé]l' OR       text(c.id) ~* '[aá]r[ií][eé]l' OR       lower(profesor) ~* '[aá]r[ií][eé]l')  AND (lower(asignatura) ~* '[aá]l[oó]nz[oó]' OR       cod_asignatura ~* '[aá]l[oó]nz[oó]' OR       text(c.id) ~* '[aá]l[oó]nz[oó]' OR       lower(profesor) ~* '[aá]l[oó]nz[oó]')  AND (lower(asignatura) ~* 'r[oó]s[aá]l[eé]s' OR       cod_asignatura ~* 'r[oó]s[aá]l[eé]s' OR       text(c.id) ~* 'r[oó]s[aá]l[eé]s' OR       lower(profesor) ~* 'r[oó]s[aá]l[eé]s')  AND (lower(asignatura) ~* '[uú]b[eé]d[aá]' OR       cod_asignatura ~* '[uú]b[eé]d[aá]' OR       text(c.id) ~* '[uú]b[eé]d[aá]' OR       lower(profesor) ~* '[uú]b[eé]d[aá]')  AND id_carrera IN (108,96,25,109,37,70,112,17,12)  
