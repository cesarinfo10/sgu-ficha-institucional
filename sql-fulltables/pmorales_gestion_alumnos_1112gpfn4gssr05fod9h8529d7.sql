COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'r[uú]th' OR  a.rut ~* 'r[uú]th' OR  lower(a.email) ~* 'r[uú]th' OR  text(a.id) ~* 'r[uú]th' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[eé]l[ií][aá]n[aá]' OR  a.rut ~* '[eé]l[ií][aá]n[aá]' OR  lower(a.email) ~* '[eé]l[ií][aá]n[aá]' OR  text(a.id) ~* '[eé]l[ií][aá]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[oó]j[eé]d[aá]' OR  a.rut ~* '[oó]j[eé]d[aá]' OR  lower(a.email) ~* '[oó]j[eé]d[aá]' OR  text(a.id) ~* '[oó]j[eé]d[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]nc[ií]ll[aá]' OR  a.rut ~* 'm[aá]nc[ií]ll[aá]' OR  lower(a.email) ~* 'm[aá]nc[ií]ll[aá]' OR  text(a.id) ~* 'm[aá]nc[ií]ll[aá]' ) 
