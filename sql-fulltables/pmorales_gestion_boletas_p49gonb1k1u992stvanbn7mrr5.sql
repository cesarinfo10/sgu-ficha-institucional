COPY (SELECT DISTINCT ON (coalesce(p.nro_boleta,p.nro_factura)) p.id,coalesce(p.nro_boleta,p.nro_factura) AS nro_docto,
                ...
                WHERE nro_boleta IS NOT NULL AND (lower(pap.nombres||' '||pap.apellidos) ~* '50337' OR  pap.rut ~* '50337' OR lower(a.nombres||' '||a.apellidos) ~* '50337' OR lower(a3.nombres||' '||a3.apellidos) ~* '50337' OR  a.rut ~* '50337' OR a2.rut ~* '50337' OR a3.rut ~* '50337'  OR text(nro_boleta) = '50337' )  
