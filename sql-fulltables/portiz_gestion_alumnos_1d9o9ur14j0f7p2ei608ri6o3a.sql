COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'n[ií]xsy' OR  a.rut ~* 'n[ií]xsy' OR  lower(a.email) ~* 'n[ií]xsy' OR  text(a.id) ~* 'n[ií]xsy' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]l[eé]j[aá]ndr[aá]' OR  a.rut ~* '[aá]l[eé]j[aá]ndr[aá]' OR  lower(a.email) ~* '[aá]l[eé]j[aá]ndr[aá]' OR  text(a.id) ~* '[aá]l[eé]j[aá]ndr[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[oó]l[ií]v[aá]r[eé]s' OR  a.rut ~* '[oó]l[ií]v[aá]r[eé]s' OR  lower(a.email) ~* '[oó]l[ií]v[aá]r[eé]s' OR  text(a.id) ~* '[oó]l[ií]v[aá]r[eé]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]lm[aá]gr[oó]' OR  a.rut ~* '[aá]lm[aá]gr[oó]' OR  lower(a.email) ~* '[aá]lm[aá]gr[oó]' OR  text(a.id) ~* '[aá]lm[aá]gr[oó]' ) 
