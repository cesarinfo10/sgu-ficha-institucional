COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[ií]v[aá]n[aá]' OR  a.rut ~* '[ií]v[aá]n[aá]' OR  lower(a.email) ~* '[ií]v[aá]n[aá]' OR  text(a.id) ~* '[ií]v[aá]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'r[oó]m[ií]n[aá]' OR  a.rut ~* 'r[oó]m[ií]n[aá]' OR  lower(a.email) ~* 'r[oó]m[ií]n[aá]' OR  text(a.id) ~* 'r[oó]m[ií]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'b[uú]r[aá]t[oó]v[ií]ch' OR  a.rut ~* 'b[uú]r[aá]t[oó]v[ií]ch' OR  lower(a.email) ~* 'b[uú]r[aá]t[oó]v[ií]ch' OR  text(a.id) ~* 'b[uú]r[aá]t[oó]v[ií]ch' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'b[eé]c[eé]rr[aá]' OR  a.rut ~* 'b[eé]c[eé]rr[aá]' OR  lower(a.email) ~* 'b[eé]c[eé]rr[aá]' OR  text(a.id) ~* 'b[eé]c[eé]rr[aá]' ) 
