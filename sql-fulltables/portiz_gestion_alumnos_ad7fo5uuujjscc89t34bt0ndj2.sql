COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'b[aá]rb[aá]r[aá]' OR  a.rut ~* 'b[aá]rb[aá]r[aá]' OR  lower(a.email) ~* 'b[aá]rb[aá]r[aá]' OR  text(a.id) ~* 'b[aá]rb[aá]r[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]l[eé]j[aá]ndr[aá]' OR  a.rut ~* '[aá]l[eé]j[aá]ndr[aá]' OR  lower(a.email) ~* '[aá]l[eé]j[aá]ndr[aá]' OR  text(a.id) ~* '[aá]l[eé]j[aá]ndr[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'j[uú][aá]r[eé]z' OR  a.rut ~* 'j[uú][aá]r[eé]z' OR  lower(a.email) ~* 'j[uú][aá]r[eé]z' OR  text(a.id) ~* 'j[uú][aá]r[eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'v[eé]l[eé]z' OR  a.rut ~* 'v[eé]l[eé]z' OR  lower(a.email) ~* 'v[eé]l[eé]z' OR  text(a.id) ~* 'v[eé]l[eé]z' ) 
