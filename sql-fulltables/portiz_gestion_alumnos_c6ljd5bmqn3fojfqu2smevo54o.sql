COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'f[aá]b[ií][aá]n[aá]' OR  a.rut ~* 'f[aá]b[ií][aá]n[aá]' OR  lower(a.email) ~* 'f[aá]b[ií][aá]n[aá]' OR  text(a.id) ~* 'f[aá]b[ií][aá]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]st[eé]l[oó]' OR  a.rut ~* 'c[aá]st[eé]l[oó]' OR  lower(a.email) ~* 'c[aá]st[eé]l[oó]' OR  text(a.id) ~* 'c[aá]st[eé]l[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'br[aá]nc[oó]' OR  a.rut ~* 'br[aá]nc[oó]' OR  lower(a.email) ~* 'br[aá]nc[oó]' OR  text(a.id) ~* 'br[aá]nc[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[ií]r[ií]n[oó]' OR  a.rut ~* 'c[ií]r[ií]n[oó]' OR  lower(a.email) ~* 'c[ií]r[ií]n[oó]' OR  text(a.id) ~* 'c[ií]r[ií]n[oó]' ) 
