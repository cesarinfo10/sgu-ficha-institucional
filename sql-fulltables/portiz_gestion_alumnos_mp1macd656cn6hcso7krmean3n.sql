COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]r[ií][aá]n[aá]' OR  a.rut ~* 'm[aá]r[ií][aá]n[aá]' OR  lower(a.email) ~* 'm[aá]r[ií][aá]n[aá]' OR  text(a.id) ~* 'm[aá]r[ií][aá]n[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'f[eé]rn[aá]nd[aá]' OR  a.rut ~* 'f[eé]rn[aá]nd[aá]' OR  lower(a.email) ~* 'f[eé]rn[aá]nd[aá]' OR  text(a.id) ~* 'f[eé]rn[aá]nd[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 's[eé]b[aá]ld' OR  a.rut ~* 's[eé]b[aá]ld' OR  lower(a.email) ~* 's[eé]b[aá]ld' OR  text(a.id) ~* 's[eé]b[aá]ld' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'tr[ií]nc[aá]d[oó]' OR  a.rut ~* 'tr[ií]nc[aá]d[oó]' OR  lower(a.email) ~* 'tr[ií]nc[aá]d[oó]' OR  text(a.id) ~* 'tr[ií]nc[aá]d[oó]' ) 
