COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[oó]l[aá]y[aá]' OR  a.rut ~* '[oó]l[aá]y[aá]' OR  lower(a.email) ~* '[oó]l[aá]y[aá]' OR  text(a.id) ~* '[oó]l[aá]y[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[ií]sm[eé]n[ií][aá]' OR  a.rut ~* '[ií]sm[eé]n[ií][aá]' OR  lower(a.email) ~* '[ií]sm[eé]n[ií][aá]' OR  text(a.id) ~* '[ií]sm[eé]n[ií][aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]br[eé]r[aá]' OR  a.rut ~* 'c[aá]br[eé]r[aá]' OR  lower(a.email) ~* 'c[aá]br[eé]r[aá]' OR  text(a.id) ~* 'c[aá]br[eé]r[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[aá]br[aá]ñ[aá]' OR  a.rut ~* 'l[aá]br[aá]ñ[aá]' OR  lower(a.email) ~* 'l[aá]br[aá]ñ[aá]' OR  text(a.id) ~* 'l[aá]br[aá]ñ[aá]' ) 
