COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'p[aá]lm[aá]' OR  a.rut ~* 'p[aá]lm[aá]' OR  lower(a.email) ~* 'p[aá]lm[aá]' OR  text(a.id) ~* 'p[aá]lm[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]rn[eé]z' OR  a.rut ~* '[aá]rn[eé]z' OR  lower(a.email) ~* '[aá]rn[eé]z' OR  text(a.id) ~* '[aá]rn[eé]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'sh[ií]rl[eé]y' OR  a.rut ~* 'sh[ií]rl[eé]y' OR  lower(a.email) ~* 'sh[ií]rl[eé]y' OR  text(a.id) ~* 'sh[ií]rl[eé]y' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'k[aá]th[eé]r[ií]n[eé]' OR  a.rut ~* 'k[aá]th[eé]r[ií]n[eé]' OR  lower(a.email) ~* 'k[aá]th[eé]r[ií]n[eé]' OR  text(a.id) ~* 'k[aá]th[eé]r[ií]n[eé]' ) 
