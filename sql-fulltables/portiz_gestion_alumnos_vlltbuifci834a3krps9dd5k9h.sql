COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'fr[eé]dy' OR  a.rut ~* 'fr[eé]dy' OR  lower(a.email) ~* 'fr[eé]dy' OR  text(a.id) ~* 'fr[eé]dy' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'd[eé]' OR  a.rut ~* 'd[eé]' OR  lower(a.email) ~* 'd[eé]' OR  text(a.id) ~* 'd[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[aá]' OR  a.rut ~* 'l[aá]' OR  lower(a.email) ~* 'l[aá]' OR  text(a.id) ~* 'l[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'cr[uú]z' OR  a.rut ~* 'cr[uú]z' OR  lower(a.email) ~* 'cr[uú]z' OR  text(a.id) ~* 'cr[uú]z' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]ntr[eé]r[aá]' OR  a.rut ~* 'c[oó]ntr[eé]r[aá]' OR  lower(a.email) ~* 'c[oó]ntr[eé]r[aá]' OR  text(a.id) ~* 'c[oó]ntr[eé]r[aá]' ) 
