COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]m[aá]n[ií]' OR  a.rut ~* 'm[aá]m[aá]n[ií]' OR  lower(a.email) ~* 'm[aá]m[aá]n[ií]' OR  text(a.id) ~* 'm[aá]m[aá]n[ií]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'm[aá]m[aá]n[ií]' OR  a.rut ~* 'm[aá]m[aá]n[ií]' OR  lower(a.email) ~* 'm[aá]m[aá]n[ií]' OR  text(a.id) ~* 'm[aá]m[aá]n[ií]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'pr[ií]sc[ií]l[aá]' OR  a.rut ~* 'pr[ií]sc[ií]l[aá]' OR  lower(a.email) ~* 'pr[ií]sc[ií]l[aá]' OR  text(a.id) ~* 'pr[ií]sc[ií]l[aá]' ) 
