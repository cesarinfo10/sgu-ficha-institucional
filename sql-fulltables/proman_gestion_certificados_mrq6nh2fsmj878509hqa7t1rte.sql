COPY (SELECT ac.folio,vac.cod,trim(a.rut) AS rut,va.nombre AS alumno,trim(c.alias) AS carrera,a.jornada,r.nombre AS regimen,va.estado AS estado_alumno,cert.nombre AS docto,
                  ...
                  WHERE (lower(a.nombres||' '||a.apellidos) ~* '[aá]ng[eé]l[oó]' OR  a.rut ~* '[aá]ng[eé]l[oó]' OR  text(ac.folio) ~* '[aá]ng[eé]l[oó]' OR  vac.cod ~* '[aá]ng[eé]l[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'fl[oó]r[eé]s' OR  a.rut ~* 'fl[oó]r[eé]s' OR  text(ac.folio) ~* 'fl[oó]r[eé]s' OR  vac.cod ~* 'fl[oó]r[eé]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'z[aá]m[oó]r[aá]' OR  a.rut ~* 'z[aá]m[oó]r[aá]' OR  text(ac.folio) ~* 'z[aá]m[oó]r[aá]' OR  vac.cod ~* 'z[aá]m[oó]r[aá]' ) 
