COPY (SELECT trim(pap.rut) AS rut,vp.id,vp.nombre,to_char(vp.fecha_post,'DD-MM-YYYY') AS fecha_post,
                    ...
                    WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'gl[oó]r[ií][aá]' OR  pap.rut ~* 'gl[oó]r[ií][aá]' OR  text(pap.id) ~* 'gl[oó]r[ií][aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'c[aá]str[oó]' OR  pap.rut ~* 'c[aá]str[oó]' OR  text(pap.id) ~* 'c[aá]str[oó]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'd[oó]n[oó]s[oó]' OR  pap.rut ~* 'd[oó]n[oó]s[oó]' OR  text(pap.id) ~* 'd[oó]n[oó]s[oó]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '' OR  pap.rut ~* '' OR  text(pap.id) ~* '' ) 
