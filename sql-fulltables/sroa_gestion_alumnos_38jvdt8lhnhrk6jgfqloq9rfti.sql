COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'p[aá][ií]ll[aá]n' OR  a.rut ~* 'p[aá][ií]ll[aá]n' OR  lower(a.email) ~* 'p[aá][ií]ll[aá]n' OR  text(a.id) ~* 'p[aá][ií]ll[aá]n' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]lt[aá]m[ií]r[aá]n[oó]' OR  a.rut ~* '[aá]lt[aá]m[ií]r[aá]n[oó]' OR  lower(a.email) ~* '[aá]lt[aá]m[ií]r[aá]n[oó]' OR  text(a.id) ~* '[aá]lt[aá]m[ií]r[aá]n[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'cynt[ií][aá]' OR  a.rut ~* 'cynt[ií][aá]' OR  lower(a.email) ~* 'cynt[ií][aá]' OR  text(a.id) ~* 'cynt[ií][aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'v[aá]n[eé]ss[aá]' OR  a.rut ~* 'v[aá]n[eé]ss[aá]' OR  lower(a.email) ~* 'v[aá]n[eé]ss[aá]' OR  text(a.id) ~* 'v[aá]n[eé]ss[aá]' ) 
