COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'd[aá]n[ií][eé]l[aá]' OR  a.rut ~* 'd[aá]n[ií][eé]l[aá]' OR  lower(a.email) ~* 'd[aá]n[ií][eé]l[aá]' OR  text(a.id) ~* 'd[aá]n[ií][eé]l[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[oó]v[ií][eé]d[oó]' OR  a.rut ~* '[oó]v[ií][eé]d[oó]' OR  lower(a.email) ~* '[oó]v[ií][eé]d[oó]' OR  text(a.id) ~* '[oó]v[ií][eé]d[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'r[oó]j[oó]' OR  a.rut ~* 'r[oó]j[oó]' OR  lower(a.email) ~* 'r[oó]j[oó]' OR  text(a.id) ~* 'r[oó]j[oó]' ) 
