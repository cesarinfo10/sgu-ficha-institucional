COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]rl[aá]' OR  a.rut ~* 'c[aá]rl[aá]' OR  lower(a.email) ~* 'c[aá]rl[aá]' OR  text(a.id) ~* 'c[aá]rl[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]l[ií][aá]g[aá]' OR  a.rut ~* '[aá]l[ií][aá]g[aá]' OR  lower(a.email) ~* '[aá]l[ií][aá]g[aá]' OR  text(a.id) ~* '[aá]l[ií][aá]g[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'p[oó]l[oó]' OR  a.rut ~* 'p[oó]l[oó]' OR  lower(a.email) ~* 'p[oó]l[oó]' OR  text(a.id) ~* 'p[oó]l[oó]' ) 
