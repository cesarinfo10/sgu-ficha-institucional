COPY (SELECT c.id,to_char(c.fecha,'DD-tmMon-YYYY') AS fecha,c.estado,
                     ...
                     WHERE (lower(va.nombre) ~* 'l[oó]r[eé]t[oó]' OR  a.rut ~* 'l[oó]r[eé]t[oó]' OR  text(c.id) ~* 'l[oó]r[eé]t[oó]' ) AND (lower(va.nombre) ~* 'm[aá]l[eé]br[aá]n' OR  a.rut ~* 'm[aá]l[eé]br[aá]n' OR  text(c.id) ~* 'm[aá]l[eé]br[aá]n' ) 
