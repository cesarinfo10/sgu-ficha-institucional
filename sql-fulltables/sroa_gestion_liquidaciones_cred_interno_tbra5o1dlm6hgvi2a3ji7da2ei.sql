COPY (SELECT c.id,to_char(c.fecha,'DD-tmMon-YYYY') AS fecha,c.estado,
                     ...
                     WHERE (lower(va.nombre) ~* '' OR  a.rut ~* '' OR  text(c.id) ~* '' ) AND (lower(va.nombre) ~* '[eé]dg[aá]rd' OR  a.rut ~* '[eé]dg[aá]rd' OR  text(c.id) ~* '[eé]dg[aá]rd' ) AND (lower(va.nombre) ~* 'c[aá]str[oó]' OR  a.rut ~* 'c[aá]str[oó]' OR  text(c.id) ~* 'c[aá]str[oó]' ) AND (lower(va.nombre) ~* 's[oó]z[aá]' OR  a.rut ~* 's[oó]z[aá]' OR  text(c.id) ~* 's[oó]z[aá]' ) 
