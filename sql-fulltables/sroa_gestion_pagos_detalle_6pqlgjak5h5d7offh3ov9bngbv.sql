COPY (SELECT coalesce(nro_boleta,nro_boleta_e,nro_factura) AS nro_docto,
			...
			WHERE (nro_boleta IS NOT NULL OR nro_boleta_e IS NOT NULL) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]ndr[eé][aá]' OR  pap.rut ~* '[aá]ndr[eé][aá]' OR lower(a.nombres||' '||a.apellidos) ~* '[aá]ndr[eé][aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* '[aá]ndr[eé][aá]' OR  a.rut ~* '[aá]ndr[eé][aá]' OR a2.rut ~* '[aá]ndr[eé][aá]' OR a3.rut ~* '[aá]ndr[eé][aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 's[eé]rr[aá]n[oó]' OR  pap.rut ~* 's[eé]rr[aá]n[oó]' OR lower(a.nombres||' '||a.apellidos) ~* 's[eé]rr[aá]n[oó]' OR lower(a3.nombres||' '||a3.apellidos) ~* 's[eé]rr[aá]n[oó]' OR  a.rut ~* 's[eé]rr[aá]n[oó]' OR a2.rut ~* 's[eé]rr[aá]n[oó]' OR a3.rut ~* 's[eé]rr[aá]n[oó]' ) 
