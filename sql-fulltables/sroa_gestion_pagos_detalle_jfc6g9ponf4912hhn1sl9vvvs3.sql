COPY (SELECT coalesce(nro_boleta,nro_boleta_e,nro_factura) AS nro_docto,
			...
			WHERE (nro_boleta IS NOT NULL OR nro_boleta_e IS NOT NULL) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'l[oó]p[eé]z' OR  pap.rut ~* 'l[oó]p[eé]z' OR lower(a.nombres||' '||a.apellidos) ~* 'l[oó]p[eé]z' OR lower(a3.nombres||' '||a3.apellidos) ~* 'l[oó]p[eé]z' OR  a.rut ~* 'l[oó]p[eé]z' OR a2.rut ~* 'l[oó]p[eé]z' OR a3.rut ~* 'l[oó]p[eé]z' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'c[aá]mp[uú]z[aá]n[oó]' OR  pap.rut ~* 'c[aá]mp[uú]z[aá]n[oó]' OR lower(a.nombres||' '||a.apellidos) ~* 'c[aá]mp[uú]z[aá]n[oó]' OR lower(a3.nombres||' '||a3.apellidos) ~* 'c[aá]mp[uú]z[aá]n[oó]' OR  a.rut ~* 'c[aá]mp[uú]z[aá]n[oó]' OR a2.rut ~* 'c[aá]mp[uú]z[aá]n[oó]' OR a3.rut ~* 'c[aá]mp[uú]z[aá]n[oó]' ) 
