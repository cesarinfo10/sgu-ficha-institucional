COPY (SELECT * FROM (SELECT DISTINCT ON (coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura)) p.id,coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura) AS nro_docto,
                ...
                WHERE (nro_boleta IS NOT NULL OR nro_boleta_e IS NOT NULL) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[eé]sp[ií]n[oó]z[aá]' OR  pap.rut ~* '[eé]sp[ií]n[oó]z[aá]' OR lower(a.nombres||' '||a.apellidos) ~* '[eé]sp[ií]n[oó]z[aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* '[eé]sp[ií]n[oó]z[aá]' OR  a.rut ~* '[eé]sp[ií]n[oó]z[aá]' OR a2.rut ~* '[eé]sp[ií]n[oó]z[aá]' OR a3.rut ~* '[eé]sp[ií]n[oó]z[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'm[oó]r[aá]l[eé]s' OR  pap.rut ~* 'm[oó]r[aá]l[eé]s' OR lower(a.nombres||' '||a.apellidos) ~* 'm[oó]r[aá]l[eé]s' OR lower(a3.nombres||' '||a3.apellidos) ~* 'm[oó]r[aá]l[eé]s' OR  a.rut ~* 'm[oó]r[aá]l[eé]s' OR a2.rut ~* 'm[oó]r[aá]l[eé]s' OR a3.rut ~* 'm[oó]r[aá]l[eé]s' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]n[aá]' OR  pap.rut ~* '[aá]n[aá]' OR lower(a.nombres||' '||a.apellidos) ~* '[aá]n[aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* '[aá]n[aá]' OR  a.rut ~* '[aá]n[aá]' OR a2.rut ~* '[aá]n[aá]' OR a3.rut ~* '[aá]n[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'k[aá]r[ií]n[aá]' OR  pap.rut ~* 'k[aá]r[ií]n[aá]' OR lower(a.nombres||' '||a.apellidos) ~* 'k[aá]r[ií]n[aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* 'k[aá]r[ií]n[aá]' OR  a.rut ~* 'k[aá]r[ií]n[aá]' OR a2.rut ~* 'k[aá]r[ií]n[aá]' OR a3.rut ~* 'k[aá]r[ií]n[aá]' )  
