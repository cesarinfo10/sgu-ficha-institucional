COPY (SELECT * FROM (SELECT DISTINCT ON (coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura)) p.id,coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura) AS nro_docto,
                ...
                WHERE (nro_boleta IS NOT NULL OR nro_boleta_e IS NOT NULL) AND (lower(pap.nombres||' '||pap.apellidos) ~* '' OR  pap.rut ~* '' OR lower(a.nombres||' '||a.apellidos) ~* '' OR lower(a3.nombres||' '||a3.apellidos) ~* '' OR  a.rut ~* '' OR a2.rut ~* '' OR a3.rut ~* '' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'y[oó]s[eé]lhyn' OR  pap.rut ~* 'y[oó]s[eé]lhyn' OR lower(a.nombres||' '||a.apellidos) ~* 'y[oó]s[eé]lhyn' OR lower(a3.nombres||' '||a3.apellidos) ~* 'y[oó]s[eé]lhyn' OR  a.rut ~* 'y[oó]s[eé]lhyn' OR a2.rut ~* 'y[oó]s[eé]lhyn' OR a3.rut ~* 'y[oó]s[eé]lhyn' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]ndr[eé][aá]' OR  pap.rut ~* '[aá]ndr[eé][aá]' OR lower(a.nombres||' '||a.apellidos) ~* '[aá]ndr[eé][aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* '[aá]ndr[eé][aá]' OR  a.rut ~* '[aá]ndr[eé][aá]' OR a2.rut ~* '[aá]ndr[eé][aá]' OR a3.rut ~* '[aá]ndr[eé][aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'm[oó]r[aá]' OR  pap.rut ~* 'm[oó]r[aá]' OR lower(a.nombres||' '||a.apellidos) ~* 'm[oó]r[aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* 'm[oó]r[aá]' OR  a.rut ~* 'm[oó]r[aá]' OR a2.rut ~* 'm[oó]r[aá]' OR a3.rut ~* 'm[oó]r[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'm[oó]r[aá]' OR  pap.rut ~* 'm[oó]r[aá]' OR lower(a.nombres||' '||a.apellidos) ~* 'm[oó]r[aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* 'm[oó]r[aá]' OR  a.rut ~* 'm[oó]r[aá]' OR a2.rut ~* 'm[oó]r[aá]' OR a3.rut ~* 'm[oó]r[aá]' )  
