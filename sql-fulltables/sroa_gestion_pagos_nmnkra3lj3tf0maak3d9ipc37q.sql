COPY (SELECT * FROM (SELECT DISTINCT ON (coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura)) p.id,coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura) AS nro_docto,
                ...
                WHERE (nro_boleta IS NOT NULL OR nro_boleta_e IS NOT NULL) AND (lower(pap.nombres||' '||pap.apellidos) ~* 's[ií]lv[aá]' OR  pap.rut ~* 's[ií]lv[aá]' OR lower(a.nombres||' '||a.apellidos) ~* 's[ií]lv[aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* 's[ií]lv[aá]' OR  a.rut ~* 's[ií]lv[aá]' OR a2.rut ~* 's[ií]lv[aá]' OR a3.rut ~* 's[ií]lv[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'wh[ií]t[eé]' OR  pap.rut ~* 'wh[ií]t[eé]' OR lower(a.nombres||' '||a.apellidos) ~* 'wh[ií]t[eé]' OR lower(a3.nombres||' '||a3.apellidos) ~* 'wh[ií]t[eé]' OR  a.rut ~* 'wh[ií]t[eé]' OR a2.rut ~* 'wh[ií]t[eé]' OR a3.rut ~* 'wh[ií]t[eé]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'm[oó]n[ií]c[aá]' OR  pap.rut ~* 'm[oó]n[ií]c[aá]' OR lower(a.nombres||' '||a.apellidos) ~* 'm[oó]n[ií]c[aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* 'm[oó]n[ií]c[aá]' OR  a.rut ~* 'm[oó]n[ií]c[aá]' OR a2.rut ~* 'm[oó]n[ií]c[aá]' OR a3.rut ~* 'm[oó]n[ií]c[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[aá]l[ií]c[ií][aá]' OR  pap.rut ~* '[aá]l[ií]c[ií][aá]' OR lower(a.nombres||' '||a.apellidos) ~* '[aá]l[ií]c[ií][aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* '[aá]l[ií]c[ií][aá]' OR  a.rut ~* '[aá]l[ií]c[ií][aá]' OR a2.rut ~* '[aá]l[ií]c[ií][aá]' OR a3.rut ~* '[aá]l[ií]c[ií][aá]' )  
