COPY (SELECT * FROM (SELECT DISTINCT ON (coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura)) p.id,coalesce(p.nro_boleta,p.nro_boleta_e,p.nro_factura) AS nro_docto,
                ...
                WHERE (nro_boleta IS NOT NULL OR nro_boleta_e IS NOT NULL) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'p[aá][uú]l[ií]n[aá]' OR  pap.rut ~* 'p[aá][uú]l[ií]n[aá]' OR lower(a.nombres||' '||a.apellidos) ~* 'p[aá][uú]l[ií]n[aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* 'p[aá][uú]l[ií]n[aá]' OR  a.rut ~* 'p[aá][uú]l[ií]n[aá]' OR a2.rut ~* 'p[aá][uú]l[ií]n[aá]' OR a3.rut ~* 'p[aá][uú]l[ií]n[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[uú]ll[oó][aá]' OR  pap.rut ~* '[uú]ll[oó][aá]' OR lower(a.nombres||' '||a.apellidos) ~* '[uú]ll[oó][aá]' OR lower(a3.nombres||' '||a3.apellidos) ~* '[uú]ll[oó][aá]' OR  a.rut ~* '[uú]ll[oó][aá]' OR a2.rut ~* '[uú]ll[oó][aá]' OR a3.rut ~* '[uú]ll[oó][aá]' )  
