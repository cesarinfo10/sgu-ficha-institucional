COPY (SELECT s.id,a.rut,a.nombres,a.apellidos,va.carrera||'-'||a.jornada AS carrera,
			  ...
			  WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '' OR  a.rut ~* '' OR  text(a.id) ~* '' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[eé][oó]n[aá]rd[oó]' OR  a.rut ~* 'l[eé][oó]n[aá]rd[oó]' OR  text(a.id) ~* 'l[eé][oó]n[aá]rd[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 't[oó]r[oó]' OR  a.rut ~* 't[oó]r[oó]' OR  text(a.id) ~* 't[oó]r[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'r[eé]y[eé]s' OR  a.rut ~* 'r[eé]y[eé]s' OR  text(a.id) ~* 'r[eé]y[eé]s' ) 
