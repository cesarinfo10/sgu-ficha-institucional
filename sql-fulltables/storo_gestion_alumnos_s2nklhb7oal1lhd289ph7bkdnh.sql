COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'c[eé]s[aá]r' OR  a.rut ~* 'c[eé]s[aá]r' OR  lower(a.email) ~* 'c[eé]s[aá]r' OR  text(a.id) ~* 'c[eé]s[aá]r' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'z[oó]r[oó]nd[oó]' OR  a.rut ~* 'z[oó]r[oó]nd[oó]' OR  lower(a.email) ~* 'z[oó]r[oó]nd[oó]' OR  text(a.id) ~* 'z[oó]r[oó]nd[oó]' )  AND a.carrera_actual IN (95,100,2,69,1,19) 
