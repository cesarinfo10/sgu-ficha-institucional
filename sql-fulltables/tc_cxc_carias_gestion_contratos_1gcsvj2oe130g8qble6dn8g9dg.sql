COPY (SELECT nro_contrato,fecha_emision,rut,nombre,centro_costo,nro_pagare,
               ...
               WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'cl[aá][uú]d[ií][oó]' OR  pap.rut ~* 'cl[aá][uú]d[ií][oó]' OR lower(a.nombres||' '||a.apellidos) ~* 'cl[aá][uú]d[ií][oó]' OR  a.rut ~* 'cl[aá][uú]d[ií][oó]' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* 'cl[aá][uú]d[ií][oó]' OR  av.rf_rut ~* 'cl[aá][uú]d[ií][oó]' OR  text(c.id) ~* 'cl[aá][uú]d[ií][oó]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'v[ií]ll[aá]rr[oó][eé]l' OR  pap.rut ~* 'v[ií]ll[aá]rr[oó][eé]l' OR lower(a.nombres||' '||a.apellidos) ~* 'v[ií]ll[aá]rr[oó][eé]l' OR  a.rut ~* 'v[ií]ll[aá]rr[oó][eé]l' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* 'v[ií]ll[aá]rr[oó][eé]l' OR  av.rf_rut ~* 'v[ií]ll[aá]rr[oó][eé]l' OR  text(c.id) ~* 'v[ií]ll[aá]rr[oó][eé]l' ) 
