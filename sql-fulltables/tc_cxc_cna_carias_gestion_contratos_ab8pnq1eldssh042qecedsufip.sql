COPY (SELECT nro_contrato,ano,regimen,fecha_emision,estado,rut,razon_social,fecha_venc,cta_ctble,monto_inicial,nro_pagare,tipo,
              ...
              WHERE (lower(pap.nombres||' '||pap.apellidos) ~* '16105277' OR  pap.rut ~* '16105277' OR lower(a.nombres||' '||a.apellidos) ~* '16105277' OR  a.rut ~* '16105277' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* '16105277' OR  av.rf_rut ~* '16105277' OR  text(c.id) ~* '16105277' ) 
