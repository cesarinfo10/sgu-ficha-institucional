COPY (SELECT nro_contrato,ano,regimen,fecha_emision,estado,rut,razon_social,fecha_venc,cta_ctble,monto_inicial,nro_pagare,tipo,
              ...
              WHERE (lower(pap.nombres||' '||pap.apellidos) ~* '21504155' OR  pap.rut ~* '21504155' OR lower(a.nombres||' '||a.apellidos) ~* '21504155' OR  a.rut ~* '21504155' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* '21504155' OR  av.rf_rut ~* '21504155' OR  text(c.id) ~* '21504155' ) 
