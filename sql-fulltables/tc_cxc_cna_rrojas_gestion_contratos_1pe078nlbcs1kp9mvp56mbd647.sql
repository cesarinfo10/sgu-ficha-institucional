COPY (SELECT nro_contrato,ano,fecha_emision,estado,rut,razon_social,fecha_venc,cta_ctble,monto_inicial,nro_pagare,tipo,
              ...
              WHERE (lower(pap.nombres||' '||pap.apellidos) ~* '17323124' OR  pap.rut ~* '17323124' OR lower(a.nombres||' '||a.apellidos) ~* '17323124' OR  a.rut ~* '17323124' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* '17323124' OR  av.rf_rut ~* '17323124' OR  text(c.id) ~* '17323124' ) 
