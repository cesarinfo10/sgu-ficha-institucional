COPY (SELECT nro_contrato,fecha_emision,rut,nombre,centro_costo,nro_pagare,
               ...
               WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'l[uú]cy' OR  pap.rut ~* 'l[uú]cy' OR lower(a.nombres||' '||a.apellidos) ~* 'l[uú]cy' OR  a.rut ~* 'l[uú]cy' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* 'l[uú]cy' OR  av.rf_rut ~* 'l[uú]cy' OR  text(c.id) ~* 'l[uú]cy' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'l[ií]sp[eé]rg[uú][eé]r' OR  pap.rut ~* 'l[ií]sp[eé]rg[uú][eé]r' OR lower(a.nombres||' '||a.apellidos) ~* 'l[ií]sp[eé]rg[uú][eé]r' OR  a.rut ~* 'l[ií]sp[eé]rg[uú][eé]r' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* 'l[ií]sp[eé]rg[uú][eé]r' OR  av.rf_rut ~* 'l[ií]sp[eé]rg[uú][eé]r' OR  text(c.id) ~* 'l[ií]sp[eé]rg[uú][eé]r' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '' OR  pap.rut ~* '' OR lower(a.nombres||' '||a.apellidos) ~* '' OR  a.rut ~* '' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* '' OR  av.rf_rut ~* '' OR  text(c.id) ~* '' ) 
