COPY (SELECT nro_contrato,fecha_emision,rut,nombre,centro_costo,nro_pagare,
               ...
               WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'm[aá]rc[eé]l[aá]' OR  pap.rut ~* 'm[aá]rc[eé]l[aá]' OR lower(a.nombres||' '||a.apellidos) ~* 'm[aá]rc[eé]l[aá]' OR  a.rut ~* 'm[aá]rc[eé]l[aá]' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* 'm[aá]rc[eé]l[aá]' OR  av.rf_rut ~* 'm[aá]rc[eé]l[aá]' OR  text(c.id) ~* 'm[aá]rc[eé]l[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'g[aá][eé]t[eé]' OR  pap.rut ~* 'g[aá][eé]t[eé]' OR lower(a.nombres||' '||a.apellidos) ~* 'g[aá][eé]t[eé]' OR  a.rut ~* 'g[aá][eé]t[eé]' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* 'g[aá][eé]t[eé]' OR  av.rf_rut ~* 'g[aá][eé]t[eé]' OR  text(c.id) ~* 'g[aá][eé]t[eé]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '' OR  pap.rut ~* '' OR lower(a.nombres||' '||a.apellidos) ~* '' OR  a.rut ~* '' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* '' OR  av.rf_rut ~* '' OR  text(c.id) ~* '' ) 
