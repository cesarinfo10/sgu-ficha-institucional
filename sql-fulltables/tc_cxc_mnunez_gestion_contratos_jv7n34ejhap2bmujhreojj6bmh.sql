COPY (SELECT nro_contrato,fecha_emision,rut,nombre,centro_costo,nro_pagare,
               ...
               WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'j[aá][ií]m[eé]' OR  pap.rut ~* 'j[aá][ií]m[eé]' OR lower(a.nombres||' '||a.apellidos) ~* 'j[aá][ií]m[eé]' OR  a.rut ~* 'j[aá][ií]m[eé]' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* 'j[aá][ií]m[eé]' OR  av.rf_rut ~* 'j[aá][ií]m[eé]' OR  text(c.id) ~* 'j[aá][ií]m[eé]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'l[aá]rr[aá][ií]n' OR  pap.rut ~* 'l[aá]rr[aá][ií]n' OR lower(a.nombres||' '||a.apellidos) ~* 'l[aá]rr[aá][ií]n' OR  a.rut ~* 'l[aá]rr[aá][ií]n' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* 'l[aá]rr[aá][ií]n' OR  av.rf_rut ~* 'l[aá]rr[aá][ií]n' OR  text(c.id) ~* 'l[aá]rr[aá][ií]n' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '' OR  pap.rut ~* '' OR lower(a.nombres||' '||a.apellidos) ~* '' OR  a.rut ~* '' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* '' OR  av.rf_rut ~* '' OR  text(c.id) ~* '' ) 
