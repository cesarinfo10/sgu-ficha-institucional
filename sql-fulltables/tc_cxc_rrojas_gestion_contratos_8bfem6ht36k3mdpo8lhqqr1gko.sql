COPY (SELECT nro_contrato,fecha_emision,rut,nombre,centro_costo,nro_pagare,
               ...
               WHERE (lower(pap.nombres||' '||pap.apellidos) ~* '17731130-8' OR  pap.rut ~* '17731130-8' OR lower(a.nombres||' '||a.apellidos) ~* '17731130-8' OR  a.rut ~* '17731130-8' OR lower(av.rf_nombres||' '||av.rf_apellidos) ~* '17731130-8' OR  av.rf_rut ~* '17731130-8' OR  text(c.id) ~* '17731130-8' ) 
