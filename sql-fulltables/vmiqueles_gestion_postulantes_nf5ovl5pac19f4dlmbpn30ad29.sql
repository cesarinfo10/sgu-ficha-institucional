COPY (SELECT trim(pap.rut) AS rut,vp.id,vp.nombre,to_char(vp.fecha_post,'DD-MM-YYYY') AS fecha_post,
                    ...
                    WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'c[aá]r[oó]l[ií]n[aá]' OR  pap.rut ~* 'c[aá]r[oó]l[ií]n[aá]' OR  text(pap.id) ~* 'c[aá]r[oó]l[ií]n[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* '[ií]g[oó]r' OR  pap.rut ~* '[ií]g[oó]r' OR  text(pap.id) ~* '[ií]g[oó]r' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'p[aá]l[oó]m[ií]n[oó]s' OR  pap.rut ~* 'p[aá]l[oó]m[ií]n[oó]s' OR  text(pap.id) ~* 'p[aá]l[oó]m[ií]n[oó]s' ) 
