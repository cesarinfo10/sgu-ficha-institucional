COPY (SELECT trim(pap.rut) AS rut,vp.id,vp.nombre,to_char(vp.fecha_post,'DD-MM-YYYY') AS fecha_post,
                    ...
                    WHERE (lower(pap.nombres||' '||pap.apellidos) ~* 'g[aá]t[ií]c[aá]' OR  pap.rut ~* 'g[aá]t[ií]c[aá]' OR  text(pap.id) ~* 'g[aá]t[ií]c[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'v[ií]d[eé]l[aá]' OR  pap.rut ~* 'v[ií]d[eé]l[aá]' OR  text(pap.id) ~* 'v[ií]d[eé]l[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'v[aá]l[eé]nt[ií]n[aá]' OR  pap.rut ~* 'v[aá]l[eé]nt[ií]n[aá]' OR  text(pap.id) ~* 'v[aá]l[eé]nt[ií]n[aá]' ) AND (lower(pap.nombres||' '||pap.apellidos) ~* 'c[oó]ns[uú][eé]l[oó]' OR  pap.rut ~* 'c[oó]ns[uú][eé]l[oó]' OR  text(pap.id) ~* 'c[oó]ns[uú][eé]l[oó]' ) 
