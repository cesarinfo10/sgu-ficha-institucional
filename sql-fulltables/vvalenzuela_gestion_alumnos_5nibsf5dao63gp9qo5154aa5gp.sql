COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[aá]lm[aá]rc[eé]g[uú][ií]' OR  a.rut ~* '[aá]lm[aá]rc[eé]g[uú][ií]' OR  lower(a.email) ~* '[aá]lm[aá]rc[eé]g[uú][ií]' OR  text(a.id) ~* '[aá]lm[aá]rc[eé]g[uú][ií]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[oó]r[oó]n[aá]d[oó]' OR  a.rut ~* 'c[oó]r[oó]n[aá]d[oó]' OR  lower(a.email) ~* 'c[oó]r[oó]n[aá]d[oó]' OR  text(a.id) ~* 'c[oó]r[oó]n[aá]d[oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[eé][aá]ndr[aá]' OR  a.rut ~* 'l[eé][aá]ndr[aá]' OR  lower(a.email) ~* 'l[eé][aá]ndr[aá]' OR  text(a.id) ~* 'l[eé][aá]ndr[aá]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[ií]n[eé]s' OR  a.rut ~* '[ií]n[eé]s' OR  lower(a.email) ~* '[ií]n[eé]s' OR  text(a.id) ~* '[ií]n[eé]s' )  AND a.carrera_actual IN (108,96,25,109,37,70,135,112,17,153) 
