COPY (SELECT a.id,trim(a.rut) AS rut,upper(a.apellidos)||' '||initcap(a.nombres) AS nombre,a.genero,a.fec_nac,c.alias||'-'||a.jornada AS carrera,c.regimen,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* 'p[aá]ll[aá]l[eé][oó]' OR  a.rut ~* 'p[aá]ll[aá]l[eé][oó]' OR  lower(a.email) ~* 'p[aá]ll[aá]l[eé][oó]' OR  text(a.id) ~* 'p[aá]ll[aá]l[eé][oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'p[aá]ll[aá]l[eé][oó]' OR  a.rut ~* 'p[aá]ll[aá]l[eé][oó]' OR  lower(a.email) ~* 'p[aá]ll[aá]l[eé][oó]' OR  text(a.id) ~* 'p[aá]ll[aá]l[eé][oó]' ) AND (lower(a.nombres||' '||a.apellidos) ~* '[ií]s[aá]b[eé]l' OR  a.rut ~* '[ií]s[aá]b[eé]l' OR  lower(a.email) ~* '[ií]s[aá]b[eé]l' OR  text(a.id) ~* '[ií]s[aá]b[eé]l' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'd[eé]' OR  a.rut ~* 'd[eé]' OR  lower(a.email) ~* 'd[eé]' OR  text(a.id) ~* 'd[eé]' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'l[oó][uú]rd[eé]s' OR  a.rut ~* 'l[oó][uú]rd[eé]s' OR  lower(a.email) ~* 'l[oó][uú]rd[eé]s' OR  text(a.id) ~* 'l[oó][uú]rd[eé]s' )  AND a.carrera_actual IN (108,96,25,109,37,70,112,17) 
