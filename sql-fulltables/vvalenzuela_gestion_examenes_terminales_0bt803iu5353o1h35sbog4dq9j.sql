COPY (SELECT et.id,to_char(fecha_reg,'dd-tmMon-YYYY HH24:MI') AS fecha_reg,
				  ...
				  WHERE true  AND (et.estado IN ('Programado')) AND (date_part('year',et.fecha_examen) = 2023) AND (et.id_escuela = 11)  AND et.fecha_examen::date BETWEEN '2023-01-01'::date AND '2023-12-31'::date  			  
