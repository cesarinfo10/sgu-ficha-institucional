...
$SQL_toma_ramos = "SELECT count(id_alumno) FROM inscripciones_cursos WHERE id_alumno=a.id";

$condicion = "WHERE true AND (m.id_alumno IS NOT NULL) AND ($SQL_toma_ramos)=0  ";
