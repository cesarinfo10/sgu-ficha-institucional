...
$SQL_curso = "SELECT vc.id,vc.cod_asignatura||'-'||vc.seccion||' '||vc.asignatura AS asignatura,vc.semestre as sem_num,
                     ...
                     md5(vc.id::text||vc.id_profesor::text) AS cod,car.regimen,c.cod_google_classroom,c.tipo_clase
...
<table bgcolor="#ffffff" cellspacing="1" cellpadding="2" class="tabla" style='margin-top: 5px'>
  ...
  <tr>
    ...
    <td class='celdaValorAttr' colspan="3"><?php echo($cod_google_classroom); ?></td>
  </tr>
  <tr>
